...
* New: Several styles have been optimized in the generated formdiableforms.css file when Pro is not active, helping to reduce file size by removing references to features that only exist in Pro.
