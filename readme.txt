...
- New: A name field will always be used when sending comment author information to Aksimet if one is set to avoid false positives that could cause another field value to possibly get sent instead.
