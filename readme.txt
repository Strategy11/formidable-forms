...
== Changelog ==
= 4.11.04 =
* New: The first field with an error will now automatically focus when a form is submitted.
...
* Fix: Improved support for importing grid views, fixing an issue where content would sometimes stay serialized.
