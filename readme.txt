...
* New: Denylist checks will no longer check radio buttons, checkboxes, dropdowns, signature, and CAPTCHA fields to help avoid issues with false positive matches.
