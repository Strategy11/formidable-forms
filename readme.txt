=== Contact Forms, Surveys & Quizzes by Formidable Forms Builder for WordPress ===
...
The most advanced WordPress forms plugin. Go beyond contact forms with our drag & drop form builder to build surveys, quizzes, and more.

== Description ==
= The Most Powerful WordPress form builder on the market =
We built <a href="https://formidableforms.com/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Formidable Forms</a> to offer the "first-ever" solutions-focused WordPress form plugin on the market. You can use our drag & drop WordPress form builder to create contact forms, surveys, quizzes, registration forms, payment forms, purchase forms, email marketing forms, and just about any other form you can imagine. 
...
Let's take a look at all the powerful features that you get with Formidable Forms.

= Drag & Drop Contact Form and Advanced Form Builder =

Formidable drag & drop form builder allows you to quickly create unlimited contact forms, surveys, quizzes, registration forms, and just about any other type of form that you want.

It comes with all the powerful form fields that you need to create a solution-focused form, fast!
...
By default, Formidable applies a single styling template to all contact form and advanced forms on your site. But if you want to have custom form style for each individual contact form and registration form, then you can upgrade to Formidable Forms Pro.
...
Need to import your leads to another service like MailChimp? No problem. **Export form leads to a CSV**, open it in Excel, and import anywhere.
...
The best part is that you can do this all within Formidable without using any third-party tool.
...
Unlike other contact form plugins, Formidable comes with a repeater field that allows you to create the most powerful registration forms.

Then, you can use our marketing integrations and APIs to send this data anywhere you want.

= Accept Credit Cards and Easily Collect Payments = 

By now, you probably already realize the theme that Formidable is more than just a contact form plugin. You can use Formidable to accept credit card payments right from your website.
...
You can use Formidable to create WooCommerce forms (more on that later).
...
As you can see, Formidable is not an average contact form plugin. It's a true all-in-one WordPress form solution.
...
You can use Formidable to add a WooCommerce Product configurator, add custom calculation fields, and then automatically send the data to WooCommerce cart with variable pricing option. 
...
= Build Powerful Quizzes & Calculators = 

Along with a contact form, you can also use Formidable form builder to create quizzes and calculator forms.
...
... and our powerful calculation fields allow you to build just about any other type of calculator. 
...
Formidable Form builder allows you to customize your WordPress user registration forms, so you can collect additional data when the user profile is being created.

With our front-end form editing option, you can also build custom profile forms and allow users to keep it updated.
...
We believe that data by itself does no good if you can't analyze it. That's why we make it easy for you to analyze your contact form, survey, quiz, and other form data with beautiful graphs and reports.
...
= All the Advanced Form Fields and Feature You Need to Grow Your Business =

Formidable Forms goes above and beyond to offer all the advanced form fields and features that you need to grow your business.

This includes things like multi-page forms, save and continue forms, cascading form fields, powerful conditional logic, partial form submissions, invisible spam protection, front-end user post submission, user-tracking, and so much more.

We're on a mission to offer an all-in-one solution focused WordPress form plugin, so you don't have to install 5 plugins alongside your contact form plugin to do everything that you want.

= Extend and Customize Your Forms - Developer's Dream Come True = 

Formidable is the form plugin of choice for smart developers, freelancers, and agencies because it helps them build complex form solutions quickly.

Our goal is to help you build complex websites with low overhead. We believe big projects don't always need big resources.

That's why we made Formidable the most extendable WordPress form builder plugin in the market.

You can easily route your form data with our powerful API. Formidable Views allow you to display your form data anywhere on the front-end, so you can quickly create data-driven web applications. 

On top of that, our hooks and filters allow you to completly extend Formidable to meet your needs. We even include hundreds of code examples in our docs to give you extra confidence to get started.
...
* <a href="https://formidableforms.com/features/drag-drop-form-builder/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Online drag and drop form builder</a>. Build complex online forms the easy way with a simple WordPress drag and drop form builder. No code required.
...
* Datepicker fields with advanced <a href="https://formidableforms.com/downloads/datepicker-options/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">datepicker options</a> including blackout dates, dynamic minimum and maximum dates, and inline calendars.
* Create relationships with Dynamic fields populated from other forms.
...
* <a href="https://formidableforms.com/features/confirm-email-address-password-wordpress-form/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Confirmation fields</a>. Double check the email address or password fields and don't let typos cannibalize your form leads.
...
* Email routing: Conditionally send multiple autoresponder emails and notifications based on values in your contact forms, payment forms, and registration forms.
...
* <a href="https://formidableforms.com/features/wordpress-visual-form-styler/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Visual form styler</a>. Create branded forms to match your site. Change colors, borders, padding and much more without any code.
...
* <a href="https://formidableforms.com/features/wordpress-mobile-friendly-responsive-forms/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Mobile-friendly, Responsive forms</a>. Let everyone see and submit your forms from any device since forms are sized automatically for every device. 
...
* Form scheduling. Open and close the form on a specific date, or close forms when the limit has been reached for your event or team.
* Conditionally redirect after form submission.
* <a href="https://formidableforms.com/features/customize-form-html-wordpress/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Customize form HTML</a>. We believe that forms should be extendable to meet your needs. So we give you access to change the form HTML (like Contact Form 7), but still have the ease and speed of a drag & drop form builder plugin.
...
* <a href="https://formidableforms.com/features/wordpress-form-templates/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Form templates for instant form building</a>. Get started quickly with the form templates that are built into Formidable.
* Import our <a href="https://formidableforms.com/downloads/category/form-templates/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">pre-built form/view templates</a> as a starting point or a final product.
* <a href="https://formidableforms.com/features/wcag-accessible-forms/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">WCAG accessible forms with A11Y compliance</a>. Don't alienate your audience. Ensure your contact forms, surveys, quizzes, lead capture forms, and advanced forms are compliant and available to anyone.
...
* <a href="https://formidableforms.com/features/fill-out-forms-automatically/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Fill out forms automatically</a> with user meta or values from your posts including custom fields.
* <a href="https://formidableforms.com/features/white-label-form-builder-wordpress/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">White label form builder</a>. Replace the Formidable Forms branding with your own in the admin area. Plus, we never show "powered by" links in your free online forms.
* <a href="https://formidableforms.com/downloads/user-registration/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">WordPress user registration forms</a>. Register users, edit profiles, and even create subdomains when using WordPress multisite forms.
* <a href="https://formidableforms.com/downloads/signature/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Digital Signature Forms</a>. Eiminate paper forms with a digital signature field to your contact form, registration form, or advanced form.
...
* <a href="https://formidableforms.com/support/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">World class support</a>. Have questions or need guidance on how to set up your web application? We are happy to help. Our purpose with Formidable Forms is to help you <strong>take on bigger projects, earn more clients, and grow your business</strong>.
...
* <a href="https://formidableforms.com/downloads/authorize-net-aim/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Authorize.net AIM Payment Forms</a>. Accept one-time payments directly on your site, using Authorize.net AIM.
* <a href="https://formidableforms.com/downloads/woocommerce/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">WooCommerce product configurator</a>. Add custom fields to a WooCommerce product form and collect extra data when a product is added to the cart.
...
* <a href="https://formidableforms.com/downloads/constant-contact/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Constant Contact Forms</a>. Create leads automatically in Constant Contact with newsletter signup forms.
...
* <a href="https://formidableforms.com/downloads/wp-multilingual/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">WPML Forms</a>. Translate forms into multiple languages using our integrated multilingual forms plugin.
* <a href="https://formidableforms.com/downloads/polylang/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Polylang Forms</a>. Create bilingual or multilingual forms with help from Polylang.
* <a href="https://formidableforms.com/downloads/zapier/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Zapier Forms</a>. Connect with hundreds of different applications through Zapier. Insert a new row in a Google docs spreadsheet, post on Twitter, or add a new Dropbox file with your form.
* <a href="https://formidableforms.com/downloads/bootstrap/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Bootstrap Form Styles</a>. Instantly add Bootstrap styling to your contact forms and advanced forms.
* <a href="https://formidableforms.com/downloads/bootstrap-modal/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">Bootstrap Modal Form</a>. Open forms, views, other shortcodes, or sections of content in a Bootstrap modal popup.
...
This plugin is created by Steve and Steph Wells along with our amazing Formidable Team. 
...
<a href="https://formidableforms.com/formidable-faqs/?utm_source=wprepo&utm_medium=link&utm_campaign=liteversion">See more FAQs</a>
