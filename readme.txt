=== Formidable Forms - Contact Form, Survey, Quiz, Calculator, Payment & Custom Form Builder ===
...
* Fix: Stripe scripts were not loading properly when the Lite minified JS was available but not the minified Pro scripts.
