...
- New: Inputs with errors will now add the aria-describedby attribute during JavaScript validation for more accessible error handling.
- New: New fields will now include role="alert" on custom error HTML by default.
