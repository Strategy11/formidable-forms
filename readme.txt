...
== Changelog ==
= 5.4.3 =
* New: Icons for dragging and moving options will now be generated client side when required as a performance optimization. Forms with radio button, checkbox, and dropdown fields with a lot of options will now require less HTML to load which will help prevent the browser from being unresponsive.
