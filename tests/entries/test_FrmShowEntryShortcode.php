...
class test_FrmShowEntryShortcode extends FrmUnitTest {
	 ...
	 * @return string
	 */
	private function get_expected_default_plain( $atts ) {
	 ...
	 * @return string
	 */
	private function get_expected_default_shortcodes( $type, $atts ) {
		$content = '';
		...
		foreach ( $fields as $field ) {
			...
			$content .= $this->table_row_separator( $type );
	...
	private function table_row_start_tags( $type, $field ) {
		$html = '';
		if ( $type === 'html' ) {
	...
	private function table_row_separator( $type ) {
		if ( $type === 'html' ) {
