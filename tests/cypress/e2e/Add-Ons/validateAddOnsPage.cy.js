describe( 'Add-Ons page', () => {
	...
	it( 'should validate all add-on cards', () => {
		...
		cy.get( 'li[data-slug="formidable-api"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=formidable-api' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="twilio"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=twilio' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="bootstrap"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=bootstrap' ).and( 'contain.text', 'Plus' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="aweber"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=aweber' ).and( 'contain.text', 'Plus' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="wp-multilingual"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=wp-multilingual' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="locations"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=locations' ).and( 'contain.text', 'Plus' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="zapier"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=zapier' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="user-tracking"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=user-tracking' ).and( 'contain.text', 'Plus' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="mailchimp"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=mailchimp' ).and( 'contain.text', 'Plus' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="user-registration"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=user-registration' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="woocommerce"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=woocommerce' ).and( 'contain.text', 'Elite' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="highrise"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=highrise' ).and( 'contain.text', 'Plus' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="bootstrap-modal"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=bootstrap-modal' ).and( 'contain.text', 'Plus' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="polylang"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=polylang' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="autoresponder"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=autoresponder' ).and( 'contain.text', 'Elite' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="logs"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=logs' ).and( 'contain.text', 'Basic' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="datepicker-options"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=datepicker-options' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="salesforce"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=salesforce' ).and( 'contain.text', 'Elite' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="mailpoet-newsletters"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=mailpoet-newsletters' ).and( 'contain.text', 'Plus' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="activecampaign-wordpress-plugin"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=activecampaign-wordpress-plugin' ).and( 'contain.text', 'Elite' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="getresponse-wordpress-plugin"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=getresponse-wordpress-plugin' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="quiz-maker"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=quiz-maker' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="constant-contact"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=constant-contact' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="campaign-monitor"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=campaign-monitor' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="export-view"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=export-view' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="visual-views"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=visual-views' ).and( 'contain.text', 'Plus' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="surveys"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=surveys' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="landing-pages"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=landing-pages' ).and( 'contain.text', 'Plus' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="conversational-forms"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=conversational-forms' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="geolocation"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=geolocation' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="pdfs"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=pdfs' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="google-sheets"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=google-sheets' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="acf-forms"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=acf-forms' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="ai"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=ai' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="abandonment"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=abandonment' ).and( 'contain.text', 'Business' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="charts"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=charts' ).and( 'contain.text', 'Plus' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
		...
		cy.get( 'li[data-slug="convertkit"]' ).within( () => {
			...
			cy.contains( 'Plan required:' ).within( () => {
				cy.get( 'a' ).should( 'have.attr', 'href', 'https://formidableforms.com/lite-upgrade/?utm_source=WordPress&utm_medium=addons&utm_campaign=liteplugin&utm_content=convertkit' ).and( 'contain.text', 'Plus' );
			} );
			cy.get( 'a[aria-label="Upgrade Now"]' ).should( 'have.attr', 'target', '_blank' )
				.and( 'have.attr', 'href' ).and( 'include', 'https://formidableforms.com/lite-upgrade/' );
		} );
