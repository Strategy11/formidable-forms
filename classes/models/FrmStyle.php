...
class FrmStyle {
	...
	public function get_defaults() {
		$defaults = array(
			...
			'submit_width'               => 'auto',
			'submit_height'              => 'auto',
			'submit_bg_color'            => '3173BE',
			'submit_border_color'        => '3173BE',
			...
			'submit_hover_bg_color'      => '2A63A4',
			'submit_hover_color'         => 'ffffff',
			'submit_hover_border_color'  => '2A63A4',
			'submit_active_bg_color'     => '2A63A4',
			'submit_active_color'        => 'ffffff',
			'submit_active_border_color' => '2A63A4',
