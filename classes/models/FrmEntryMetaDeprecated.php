...
class FrmEntryMetaDeprecated {
	...
	public static function add_entry_meta( $entry_id, $field_id, $meta_key = null, $meta_value ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::add_entry_meta' );
	...
	public static function update_entry_meta( $entry_id, $field_id, $meta_key = null, $meta_value ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::update_entry_meta' );
	...
	public static function update_entry_metas( $entry_id, $values ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::update_entry_metas' );
	...
	public static function duplicate_entry_metas( $old_id, $new_id ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::duplicate_entry_metas' );
	...
	public static function delete_entry_meta( $entry_id, $field_id ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::delete_entry_meta' );
	...
	public static function clear_cache() {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::clear_cache' );
	...
	public static function get_meta_value( $entry, $field_id ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::get_meta_value' );
	...
	public static function get_entry_meta_by_field( $entry_id, $field_id ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::get_entry_meta_by_field' );
	...
	public static function get_entry_metas_for_field( $field_id, $order = '', $limit = '', $args = array() ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::get_entry_metas_for_field' );
	...
	public static function get_entry_meta_info( $entry_id ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::get_entry_meta_info' );
	...
	public static function getAll( $where = array(), $order_by = '', $limit = '', $stripslashes = false ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::getAll' );
	...
	public static function getEntryIds( $where = array(), $order_by = '', $limit = '', $unique = true, $args = array() ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::getEntryIds' );
	...
	public static function search_entry_metas( $search, $field_id = '', $operator ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmEntryMeta::search_entry_metas' );
