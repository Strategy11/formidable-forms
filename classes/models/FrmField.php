	...
	public static function pro_field_selection() {
		...
		$fields     = array(
			'file'            => array(
				...
				'upsell_image' => $images_url . 'upsell/file-upload-field-preview.png',
			),
			'ranking'         => array(),
			'rte'             => array(
				...
				'upsell_image' => $images_url . 'upsell/rich-text-field-preview.png',
			),
			'date'            => array(
				...
				'upsell_image' => $images_url . 'upsell/date-field-preview.png',
			),
			'time'            => array(
				...
				'upsell_image' => $images_url . 'upsell/time-field-preview.png',
			),
			'scale'           => array(
				...
				'upsell_image' => $images_url . 'upsell/scale-field-preview.png',
			),
			'star'            => array(
				...
				'upsell_image' => $images_url . 'upsell/star-field-preview.png',
			),
			'range'           => array(
				...
				'upsell_image' => $images_url . 'upsell/slider-field-preview.png',
			),
			'toggle'          => array(
				...
				'upsell_image' => $images_url . 'upsell/toggle-field-preview.png',
			),
			'data'            => array(
				...
				'upsell_image' => $images_url . 'upsell/dynamic-field-preview.png',
			),
			'lookup'          => array(
				'name'         => __( 'Lookup', 'formidable' ),
				'icon'         => 'frm_icon_font frm_search_icon',
				'message'      => esc_html__( 'Link entries together, dynamic display information, and even make selections from data entered on another form.', 'formidable' ),
				'upsell_image' => $images_url . 'upsell/lookup-field-preview.png',
			),
			'divider|repeat'  => array(
				...
				'upsell_image' => $images_url . 'upsell/repeater-field-preview.png',
			),
			'end_divider'     => array(
			...
			'divider'         => array(
				...
				'upsell_image' => $images_url . 'upsell/section-field-preview.png',
			),
			'break'           => array(
				'name'         => __( 'Page Break', 'formidable' ),
				'icon'         => 'frm_icon_font frm_page_break_icon',
				'message'      => esc_html__( 'Enhance the user experience and improve completion rates by dividing long surveys into clean, manageable steps with distinct pages.', 'formidable' ),
				'upsell_image' => $images_url . 'upsell/page-break-field-preview.png',
			),
			'form'            => array(
				...
				'upsell_image' => $images_url . 'upsell/embed-form-field-preview.png',
			),
			'likert'          => array(
				...
				'upsell_image' => $images_url . 'upsell/likert-field-preview.png',
			),
			'nps'             => array(
				...
				'upsell_image' => $images_url . 'upsell/nps-field-preview.png',
			),
			'password'        => array(
				...
				'upsell_image' => $images_url . 'upsell/password-field-preview.png',
			),
			'tag'             => array(
				...
				'upsell_image' => $images_url . 'upsell/tags-field-preview.png',
			),
			...
			'address'         => array(
				...
				'upsell_image' => $images_url . 'upsell/address-field-preview.png',
			),
			'summary'         => array(
				...
				'upsell_image' => $images_url . 'upsell/summary-field-preview.png',
			),
			'signature'       => array(
				...
				'upsell_image' => $images_url . 'upsell/signature-field-preview.png',
			),
			'ai'              => array(
				...
				'upsell_image' => $images_url . 'upsell/ai-field-preview.png',
			),
			'ssa-appointment' => array(
				...
				'upsell_image' => $images_url . 'upsell/appointment-field-preview.png',
			),
			'product'         => array(
				...
				'upsell_image' => $images_url . 'upsell/product-field-preview.png',
			),
			'quantity'        => array(
				...
				'section'      => 'pricing',
				'message'      => __( 'Turn your form into a simple storefront by adding fields to list products, choose quantities, and calculate totals, enabling direct sales.', 'formidable' ),
				'upsell_image' => $images_url . 'upsell/quantity-field-preview.png',
			),
			'total'           => array(
				...
				'section'      => 'pricing',
				'message'      => __( 'Turn your form into a simple storefront by adding fields to list products, choose quantities, and calculate totals, enabling direct sales.', 'formidable' ),
				'upsell_image' => $images_url . 'upsell/total-field-preview.png',
			),
		);
		...
		if ( self::include_ranking_fields() ) {
			$fields['ranking'] = array(
				...
				'upsell_image' => $images_url . 'upsell/ranking-field-preview.png',
				'addon'        => 'surveys',
