...
class FrmDbDeprecated {
	...
	public function __construct() {
		_deprecated_function( __FUNCTION__, '2.03.04', 'new FrmDb()' );
	...
	public function upgrade( $old_db_version = false ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmDb::upgrade( $old_db_version )' );
	...
	public function collation() {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmDb::collation()' );
	...
	public function uninstall() {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmDb::uninstall()' );
	...
	public static function get_where_clause_and_values( &$args, $starts_with = ' WHERE ' ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmDb::get_where_clause_and_values( $args, $starts_with )' );
	...
	public static function parse_where_from_array( $args, $base_where, &$where, &$values ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmDb::parse_where_from_array( $args, $base_where, $where, $values )' );
	...
	public static function get_count( $table, $where = array(), $args = array() ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmDb::get_count' );
	...
	public static function get_var( $table, $where = array(), $field = 'id', $args = array(), $limit = '', $type = 'var' ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmDb::get_var' );
	...
	public static function get_col( $table, $where = array(), $field = 'id', $args = array(), $limit = '' ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmDb::get_col' );
	...
	public static function get_row( $table, $where = array(), $fields = '*', $args = array() ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmDb::get_row' );
	...
	public static function get_results( $table, $where = array(), $fields = '*', $args = array() ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmDb::get_results' );
	...
	public static function append_where_is( $where_is ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmDb::append_where_is' );
	...
	public static function get_associative_array_results( $columns, $table, $where ) {
		_deprecated_function( __FUNCTION__, '2.03.04', 'FrmDb::get_associative_array_results' );
