...
class FrmEntriesListHelper extends FrmListHelper {
	...
	public function single_row( $item, $style = '' ) {
		...
		$checkbox .= "<label for='cb-item-action-{$item->id}'><span class='screen-reader-text'>" . sprintf( __( 'Select %s', 'formidable' ), FrmFormsHelper::edit_form_link_label( $item->form_id ) ) . '</span></label>';
