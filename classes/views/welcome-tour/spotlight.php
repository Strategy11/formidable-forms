...
?>
<div class="frm-spotlight frm-h-stack-xs frm-force-hidden" data-target="<?php echo esc_attr( $spotlight['target'] ); ?>" data-left-position="<?php echo esc_attr( $spotlight['left-position'] ?? 'end' ); ?>">
