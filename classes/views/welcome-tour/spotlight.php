...
?>
<div class="frm-spotlight frm-welcome-tour-spotlight frm-flex frm-gap-xs frm-items-center frm-force-hidden frm-fadein" data-target="<?php echo esc_attr( $spotlight['target'] ); ?>" data-left-position="<?php echo esc_attr( $spotlight['left-position'] ?? 'end' ); ?>">
