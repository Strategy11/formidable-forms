...
<section id="frm-onboarding-default-email-step" class="frm-onboarding-step frm-card-box frm-has-progress-bar frm_hidden" data-step-name="email">
	...
	<div class="frm-card-box-content frm-fields">
		...
		<div class="frm_form_field frm-mt-lg">
			<p>
				...
				<!-- Email Error -->
				<span id="frm-onboarding-email-step-error" class="frm-form-error frm-mt-xs frm_hidden">
	...
	<div class="frm-card-box-footer">
		...
		<a href="#" id="frm-onboarding-setup-email-step-button" class="button button-primary frm-button-primary frm-onboarding-next-step" role="button">
