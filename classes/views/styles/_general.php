...
<p class="frm4 frm_form_field frm_end">
	...
	<input type="text" name="<?php echo esc_attr( $frm_style->get_field_name( 'fieldset_bg_color' ) ); ?>" id="frm_fieldset_bg_color" class="hex" data-alpha-color-type="rgba" data-alpha-enabled="true" value="<?php echo esc_attr( $style->post_content['fieldset_bg_color'] ); ?>" size="4" />
</p>
