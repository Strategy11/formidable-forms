...
<div class="frm-style-component frm-field-shape frm-radio-component">
	<div class="frm-radio-container frm-flex-box frm-flex-justify">
		...
		<label class="frm-flex-center" for="frm-field-shape-regular" tabindex="0" aria-label="<?php esc_attr_e( 'Square', 'formidable' ); ?>">
		...
		<label class="frm-flex-center" for="frm-field-shape-rounded-corners" tabindex="0" aria-label="<?php esc_attr_e( 'Rounded corners', 'formidable' ); ?>">
		...
		<label class="frm-flex-center" for="frm-field-shape-circle" tabindex="0" aria-label="<?php esc_attr_e( 'Circle', 'formidable' ); ?>">
		...
		<label class="frm-flex-center" for="frm-field-shape-underline" tabindex="0" aria-label="<?php esc_attr_e( 'Underline', 'formidable' ); ?>">
