...
<span class="frm-style-component frm-field-shape frm-radio-component">
	<div class="frm-radio-container frm-flex-box frm-flex-justify">
		...
		<label for="frm-field-shape-regular" tabindex="0">
		...
		<label for="frm-field-shape-rounded-corners" tabindex="0">
		...
		<label for="frm-field-shape-circle" tabindex="0">
		...
		<label for="frm-field-shape-underline" tabindex="0">
