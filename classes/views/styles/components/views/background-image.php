<div class="frm-style-component frm-background-image">
	<div class="frm-flex-justify">
		...
		<?php
			do_action( 'frm_style_settings_general_section_after_background', array( 'frm_style' => $component['frm_style'], 'style' => $component['style'], 'image_id_input_name' => $component['image_id_input_name'] ) );
