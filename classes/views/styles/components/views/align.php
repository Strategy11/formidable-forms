<span class="<?php echo esc_attr( $component_class ); ?>">
	<div class="frm-radio-container frm-flex-box frm-flex-justify">
		<?php if ( empty( $component['options'] ) || in_array( 'left', $component['options'] ) ) : ?>
		...
		<?php if ( empty( $component['options'] ) || in_array( 'center', $component['options'] ) ) : ?>
		...
		<?php if ( empty( $component['options'] ) || in_array( 'right', $component['options'] ) ) : ?>
