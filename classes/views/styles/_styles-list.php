...
// It is accessed from /wp-admin/admin.php?page=formidable-styles&form_id=782
?>
<div id="frm_style_sidebar">
	...
	?>
	<form id="frm_style_form" method="post" action="<?php echo esc_url( admin_url( 'admin.php?page=formidable&frm_action=style&form_id=' . $form->id .'&t=advanced_settings' ) ); ?>">
