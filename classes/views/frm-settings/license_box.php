...
<?php if ( ! is_multisite() || current_user_can( 'setup_network' ) ) { ?>
    <div class="postbox">
        <div class="inside">
			<p><?php _e( 'Get more field types including multiple file upload and cascading lookups. PLUS multi-page forms, calculations, repeatable sections, confirmation fields, conditional logic, front-end editing, views, data management, and graph & stat reporting.', 'formidable' ) ?>
