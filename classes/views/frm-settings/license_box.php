...
<div id="frm_license_top" class="frm_unauthorized_box">
	<p id="frm-connect-btns" class="frm-show-unauthorized">
		<a href="<?php echo esc_url( FrmAddonsController::connect_link() ); ?>" class="button-primary frm-button-primary frm-button-sm" target="_blank" rel="noopener noreferrer">
	...
	<div id="frm-using-lite" class="frm-show-unauthorized">
		...
		<p>
			...
			printf(
				...
				'<a href="' . esc_url( $unlock_more_upgrade_link ) . '" target="_blank" rel="noopener noreferrer">',
