...
<div class="frm_with_left_label">
	...
	<p>
		Already have a PRO license? <a href="<?php echo esc_url( FrmAppHelper::make_affiliate_url( FrmAppHelper::admin_upgrade_link( 'settings-license', 'knowledgebase/install-formidable-forms/' ) ) ); ?>" target="_blank"><?php esc_html_e( 'Get the installation instructions', 'formidable' ); ?></a>.
	</p>
</div>
<div class="clear"></div>
