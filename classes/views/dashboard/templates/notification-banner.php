<div class="frm-dashboard-banner">
	...
	<div class="frm-flex-box frm-justify-between frm-align-center">
		<div>
			...
			<p>Whether you're looking to create simple contact forms or complex survey forms, Formidable Forms has you covered.</p>
		</div>
		<div>
			<a href="#" title="" class="frm-button-secondary">Check all features</a>
		</div>
	</div>
</div>