...
<input type="hidden" name="frm_hide_fields_<?php echo $form->id ?>" id="frm_hide_fields_<?php echo $form->id ?>" value="<?php echo esc_attr($frm_hide_fields) ?>" />
<input type="hidden" name="frm_helpers_<?php echo $form->id ?>" id="frm_helpers_<?php echo $form->id ?>" value="<?php echo esc_attr( $frm_helpers ) ?>" />
