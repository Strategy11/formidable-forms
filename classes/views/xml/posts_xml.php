...
foreach ( (array) $terms as $term ) {
	...
	?>
	<term><term_id><?php echo esc_html( $term->term_id ); ?></term_id><?php echo $term_parent; ?><term_taxonomy><?php echo esc_html( $term->taxonomy ); ?></term_taxonomy><?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	if ( ! empty( $term->name ) ) {
