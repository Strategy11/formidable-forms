...
$aria_label   = isset( $args['aria-label-attr'] ) ? $args['aria-label-attr'] : '';
...
?>
	<label class="frm_toggle_block" <?php FrmAppHelper::array_to_html_params( $div_params, true ); ?>>
		...
		<span class="frm_toggle" tabindex="0" role="switch"  aria-label="<?php echo esc_attr( $aria_label ); ?>" aria-labelledby="<?php echo esc_attr( $id ); ?>_label" aria-checked="<?php echo esc_attr( $aria_checked ); ?>">
