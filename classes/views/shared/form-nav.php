...
<li class="first"><a<?php FrmAppHelper::select_current_page( 'formidable', array( 'edit', 'new', 'duplicate' ) ); ?> href="<?php echo esc_url( admin_url('admin.php?page=formidable&frm_action=edit&id='. $id) ) ?>"><?php _e( 'Build', 'formidable' ) ?></a> </li>
<li><a<?php FrmAppHelper::select_current_page( 'formidable', array( 'settings' ) ); ?> href="<?php echo esc_url( admin_url('admin.php?page=formidable&frm_action=settings&id='. $id) ) ?>"><?php _e( 'Settings', 'formidable' ) ?></a> </li>
...
<li> <a<?php FrmAppHelper::select_current_page( 'formidable', array( 'reports' ) ); ?> href="<?php echo esc_url( admin_url('admin.php?page=formidable&frm_action=reports&form='. $id .'&show_nav=1') ) ?>"><?php _e( 'Reports', 'formidable' ) ?></a></li>
