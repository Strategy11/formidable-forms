...
<div class="frm_wrap frm-views-info-page">
	...
	<div class="frmcenter frm-m-12" style="max-width:706px;margin:auto;padding-top:50px;">
		...
		?>
		<a href="<?php echo esc_url( FrmAppHelper::admin_upgrade_link( $demo_link_args, 'demos/' ) ); ?>" class="frm-mb-md frm-ml-xs frm-button-secondary" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'View Demos', 'formidable' ); ?></a>
		...
		<div class="frm_grid_container">
			<div class="frm6">
				<div class="frm-views-learn-more">
					...
					<a href="<?php echo esc_url( FrmAppHelper::admin_upgrade_link( $learn_more_utm, 'features/display-form-data-views/' ) ); ?>" class="frm-button-secondary" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Learn more', 'formidable' ); ?></a>
				</div>
			</div>
			<div class="frm6">
		...
		<div class="frm_grid_container frm-views-reviews">
			<div class="frm4">
				<div class="frm-views-review">
					...
					<div class="frm-views-review__desc">
						<?php echo esc_html( FrmAddonsHelper::get_reviews_text( '1,300+', 'WordPress.org' ) ); ?>
					</div>
			...
			<div class="frm4">
				<div class="frm-views-review">
					<svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" fill="none"><g fill="#EC573C" clip-path="url(#b)"><path d="M15.7 5.8h-2.6c0-.4.3-.7.8-1l.5-.2c.9-.4 1.3-1 1.3-1.7 0-.5-.2-1-.6-1.2-.4-.3-.8-.5-1.4-.5-.4 0-.8.2-1.2.4a2 2 0 0 0-.7.8l.7.8c.3-.6.7-.9 1.3-.9.5 0 .8.3.8.6s-.2.5-.7.8l-.3.1c-.7.4-1.2.8-1.4 1.2-.3.4-.4 1-.4 1.7v.1h3.9v-1ZM15.4 8H11L9 11.8h4.3l2.2 3.8 2.1-3.8-2.1-3.7Z"/><path d="M9.3 14.3a5 5 0 0 1 0-10L11 .9A8.8 8.8 0 0 0 .5 9.3a8.7 8.7 0 0 0 13.9 7l-1.9-3.2a5 5 0 0 1-3.2 1.2Z"/></g><defs><clipPath id="b"><path fill="#fff" d="M.5.6H18V18H.5z"/></clipPath></defs></svg>
					...
					<div class="frm-views-review__desc">
						<?php echo esc_html( FrmAddonsHelper::get_reviews_text( 99, 'G2' ) ); ?>
					</div>
				</div><!-- End .frm-views-review -->
			</div>
			...
			<div class="frm4">
				<div class="frm-views-review">
					...
					<div class="frm-views-review__desc">
						<?php echo esc_html( FrmAddonsHelper::get_reviews_text( 114, 'Capterra' ) ); ?>
					</div>
				</div><!-- End .frm-views-review -->
			</div>
		</div>
