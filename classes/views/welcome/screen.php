...
<div class="frm-we-wrapper">
			...
			<div class="column">
				<div class="frm-we-block-1">
					...
					<div class="frm-we-buttons">
						<div class="frm-we-btn bg-blue"><a href="#"><?php esc_html_e( 'Activate Formidable Form', 'formidable' ); ?></a></div>
						<div class="frm-we-btn bg-transparent"><a href="#"><?php esc_html_e( 'Reactivate my account', 'formidable' ); ?></a></div>
					</div>
				</div>
			</div>
			<div class="column">
				<div class="frm-we-block-2">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/d2IPmicn2x8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
		</div>
	</div>
	...
	<div>
		<div class="row">
			<div class="column">
				<div class="frm-we-block-left">
					<div class="icon"><img src="<?php echo esc_url( FrmAppHelper::plugin_url() . '/images/plus.svg' ); ?>"></div>
	...
	<div class="frm-we-carousel-wrapper">
		...
		<div class="row">
			<div class="column col-4">
				...
				<div class="btn"><a href="#"><?php esc_html_e( 'Upgrade', 'formidable' ); ?></a></div>
			</div>
			<div class="column col-4">
