...
<p class="frm-flex-col">
	...
	<textarea id="frm_description_<?php echo esc_attr( $field['id'] ); ?>" name="field_options[description_<?php echo esc_attr( $field['id'] ); ?>]" class="frm_long_input" rows="2" data-changeme="field_description_<?php echo esc_attr( $field['id'] ); ?>"><?php
