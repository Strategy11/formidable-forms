...
if ( isset( $field['post_field'] ) && $field['post_field'] == 'post_category' ) {
	...
	foreach ( $field['options'] as $opt_key => $opt ) {
		...
		?>
		<div class="<?php echo esc_attr( apply_filters( 'frm_radio_class', 'frm_radio', $field, $field_val ) ); ?> <?php echo esc_attr( $image_option_class ); ?>" id="<?php echo esc_attr( FrmFieldsHelper::get_checkbox_id( $field, $opt_key, 'radio' ) ); ?>"><?php
