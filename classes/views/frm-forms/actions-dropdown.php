...
<div class="frm_actions_dropdown dropdown <?php echo esc_attr( is_rtl() ? 'dropdown-menu-right' : 'dropdown-menu-left' ); ?>">
	<a href="#" id="frm-actionsDrop" aria-label="<?php echo esc_attr__( 'Dropdown toggle', 'formidable' ); ?>" class="frm-dropdown-toggle frmfont frm_option_icon" data-toggle="dropdown" title="<?php esc_attr_e( 'Show options', 'formidable' ); ?>"></a>
