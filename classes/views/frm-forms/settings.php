...
<form method="post" class="frm_form_settings">
    ...
    <input type="hidden" name="frm_action" value="update_settings" />
        ...
        <ul class="frm-category-tabs frm-form-setting-tabs">
			...
			<li <?php echo ( $a === 'advanced_settings' ) ? 'class="tabs active"' : '' ?>>
				<a href="#advanced_settings"><?php esc_html_e( 'General', 'formidable' ) ?></a>
			</li>
			<li <?php echo ( $a === 'email_settings' ) ? 'class="tabs active"' : '' ?>>
				<a href="#email_settings"><?php esc_html_e( 'Form Actions', 'formidable' ); ?></a>
			</li>
			<li <?php echo ( $a === 'html_settings' ) ? 'class="tabs active"' : '' ?>>
        ...
        <div class="advanced_settings tabs-panel <?php echo ($a == 'advanced_settings') ? 'frm_block' : 'frm_hidden' ?>">
                ...
                <tr>
                    <td colspan="2"><?php esc_html_e( 'Use Akismet to check entries for spam for', 'formidable' ) ?>
                        <select name="options[akismet]">
                            <option value=""><?php esc_html_e( 'no one', 'formidable' ) ?></option>
							<option value="1" <?php selected( $values['akismet'], 1 ) ?>><?php esc_html_e( 'everyone', 'formidable' ) ?></option>
							<option value="logged" <?php selected( $values['akismet'], 'logged' ) ?>><?php esc_html_e( 'visitors who are not logged in', 'formidable' ) ?></option>
                        </select>
                    </td>
                </tr>
                <?php } ?>
            ...
            <table class="form-table">
                <tr>
                    <td class="frm_left_label"><label for="custom_style"><?php esc_html_e( 'Style Template', 'formidable' ) ?></label></td>
                    <td><select name="options[custom_style]" id="custom_style">
						<option value="1" <?php selected( $values['custom_style'], 1 ) ?>><?php esc_html_e( 'Always use default', 'formidable' ) ?></option>
                        ...
                        <?php } ?>
						<option value="0" <?php selected( $values['custom_style'], 0 ); selected( $values['custom_style'], '' ) ?>><?php esc_html_e( 'Do not use Formidable styling', 'formidable' ) ?></option>
                    </select></td>
                </tr>
                <tr>
            ...
            <!--Message Section-->
			<h3 id="frm_messages_header" class="<?php echo ( ( isset( $values['edit_action'] ) && $values['edit_action'] == 'message' && isset( $values['editable'] ) && $values['editable'] == 1 ) || $values['success_action'] == 'message' || $values['save_draft'] == 1 ) ? '' : 'frm_hidden'; ?>"><?php esc_html_e( 'Messages', 'formidable' ); ?>
