...
<div class="frm-banner-alert frm_error_style frm_previous_install">
	...
	<?php if ( FrmAddonsController::is_license_expired() ) : ?>
		...
		?>
		Please <a href="<?php echo esc_url( FrmAppHelper::admin_upgrade_link( $utm, 'account/downloads/' ) ); ?>" target="_blank" rel="noopener noreferrer">renew now</a> to get the latest version.
	<?php else : ?>
