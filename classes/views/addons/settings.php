	...
	foreach ( $plugins as $slug => $plugin ) {
		...
		<div class="edd_frm_license_row frm-inline-select frm_grid_container">
			...
			<div class="edd_frm_authorized frm8 frm_form_field <?php echo esc_attr( $activate === 'activate' ) ? 'frm_hidden' : ''; ?>">
				...
				<span class="frm_icon_font frm_action_success"><?php FrmAppHelper::icon_by_class( 'frmfont frm_check1_icon frm_action_icon edd_frm_status_icon frm_inactive_icon' ); ?></span>
				<span class="frm_icon_font frm_action_error frm_hidden"><?php FrmAppHelper::icon_by_class( 'frmfont frm_cancel1_icon edd_frm_status_icon' ); ?></span>
			...
			<div class="edd_frm_unauthorized frm8 frm_form_field <?php echo esc_attr( $activate === 'deactivate' ) ? 'frm_hidden' : ''; ?>">
				...
				<span class="frm_icon_font frm_action_success <?php echo esc_attr( $icon_class ); ?>"><?php FrmAppHelper::icon_by_class( 'frmfont frm_check1_icon edd_frm_status_icon' ); ?></span>
				<span class="frm_icon_font frm_action_error frm_hidden"><?php FrmAppHelper::icon_by_class( 'frmfont frm_cancel1_icon edd_frm_status_icon' ); ?></span>
