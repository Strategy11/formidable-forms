			...
			<div id="post-body-content" class="frm-flex-col frm-gap-sm frm-p-md frm-hide-js">
				<div class="frm-list-grid-layout">
					...
					if ( ! FrmAppHelper::pro_is_installed() ) {
						?>
					<button id="frm-form-templates-create-ai-form" class="frm-flex-box frm-items-center frm-form-templates-create-button frm_show_upgrade" data-upgrade="<?php esc_attr_e( 'Create with AI', 'formidable' ); ?>">
