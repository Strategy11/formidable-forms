...
.frm-grid th{
	...
	border-width:1px;
	border-style:solid;
	<?php if ( ! empty( $defaults['border_color'] ) ) { ?>border-color:<?php echo esc_html( $defaults['border_color'] ); ?>;<?php } ?>
	border-top:none;
	border-left:none;
	border-right:none;
}
...
table.form_results.with_frm_style tr td{
	text-align:left;
	<?php if ( ! empty( $defaults['text_color'] ) ) { ?>color:<?php echo esc_html( $defaults['text_color'] ); ?>;<?php } ?>
	padding:7px 9px;
	<?php if ( ! empty( $defaults['border_color'] ) ) { ?>border-top:1px solid <?php echo esc_html( $defaults['border_color'] ); ?>;<?php } ?>
}
...
.frm-grid .frm_odd{
	<?php if ( ! empty( $defaults['border_color'] ) ) { ?>background-color:<?php echo esc_html( FrmStylesHelper::adjust_brightness( $defaults['border_color'], 45 ) ); ?>;<?php } ?>
}
...
#frm_loading .progress-striped .progress-bar{
	<?php if ( ! empty( $defaults['border_color'] ) ) { ?>background-image:linear-gradient(45deg, <?php echo esc_html( $defaults['border_color'] ); ?> 25%, rgba(0, 0, 0, 0) 25%, rgba(0, 0, 0, 0) 50%, <?php echo esc_html( $defaults['border_color'] ); ?> 50%, <?php echo esc_html( $defaults['border_color'] ); ?> 75%, rgba(0, 0, 0, 0) 75%, rgba(0, 0, 0, 0));<?php } ?>
