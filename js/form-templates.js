...
function createApplicationTemplates(applications) {
  ...
  applicationTemplates = div({
    ...
    children: [tag('h2', {
      ...
      className: "".concat(_shared__WEBPACK_IMPORTED_MODULE_2__.PREFIX, "-list frm-list-grid-layout"),
...
var onGetTemplatesButtonClick = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var _getElements2, leaveEmailModalInput, email, _getElements3, leaveEmailModalButton, formData, data, doJsonPost, _t;
...
function _initializeModal() {
  _initializeModal = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
