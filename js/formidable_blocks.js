...
var FormidableIcon = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(FormidableIcon, [{
    ...
    value: function loadCustomSvgIcon() {
      var _formidable_form_sele = formidable_form_selector,
        icon = _formidable_form_sele.icon;
...
function Edit(_ref) {
  ...
  var _formidable_form_sele = formidable_form_selector,
    forms = _formidable_form_sele.forms;
...
function Edit(_ref) {
  ...
  return wp.element.createElement("div", blockProps, wp.element.createElement("div", {
    ...
    src: "".concat(formidable_form_selector.url, "/images/conversion-calc.jpg"),
...
(function () {
  ...
  function Edit() {
    ...
    return wp.element.createElement("div", blockProps, wp.element.createElement("div", {
      ...
      src: "".concat(formidable_form_selector.url, "/images/demo-graph.svg"),
      alt: blockName
    }))))));
  }
  ...
  return _createClass(Inspector, [{
    ...
    value: function render() {
      ...
      return wp.element.createElement(InspectorControls, null, wp.element.createElement(PanelBody, {
        ...
        href: "".concat((0,_common_utilities_values__WEBPACK_IMPORTED_MODULE_2__.getSubDir)(), "wp-admin/admin.php?page=formidable&frm_action=edit&id=").concat(formId)
...
function Edit(_ref2) {
  ...
  return wp.element.createElement("div", blockProps, wp.element.createElement("div", {
    ...
    src: "".concat(formidable_form_selector.url, "/images/modal.png"),
    alt: blockName,
    style: imageStyles
  }))))));
}
registerBlockType('frm-modal/modal', {
  apiVersion: 3,
  title: "".concat(formidable_form_selector.name, " ").concat(__('Modal', 'formidable')),
...
var useBlockProps = wp.blockEditor.useBlockProps;
var blockData = formidable_form_selector;
...
function Edit() {
  ...
  var activateViewsAddon = function activateViewsAddon() {
    ...
    updateAddonActivateButton(_objectSpread(_objectSpread({}, addonActivateButton), {}, {
      isLoading: true,
      classnames: "".concat(addonActivateButton.defaultClassname, " ").concat(addonActivateButton.loadingClassname)
    }));
  ...
  return wp.element.createElement("div", blockProps, wp.element.createElement("div", {
    ...
    src: "".concat(blockData.url, "/images/blocks/views-block-placeholder.jpg"),
    alt: blockName,
    style: imageStyles
  }))))));
}
