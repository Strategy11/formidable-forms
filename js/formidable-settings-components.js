...
var frmRadioComponent = /*#__PURE__*/function () {
  function frmRadioComponent() {
    ...
    window.addEventListener('resize', function () {
      return _this.throttledUpdateAllTrackers();
    });
  }
  ...
  return _createClass(frmRadioComponent, [{
    ...
    key: "throttledUpdateAllTrackers",
    value: function throttledUpdateAllTrackers() {
      var _this5 = this;
      if (this.resizeTimeout) {
        return;
      }
      this.resizeTimeout = requestAnimationFrame(function () {
        _this5.resizeTimeout = null;
        document.querySelectorAll('.frm-radio-component input[type="radio"]:checked').forEach(function (radio) {
          var wrapper = radio.closest('.frm-radio-component');
    ...
    value: function triggerValueChange(index) {
      ...
      if (input instanceof NodeList) {
        input.forEach(function (item) {
          item.dispatchEvent(_this0.eventsChange[index]);
        });
        return;
      }
    ...
    value: function updateValue(element, value) {
      ...
      if (element.classList.contains('frm-has-multiple-values')) {
        ...
        childSlidersGroup.forEach(function (slider) {
          var unitMeasure = _this1.getUnitMeasureFromValue(value);
