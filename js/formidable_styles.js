...
/* harmony import */ var _components_dependent_updater_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/dependent-updater-component */ "./js/src/admin/components/dependent-updater-component.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
function _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
...
var frmStyleOptions = /*#__PURE__*/function () {
  ...
  return _createClass(frmStyleOptions, [{
    ...
    value: function initCustomCSSEditorInstance() {
      var _this = this;
      ...
      if ('undefined' === typeof window.frm_single_style_custom_css_wp_editor || 'undefined' === typeof window.frm_single_style_custom_css_wp_editor.codemirror) {
        setTimeout(function () {
          _this.cssEditorOptions.retryCount++;
          _this.initCustomCSSEditorInstance();
        }, 500);
        return;
      }
    ...
    key: "getInlineStyleElement",
    value: function getInlineStyleElement() {
    ...
    key: "onCssEditorReady",
    value: function onCssEditorReady() {
      var _document$getElementB,
        _this2 = this;
      var cssScope = (_document$getElementB = document.getElementById('frm_style_class_custom_css')) === null || _document$getElementB === void 0 || (_document$getElementB = _document$getElementB.dataset) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.cssScope;
      if (null === cssScope) {
        return;
      }
      var sanitizedCssScope = CSS.escape(cssScope);
      this.cssEditorInstance.on('change', function (editor) {
        var value = editor.getValue().replace(/<[^>]*>/g, '').trim();
        _this2.getInlineStyleElement().textContent = ".".concat(sanitizedCssScope, " { ").concat(value, " }");
      });
    }
    ...
    value: function initColorPickerDependentUpdaterComponents() {
      ...
      components.forEach(function (component) {
        ...
        if (null !== id) {
          elements.push({
            id: id,
            dependentUpdaterClass: new _components_dependent_updater_component__WEBPACK_IMPORTED_MODULE_1__["default"](component, 'colorpicker')
          });
        }
      });
    ...
    value: function initStyleClassCopyToClipboard(successMessage) {
      var _this3 = this;
      var labels = document.querySelectorAll('.frm-copy-text');
      labels.forEach(function (label) {
        label.addEventListener('click', function (event) {
          var className = event.currentTarget.innerText;
          if (!navigator.clipboard || !navigator.clipboard.writeText) {
            if (true === _this3.fallbackCopyToClipboard(className, event.currentTarget)) {
              _this3.success(successMessage);
            }
            return;
          }
    ...
    key: "toggleVisibilityOfCustomCSSEditor",
    value: function toggleVisibilityOfCustomCSSEditor() {
      var toggle = document.getElementById('frm_enable_single_style_custom_css');
      var editor = document.getElementById('frm_single_style_custom_css_editor');
      if (!toggle || !editor) {
        return;
      }
    ...
    value: function fallbackCopyToClipboard(couponCode, copyButton) {
