...
"use strict";
/*!**************************************!*\
  !*** ./js/src/admin/styles/index.js ***!
  \**************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   frmRadioStyleComponent: function() { return /* binding */ frmRadioStyleComponent; },
/* harmony export */   frmSliderStyleComponent: function() { return /* binding */ frmSliderStyleComponent; },
/* harmony export */   frmStyleDependendUpdaterComponent: function() { return /* binding */ frmStyleDependendUpdaterComponent; },
/* harmony export */   frmStyleOptions: function() { return /* binding */ frmStyleOptions; },
/* harmony export */   frmTabsStyleComponent: function() { return /* binding */ frmTabsStyleComponent; }
/* harmony export */ });
...
var frmRadioStyleComponent = /*#__PURE__*/function () {
  ...
  _createClass(frmRadioStyleComponent, [{
    key: "init",
    value: function init() {
      var _this = this;
    ...
    value: function initOnRadioChange(wrapper) {
      var _this2 = this;
      wrapper.querySelectorAll('input[type="radio"]').forEach(function (radio) {
        radio.addEventListener('change', function (event) {
          _this2.onRadioChange(event.target.closest('.frm-style-component.frm-radio-component'));
        });
      });
    }
  }, {
    key: "onRadioChange",
    value: function onRadioChange(wrapper) {
      var activeItem = wrapper.querySelector('input[type="radio"]:checked + label');
      this.moveTracker(activeItem, wrapper);
    }
  }, {
    key: "getRadioIndex",
    value: function getRadioIndex(radio) {
      var radioButtons = Array.from(wrapper.querySelectorAll('input[type="radio"]'));
...
var frmSliderStyleComponent = /*#__PURE__*/function () {
  function frmSliderStyleComponent() {
    ...
    this.valueChangeDebouncer = debounce(function (index) {
      return _this3.triggerValueChange(index);
    }, 25);
    this.initOptions();
    this.init();
  }
  _createClass(frmSliderStyleComponent, [{
    key: "initOptions",
    ...
    value: function initDraggable() {
      var _this5 = this;
      this.elements.forEach(function (element, index) {
        _this5.eventsChange[index] = new Event('change', {
          'bubbles': true,
          'cancelable': true
        });
        ...
        if ('undefined' !== typeof element.dataset.displaySliders) {
          var sliderGroupItems = _this5.getSliderGroupItems(element);
          if (null !== element.querySelector('.frmsvg')) {
            element.querySelector('.frmsvg').addEventListener('click', function () {
        ...
        valueInput.addEventListener('change', function (event) {
          ...
          if (_this5.getMaxValue(unit, index) < parseInt(event.target.value, 10)) {
            return;
          }
          _this5.initSliderWidth(element);
          _this5.updateValue(element, valueInput.value + unit);
          _this5.triggerValueChange(index);
        });
        draggableBullet.addEventListener('mousedown', function (event) {
          _this5.enableDragging(event, index);
        });
        draggableBullet.addEventListener('mousemove', function (event) {
          _this5.moveTracker(event, index);
        });
        draggableBullet.addEventListener('mouseup', function (event) {
          _this5.disableDragging(index, event);
        });
    ...
    value: function initSlidersPosition() {
      ...
      accordionitems.forEach(function (item, index) {
        if (0 === index) {
          _this6.initSlidersWidth(item.closest('.accordion-section'));
        }
    ...
    value: function initSliderWidth(slider) {
      ...
      var sliderWidth = slider.querySelector('.frm-slider').offsetWidth - 14;
    ...
    value: function initChildSlidersWidth(slider, width, index, value) {
      ...
      childSliders.forEach(function (item, childIndex) {
        ...
        _this8.options[index + childIndex + 1].translateX = width;
        _this8.options[index + childIndex + 1].value = value;
      });
    }
  }, {
    key: "getSliderIndex",
    ...
    value: function triggerValueChange(index) {
      ...
      var input = this.elements[index].classList.contains('frm-has-multiple-values') ? this.elements[index].closest('.frm-style-component').querySelector('input[type="hidden"]') : this.elements[index].querySelectorAll('.frm-slider-value input[type="hidden"]');
      if (input instanceof NodeList) {
        input.forEach(function (item) {
          item.dispatchEvent(_this9.eventsChange[index]);
        });
        return;
      }
    ...
    value: function calculateValue(width, deltaX, maxValue) {
      var value = Math.ceil((deltaX + 14) / width * maxValue);
      if (value < 0) {
        return 0;
      }
  ...
  return frmSliderStyleComponent;
}();
var frmTabsStyleComponent = /*#__PURE__*/function () {
  ...
  _createClass(frmTabsStyleComponent, [{
    key: "init",
    value: function init() {
      this.elements.forEach(function (element) {
        new _components_class_tabs_navigator__WEBPACK_IMPORTED_MODULE_1__.frmTabsNavigator(element);
      });
    }
  }, {
    key: "initOnTabClick",
    value: function initOnTabClick(wrapper) {
      ...
      wrapper.querySelectorAll('.frm-tab-item').forEach(function (tab) {
        tab.addEventListener('click', function (event) {
          _this10.onTabClick(event.target.closest('.frm-tabs-wrapper'));
        });
      });
    }
  }]);
  return frmTabsStyleComponent;
}();
var frmStyleDependendUpdaterComponent = /*#__PURE__*/function () {
  function frmStyleDependendUpdaterComponent(component) {
    _classCallCheck(this, frmStyleDependendUpdaterComponent);
  ...
  _createClass(frmStyleDependendUpdaterComponent, [{
    ...
    key: "updateAllDependendElements",
    value: function updateAllDependendElements(value) {
  ...
  return frmStyleDependendUpdaterComponent;
}();
var frmStyleOptions = /*#__PURE__*/function () {
  ...
  _createClass(frmStyleOptions, [{
    ...
    key: "initColorPickerDependendUpdaterComponents",
    value: function initColorPickerDependendUpdaterComponents() {
      var components = document.querySelectorAll('.frm-style-dependend-updater-component.frm-colorpicker');
      var elements = [];
    ...
    value: function initStyleClassCopyToClipboard(successMessage) {
      ...
      copyLabel.addEventListener('click', function (event) {
        ...
        navigator.clipboard.writeText(className).then(function () {
          _this11.success(successMessage);
        });
      });
    }
  }]);
  return frmStyleOptions;
}();
new frmStyleOptions();
}();
/******/ })()
