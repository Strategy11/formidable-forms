...
window.frmAdminBuildJS = function () {
  ...
  function liveChanges(event) {
    var shouldTryBreakFieldGroup = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    /*jshint validthis:true */
    var option,
      newValue = this.value,
  ...
  function changeFieldClass(field, setting, shouldTryBreakFieldGroup) {
    ...
    if (shouldTryBreakFieldGroup && replaceWith.includes('frm_first') && !classes.includes('frm_first')) {
      var fieldsInFieldBox = Array.from(field.parentElement.children);
      var indexOfTargetField = fieldsInFieldBox.indexOf(field);
      var fieldBox = field.parentElement.closest('li.frm_field_box.ui-draggable');
      var newFieldBox = fieldBox.cloneNode(true);
      // Delete the singlings up to indexOfTargetField
      for (var _i13 = indexOfTargetField; _i13 < fieldsInFieldBox.length; _i13++) {
        fieldsInFieldBox[_i13].remove();
      }
      fieldBox.after(newFieldBox);
      var fieldsInNewFieldBox = Array.from(newFieldBox.firstChild.children);
      for (var _i14 = 0; _i14 < indexOfTargetField; _i14++) {
        fieldsInNewFieldBox[_i14].remove();
      }
    }
    //
  ...
  function selectedOptions(select) {
    ...
    for (var _i15 = 0, iLen = options.length; _i15 < iLen; _i15++) {
      opt = options[_i15];
      if (opt.selected) {
