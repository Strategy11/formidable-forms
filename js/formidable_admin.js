...
window.frmAdminBuildJS = function () {
  ...
  function searchSelectByText(selectElement, searchText) {
    ...
    for (var _i0 = 0; _i0 < options.length; _i0++) {
      var option = options[_i0];
  ...
  function clickVis(e) {
    ...
    if (e !== null && e !== void 0 && e.metaKey || e !== null && e !== void 0 && e.ctrlKey) {
      var groupIsActive = this.closest('ul').classList.contains('frm-selected-field-group');
      var $selectedFieldGroups = getSelectedFieldGroups();
      var numberOfSelectedGroups = $selectedFieldGroups.length;
      if (groupIsActive) {
        // Unselect if holding ctrl or cmd and the group was already active.
  ...
  function fillDropdownOpts(field, atts) {
    ...
    for (var _i1 = 0; _i1 < opts.length; _i1++) {
      var label = opts[_i1].label,
        isOther = opts[_i1].key.indexOf('other') !== -1;
      ...
      if (!isOther || showOther) {
        ...
        opt.value = opts[_i1].saved;
        opt.innerHTML = purifyHtml(label);
        if (isProduct) {
          opt.setAttribute('data-price', opts[_i1].price);
        }
  ...
  function imagesAsOptions(fieldId) {
    ...
    for (var _i10 = 0; _i10 < field.length; _i10++) {
      if (field[_i10].checked) {
        checked = '0' !== field[_i10].value;
      }
    }
  ...
  function selectedOptions(select) {
    ...
    for (var _i11 = 0, iLen = options.length; _i11 < iLen; _i11++) {
      opt = options[_i11];
      if (opt.selected) {
