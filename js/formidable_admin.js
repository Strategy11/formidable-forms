...
window.frmAdminBuildJS = function () {
  ...
  function confirmLinkClick(link) {
    ...
    if ('entries-list' === loadedFrom) {
      var _confirmModal = wp.hooks.applyFilters('frm_on_multiple_entries_delete', {
        link: link,
        initModal: initModal
      });
      if (typeof _confirmModal === 'string') {
        return _confirmModal;
      }
      return confirmDeleteAllEntriesModal({
        link: link,
        initModal: initModal
      });
    }
  ...
  function confirmDeleteAllEntriesModal(args) {
    ...
    this.getCopy = function () {
      ...
      var copy = window.frmDom.tag('span');
    ...
    this.updateOnDeleteURL = function () {
      var triggerOnDeleteActions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
    ...
    this.initConfirmButton = function (active) {
      ...
      if (true === active) {
        ...
        var triggerActionsOnDeleteEl = document.getElementById('frm_trigger_on_delete_entry_actions');
    ...
    this.initModal = function () {
      ...
      var copyWrapper = self.wrapper.querySelector('.frm-confirm-msg');
      ...
      var onDeleteActionsTrigger = self.getOnDeleteActionsTriggerCheckbox();
      if (link.getAttribute('data-total-entries') && ('undefined' === typeof frmEntriesData || frmEntriesData.hasPostAction === '0') && onDeleteActionsTrigger) {
  ...
  function handleAjaxLoadFieldSuccess(html, $thisField, field) {
    ...
    for (key in html) {
      ...
      var newReplacedField = document.getElementById('frm_field_id_' + key);
      if (newReplacedField) {
  ...
  function markUnique() {
    ...
    if (this.checked) {
      ...
      var $unqDetail = jQuery('.frm_unique_details' + fieldId + ' input');
      if ($unqDetail.val() === '') {
  ...
  function addFieldOption() {
    ...
    (_this$closest = this.closest('.frm_sortable_field_opts')) === null || _this$closest === void 0 || (_this$closest = _this$closest.querySelectorAll('.frm_remove_tag.frm_disabled')) === null || _this$closest === void 0 || _this$closest.forEach(function (button) {
