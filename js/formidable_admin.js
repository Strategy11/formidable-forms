...
function closePopupButton() {
  ...
  a.textContent = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Close', 'formidable');
  return a;
}
...
function addOneClick(link, context, upgradeLabel) {
  ...
  if (oneclickMessage !== null && typeof oneclick !== 'undefined' && oneclick) {
    ...
    if (oneclick.class === 'frm-activate-addon') {
      ...
      oneclickMessage.textContent = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('That add-on is not installed. Would you like to install it now?', 'formidable');
      button.textContent = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Install', 'formidable');
    }
  }
  if (!newMessage) {
...
window.frmAdminBuildJS = function () {
  ...
  function getMultipleOpts(fieldId) {
    ...
    var i,
      ...
      opts = [],
      imageUrl = '';
    var optVals = jQuery('input[name^="field_options[options_' + fieldId + ']"]');
  ...
  function populateUpgradeTab(element) {
    ...
    if (upgradeModalLink) {
      var upgradeButton = upgradeModalLink.cloneNode(true);
...
jQuery(document).ready(function () {
  ...
  (_document$querySelect9 = document.querySelector('.preview.dropdown .frm-dropdown-toggle')) === null || _document$querySelect9 === void 0 || _document$querySelect9.setAttribute('data-toggle', 'dropdown');
