...
function frmAdminBuildJS() {
	...
	function maybeUpdateFieldOptionValues() {
		var i, value, label, match, defaultVal, separateValues,
			labels = document.querySelectorAll( '#new_fields .frm_single_option:not([data-optkey="000"]) [name^="field_options[options_"][name$="[label]"],[name^="field_options[options_"][name*="other_"]' );
