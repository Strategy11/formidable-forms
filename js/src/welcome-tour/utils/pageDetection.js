 ...
 *
 * @returns {boolean} True if the current page is the editor page, false otherwise.
 */
 ...
 *
 * @returns {boolean} True if the current page is the styler page, false otherwise.
 */
 ...
 *
 * @returns {boolean} True if the current page is the form templates page, false otherwise.
 */
 ...
 *
 * @returns {boolean} True if the current page is the dashboard page, false otherwise.
 */
