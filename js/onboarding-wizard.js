...
function setupInitialView() {
  ...
  new _utils__WEBPACK_IMPORTED_MODULE_1__.frmAnimate(pageBackground).fadeIn();
  new _utils__WEBPACK_IMPORTED_MODULE_1__.frmAnimate(container).fadeIn();
...
var showEmailAddressError = function showEmailAddressError(type) {
  (0,_utils__WEBPACK_IMPORTED_MODULE_0__.showFormError)('#frm-onboarding-default-email-field', '#frm-onboarding-email-step-error', type);
};
