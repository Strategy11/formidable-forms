...
/* harmony import */ var _checkProInstallationListener__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./checkProInstallationListener */ "./js/src/onboarding-wizard/events/checkProInstallationListener.js");
/* harmony import */ var _saveLicenseButtonListener__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./saveLicenseButtonListener */ "./js/src/onboarding-wizard/events/saveLicenseButtonListener.js");
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../elements */ "./js/src/onboarding-wizard/elements/index.js");
/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared */ "./js/src/onboarding-wizard/shared/index.js");
...
function addEventListeners() {
  ...
  (0,_saveLicenseButtonListener__WEBPACK_IMPORTED_MODULE_4__["default"])();
  ...
  (0,_checkProInstallationListener__WEBPACK_IMPORTED_MODULE_3__["default"])();
}
...
var navigateToStep = function navigateToStep(stepName) {
  ...
  var targetStep = document.querySelector(".".concat(_shared__WEBPACK_IMPORTED_MODULE_6__.PREFIX, "-step[data-step-name=\"").concat(stepName, "\"]"));
  if (!targetStep) {
    return;
  }

  // Find and hide the current step element
  var currentStep = document.querySelector(".".concat(_shared__WEBPACK_IMPORTED_MODULE_6__.PREFIX, "-step.").concat(_shared__WEBPACK_IMPORTED_MODULE_6__.CURRENT_CLASS));
  if (currentStep) {
    currentStep.classList.remove(_shared__WEBPACK_IMPORTED_MODULE_6__.CURRENT_CLASS);
    (0,_utils__WEBPACK_IMPORTED_MODULE_7__.hide)(currentStep);
  }

  // Display the target step element
  targetStep.classList.add(_shared__WEBPACK_IMPORTED_MODULE_6__.CURRENT_CLASS);
  (0,_utils__WEBPACK_IMPORTED_MODULE_7__.show)(targetStep);
  new _utils__WEBPACK_IMPORTED_MODULE_7__.frmAnimate(targetStep).fadeIn();

  // Update the onboarding wizard's current step attribute
  var _getElements = (0,_elements__WEBPACK_IMPORTED_MODULE_5__.getElements)(),
  ...
  (0,_utils__WEBPACK_IMPORTED_MODULE_7__.setQueryParam)('step', stepName, updateMethod);
};
...
function enhanceStepsWithProgress() {
  ...
  (0,_common_components__WEBPACK_IMPORTED_MODULE_4__.addProgressToCardBoxes)(steps);
}
...
function fadeInPageElements() {
  var _getElements3 = (0,_elements__WEBPACK_IMPORTED_MODULE_0__.getElements)(),
    pageBackground = _getElements3.pageBackground,
    container = _getElements3.container;
