...
a,e)}function t(b,a){-1==jQuery.inArray(b,z)&&(z.push(b),b="."===a?jQuery("."+b):jQuery(document.getElementById(b)),b.fadeOut("slow"),b.find(".frm_data_field_container").empty())}function w(b,a){b.hide();if(-1==jQuery.inArray(b.attr("id"),z)){z.push(b.attr("id"));var c=b.find("select, textarea, input:not([type=hidden])");if(c.length){c.prop("checked",!1).prop("selectedIndex",0);c.not(":checkbox, :radio, select, :readonly").val("");var d=!1;c.each(function(){!1===d&&jQuery(this).trigger({type:"change",
frmTriggered:"dependent",selfTriggered:!0});d=!0})}}}function A(b,a,c){if("all"==a.MatchType||!1===l[a.HideField][b])D.push({result:l[a.HideField][b],show:a.Show,match:a.MatchType,FieldName:a.FieldName,HideField:a.HideField,hideContainerID:a.hideContainerID,hideBy:a.hideBy});else{var d="none";if("show"==a.Show){if(!0!==l[a.HideField][b]){I(l[a.HideField][b],a.FieldName,c);return}d=""}"."===a.hideBy?(b=jQuery("."+a.hideContainerID),b.length&&("none"===d?w(b,a):b.show())):(b=document.getElementById(a.hideContainerID),
null!==b&&("none"==d?w(jQuery(b),a):b.style.display=d))}}function P(b){jQuery.each(D,function(a,c){if("undefined"!=typeof c&&"undefined"!=typeof c.result){var d=jQuery(c.hideBy+c.hideContainerID),e=c.show;if(d.length){if("any"==c.match&&-1==jQuery.inArray(!0,l[c.HideField])||"all"==c.match&&-1<jQuery.inArray(!1,l[c.HideField]))e="show"==c.show?"hide":"show";"show"==e?d.show():w(d,c);!1!==typeof c.result&&!0!==typeof c.result&&I(c.result,c.FieldName,b)}delete D[a]}})}function y(b,a,c){"undefined"==
typeof c&&(c="");jQuery.isArray(c)&&-1<jQuery.inArray(a,c)&&(c=a);-1!=String(a).search(/^\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*$/)&&(a=parseFloat(a),c=parseFloat(c));return"-1"!=String(a).indexOf("&quot;")&&y(b,a.replace("&quot;",'"'),c)?!0:{"==":function(b,a){return b==a},"!=":function(b,a){return b!=a},"<":function(b,a){return b>a},">":function(b,a){return b<a},LIKE:function(b,a){return a?-1!=a.indexOf(b):0},"not LIKE":function(b,a){return a?-1==a.indexOf(b):1}}[b](a,c)}function I(b,a,c){"getDataOpts"==
b.funcName?R(b.f,b.sel,a,c):"getData"==b.funcName&&H(b.f,b.sel,0)}function H(b,a,c){var d=document.getElementById(b.hideContainerID),e=jQuery(d).find(".frm_data_field_container");if(0===e.length)return!0;c||e.html('<span class="frm-loading-img"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",entry_id:a,field_id:b.LinkedField,current_field:b.HideField,hide_id:b.hideContainerID,nonce:frm_js.nonce},success:function(f){""!==f&&(d.style.display="");if(c)e.append(f);
