...
Z(b.HideField,b.hideContainerID),c=jQuery('input[name^="'+c+'"]'),aa(c);var d=b.hideContainerID,c=document.getElementById("frm_hide_fields_"+b.FormId),f=c.value;f&&(f=JSON.parse(f),d=f.indexOf(d),-1<d&&(f.splice(d,1),f=JSON.stringify(f),c.value=f))}function aa(a){if(a.length)for(var b=!1,c=0;c<a.length;c++)if(!b||a[c-1].name!=a[c].name){if(0===c||a[c-1].name!=a[c].name){var d=a[c],b=!1;if("checkbox"==d.type||"radio"==d.type)for(var d=document.getElementsByName(d.name),f=d.length,e=0;e<f;e++){if(d[e].checked){b=
!0;break}}else d.value&&(b=!0)}if(!b&&(ba(jQuery(a[c])),f=a[c],"undefined"!==typeof __FRMCALC)){var d=__FRMCALC,e=f.name,g=f.id.replace("field_","");if(O(e))for(var e=g.split("-"),g="",h=0;h<e.length-1;h++)g=""==g?e[h]:g+"-"+e[h];e=g;g=null;O(f.name)&&(g="hidden"!=f.type?jQuery(f).closest(".frm_form_field"):jQuery(f));f=g;void 0!==d.calc[e]&&ca(d,e,[],f)}}}function ba(a){var b=a.length;if(b)for(var c=0;c<b;c++){var d=jQuery(a[c]),f=d.data("frmval");if("undefined"!==typeof f)if(!d.is(":checkbox, :radio"))d.val(f),
E(d);else if(d.val()==f||jQuery.isArray(f)&&-1!==jQuery.inArray(d.val(),f))d.prop("checked",!0),E(d)}}function E(a,b){"undefined"===typeof b&&(b="dependent");1<a.length&&(a=a.eq(0));a.trigger({type:"change",selfTriggered:!0,frmTriggered:b})}function C(a,b,c){"undefined"===typeof c&&(c="");jQuery.isArray(c)&&-1<jQuery.inArray(b,c)&&(c=b);-1!==String(b).search(/^\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*$/)&&(b=parseFloat(b),c=parseFloat(c));return"-1"!=String(b).indexOf("&quot;")&&C(a,b.replace("&quot;",
'"'),c)?!0:{"==":function(a,b){return a==b},"!=":function(a,b){return a!=b},"<":function(a,b){return a>b},">":function(a,b){return a<b},LIKE:function(a,b){return b?-1!=b.indexOf(a):0},"not LIKE":function(a,b){return b?-1==b.indexOf(a):1}}[a](b,c)}function T(a,b,c){"getDataOpts"==a.funcName?ka(a.f,a.sel,b,c):"getData"==a.funcName&&X(a.f,a.sel,0)}function X(a,b,c){var d=document.getElementById(a.hideContainerID),f=jQuery(d).find(".frm_data_field_container");if(0===f.length)return!0;c||f.html('<span class="frm-loading-img"></span>');
jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",entry_id:b,field_id:a.LinkedField,current_field:a.HideField,hide_id:a.hideContainerID,nonce:frm_js.nonce},success:function(a){c?f.append(a):f.html(a);var b=f.children("input"),h=b.val();d.style.display=""===a&&!c||""===h?"none":"";E(b);return!0}})}function ka(a,b,c,d){if(!("stop"==d&&-1<jQuery.inArray(a.HideField,P)&&a.parentField&&"hidden"==a.parentField.attr("type"))){var f=jQuery("#"+a.hideContainerID).find('select[name^="item_meta"], textarea[name^="item_meta"], input[name^="item_meta"]'),
e=la(f),g=f.data("frmval");if("select"!=a.DataType||"stop"!=d&&!jQuery("#"+a.hideContainerID+" .frm-loading-img").length||!(-1<jQuery.inArray(a.HideField,P))){P.push(a.HideField);var h=document.getElementById(a.hideContainerID),k=jQuery(h).find(".frm_data_field_container");if(0===k.length&&f.length)return t(a.HideField,"stop",f),!1;if(""!==a.Value&&!C(a.Condition,a.Value,b))return h.style.display="none",k.html(""),t(a.HideField,"stop",f),!1;k.html('<span class="frm-loading-img" style="visibility:visible;display:inline;"></span>');
var m=a.DataType;jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_data_options",hide_field:c,entry_id:b,selected_field_id:a.LinkedField,field_id:a.HideField,default_value:g,hide_id:a.hideContainerID,nonce:frm_js.nonce},success:function(b){k.html(b);var c=k.find("select, input, textarea"),d=1;"hidden"==c.attr("type")&&(d=c.val());""===b||""===d?(h.style.display="none",e=""):"all"!=a.MatchType&&(h.style.display="");""!==b&&(""!==e?(jQuery.isArray(e)||(b=[],b.push(e),e=b),jQuery.each(e,
function(a,b){if("undefined"!==typeof b&&""!==b)if("checkbox"==m||"radio"==m)1<c.length?c.filter('[value="'+b+'"]').attr("checked","checked"):c.val()==b&&c.attr("checked","checked");else if("select"==m){var d=c.children('option[value="'+b+'"]');d.length?d.prop("selected",!0):e.splice(a,1)}else c.val(b)})):ba(N(k)));c.hasClass("frm_chzn")&&jQuery().chosen&&jQuery(".frm_chzn").chosen({allow_single_deselect:!0});E(c)}})}}}function la(a){var b=[],c="";a.each(function(){c=this.value;"radio"===this.type||
"checkbox"===this.type?!0===this.checked&&b.push(c):""!==c&&b.push(c)});0===b.length&&(b="");return b}function K(a,b){if("undefined"!==typeof __FRMCALC){var c=__FRMCALC,d=c.fields[a];if("undefined"!==typeof d)for(var d=d.total,f=[],e=0,g=d.length;e<g;e++){var h;var k=c.calc[d[e]],m=b.attr("name");h=k.field_id;var l=k.form_id;if(k=document.getElementById("frm_hide_fields_"+l).value){var k=JSON.parse(k),n=h;O(m)&&(m=m.replace("item_meta","").replace(/\[/g,"").split("]"),n=h+"-"+m[0]+"-"+m[1]);-1<k.indexOf("frm_field_"+
n+"_container")?h=!0:(m=void 0,h=(m=l=(l=document.getElementById("frm_helpers_"+l).value)?JSON.parse(l):[])&&null!==m[h]&&-1<k.indexOf("frm_field_"+m[h]+"_container")?!0:!1)}else h=!1;h||ca(c,d[e],f,b)}}}function O(a){var b=!1;4<=a.split("[").length&&(b=!0);return b}function ca(a,b,c,d){var f=a.calc[b],e=f.calc,g=jQuery(document.getElementById("field_"+b)),h={triggerField:d,inSection:!1,thisFieldCall:'input[id^="field_'+b+'-"]'};1>g.length&&"undefined"!==typeof d&&(h.inSection=!0,h.thisFieldId=ma(a.fieldsWithCalc,
b),g=da(h));e=na(f,e,a,c,h);a=f.calc_dec;e.indexOf(").toFixed(")&&(c=e.split(").toFixed("),ea(c[1])&&(a=c[1],e=e.replace(").toFixed("+a,"")));e=parseFloat(eval(e));"undefined"===typeof e&&(e=0);ea(a)&&(e=e.toFixed(a));g.val()!=e&&(g.val(e),E(g,b))}function na(a,b,c,d,f){for(var e=0,g=a.fields.length;e<g;e++){var h={triggerField:f.triggerField,thisFieldId:a.fields[e],inSection:f.inSection,valKey:f.inSection+""+a.fields[e],thisField:c.fields[a.fields[e]],thisFieldCall:"input"+c.fieldKeys[a.fields[e]]},
k=c;"checkbox"==h.thisField.type||"select"==h.thisField.type?h.thisFieldCall=h.thisFieldCall+":checked,select"+k.fieldKeys[h.thisFieldId]+" option:selected,"+h.thisFieldCall+"[type=hidden]":"radio"==h.thisField.type||"scale"==h.thisField.type?h.thisFieldCall=h.thisFieldCall+":checked,"+h.thisFieldCall+"[type=hidden]":"textarea"==h.thisField.type&&(h.thisFieldCall=h.thisFieldCall+",textarea"+k.fieldKeys[h.thisFieldId]);d=oa(h,c,d);if("undefined"===typeof d[h.valKey]||isNaN(d[h.valKey]))d[h.valKey]=
0;k="["+h.thisFieldId+"]";k=k.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1");b=b.replace(new RegExp(k,"g"),d[h.valKey])}return b}function oa(a,b,c){if("undefined"!==typeof c[a.valKey]&&0!==c[a.valKey])return c;c[a.valKey]=0;var d;if(!1===a.inSection)d=jQuery(a.thisFieldCall);else if(d=da(a),null===d||"undefined"===typeof d)d=jQuery(a.thisFieldCall);if(null===d||"undefined"===typeof d||1>d.length)return c;d.each(function(){var d,e=a.thisField;d=!1;if("hidden"==this.type)""!==Q(this)&&(d=!0);else if("select"==
...
a.options.fields)&&(d=!0,c.addColumn("number",frm_js.id));for(var f=a.fields.length,e="string",g=0,h=f;g<h;g++){var k=a.fields[g],e=ia(k);c.addColumn(e,k.name)}g=!1;a.options.edit_link&&(g=!0,c.addColumn("string",a.options.edit_link));h=!1;a.options.delete_link&&(h=!0,c.addColumn("string",a.options.delete_link));k=0;if(null!==a.entries){var m=a.entries.length;c.addRows(m);for(var l=0,n=0;n<m;n++){var k=0,p=a.entries[n];d&&(c.setCell(l,k,p.id),k++);for(var r=0,t=f;r<t;r++){var u=a.fields[r],e=ia(u),
u=p.metas[u.id];"number"!=e||null!==u&&""!==u?"boolean"==e&&(u=null===u||"false"==u||!1===u?!1:!0):u=0;c.setCell(l,k,u);k++}g&&("undefined"!==typeof p.editLink?c.setCell(l,k,'<a href="'+p.editLink+'">'+a.options.edit_link+"</a>"):c.setCell(l,k,""),k++);h&&("undefined"!==typeof p.deleteLink?c.setCell(l,k,'<a href="'+p.deleteLink+'" class="frm_delete_link" data-frmconfirm="'+a.options.confirm+'">'+a.options.delete_link+"</a>"):c.setCell(l,k,""));l++}}else for(c.addRows(1),g=k=0,h=f;g<h;g++)0<k?c.setCell(0,
k,""):c.setCell(0,k,a.options.no_entries),k++;(new google.visualization.Table(document.getElementById("frm_google_table_"+a.options.form_id))).draw(c,a.graphOpts)}else ta(a)}})}function ia(a){var b="string";if("number"==a.type)b="number";else if("checkbox"==a.type||"select"==a.type){var c=a.options.length;"select"==a.type&&""===a.options[0]&&(c="post_status"==a.field_options.post_field?3:c-1);1==c&&(b="boolean")}return b}function ta(a){var b=new google.visualization.DataTable,c=!1,d=!1,f=a.rows.length;
