...
a));c=C="any"==a.anyAll?-1<b.indexOf(!0)?a.showHide:ka(a.showHide):-1<b.indexOf(!1)?ka(a.showHide):a.showHide;b=null!==document.getElementById(a.containerId);"show"==c?"data"==a.fieldType&&a.hasOwnProperty("dataLogic")?(a={fieldId:a.fieldId,fieldKey:a.fieldKey,formId:a.formId,containerId:a.containerId,repeatRow:a.repeatRow,dataLogic:{actualValue:a.dataLogic.actualValue,fieldId:a.dataLogic.fieldId},children:"",inputType:a.inputType},"data"==a.inputType?Oa(a,b):b&&Pa(a)):!1!==B(a.containerId,a.formId)&&
(H(a.containerId,a.formId),b?(b=la(a.containerId),ma(b,"divider"==a.fieldType||"form"==a.fieldType,a.formId),jQuery("#"+a.containerId).show()):(b=na(a),ma(b,"divider"==a.fieldType||"form"==a.fieldType,a.formId))):P(a,b)}function N(a){return"undefined"===typeof __FRMRULES||"undefined"===typeof __FRMRULES[a]?!1:__FRMRULES[a]}function Na(a,b){var c=N(a.fieldId),d=oa(c,b);"data"==b.fieldType&&"data"==c.fieldType?(c=""===a.value?""===d||1==d.length&&""===d[0]?!1:!0:Q(a.operator,a.value,d),b.dataLogic=
a,b.dataLogic.actualValue=d,d=c):d=Q(a.operator,a.value,d);return d}function oa(a,b){var c;if("radio"==a.inputType||"checkbox"==a.inputType)c=pa(a,b),c=document.querySelectorAll('input[name^="'+c+'"]'),c="checkbox"==a.inputType?R(c):qa(c);else if(c="",!0===a.isMultiSelect){c=pa(a,b);var d=document.querySelectorAll('[name^="'+c+'"]');c=1==d.length&&"hidden"!=d[0].type?jQuery('[name^="'+c+'"]').val():R(d)}else d="field_"+a.fieldKey,a.isRepeating&&(d+="-"+b.repeatRow),d=document.getElementById(d),null!==
d&&(c=d.value);"undefined"===typeof c?c="":"string"===typeof c&&(c=c.trim());return c}function pa(a,b){return a.isRepeating?"item_meta["+b.inSection+"]["+b.repeatRow+"]["+a.fieldId+"]":"item_meta["+a.fieldId+"]"}function R(a){for(var b=[],c=0,d=a.length;c<d;c++)("hidden"==a[c].type||a[c].checked)&&b.push(a[c].value);0===b.length&&(b="");return b}function Q(a,b,c){b=Qa(b);c=Ra(b,c);return"string"===typeof b&&"-1"!=b.indexOf("&quot;")&&Q(a,b.replace("&quot;",'"'),c)?!0:{"==":function(a,b){return a==
...
"string"===typeof b&&(b=parseFloat(b));"string"===typeof b&&(b=b.trim());return b}function I(a){"string"===typeof a?a=a.toLowerCase():"number"===typeof a&&(a=a.toString());return a}function ka(a){return"show"==a?"hide":"show"}function la(a){return document.getElementById(a).querySelectorAll('select[name^="item_meta"], textarea[name^="item_meta"], input[name^="item_meta"]')}function na(a){if("divider"==a.fieldType){var b=[];"divider"==a.fieldType&&(b=document.querySelectorAll('[data-sectionid="'+a.fieldId+
'"]'));a=b}else a="form"==a.fieldType?document.querySelectorAll('[id^="field_'+a.fieldKey+'-"]'):document.querySelectorAll('[name^="'+(a.isRepeating?"item_meta["+a.inSection+"]["+a.repeatRow+"]["+a.fieldId+"]":"item_meta["+a.fieldId+"]")+'"]');return a}function ma(a,b,c){if(a.length)for(var d,e=["checkbox","radio"],f=0;f<a.length;f++)if(!(0<f&&"undefined"!==typeof d&&d.name==a[f].name&&-1<e.indexOf(d.type)||b&&ra(a[f],c))){d=a[f];var h=jQuery(d),g=h.data("frmval");if("undefined"!==typeof g){if("checkbox"==
...
null!==k&&(k=k.replace("address-",""),g=g[k]),d.value=g;"SELECT"==d.tagName&&S(d);u(h)}d=a[f];h=q(d,!1);h=T(h);!1!==h&&"lookup"!=h.fieldType&&(h.parentVals=U(h),sa(h,d));d=a[f];if(h="undefined"!==typeof __FRMCALC){h=d.type;g=!1;if("text"==h||"hidden"==h||"number"==h)g=!0;h=g}if(h){h=__FRMCALC;g=d.name;k=d.id.replace("field_","");if(3<=g.split("][").length)for(g=k.split("-"),k="",m=0;m<g.length-1;m++)k=""===k?g[m]:k+"-"+g[m];g=k;k=null;3<=d.name.split("][").length&&(k="hidden"!=d.type?jQuery(d).closest(".frm_form_field"):
jQuery(d));d=k;void 0!==h.calc[g]&&V(h,g,[],d)}d=a[f]}}function ra(a,b){var c=q(a,!0);return B("frm_field_"+c+"_container",b)}function P(a,b){if(!B(a.containerId,a.formId)){if(b){jQuery("#"+a.containerId).hide();var c=la(a.containerId)}else c=na(a);W(c);ta(a.containerId,a.formId)}}function W(a){if(!(1>a.length)){for(var b,c=!0,d=0,e=a.length;d<e;d++)0<d&&b.name!=a[d].name&&!0===c&&u(jQuery(b)),c=!0,"radio"==a[d].type||"checkbox"==a[d].type?a[d].checked=!1:"SELECT"==a[d].tagName?(0===a[d].selectedIndex?
...
b){var c=D(b),d=c.indexOf(a);-1<d&&(c.splice(d,1),c=JSON.stringify(c),document.getElementById("frm_hide_fields_"+b).value=c)}function da(a,b,c){if(!("undefined"===typeof __FRMLOOKUP||"undefined"===typeof __FRMLOOKUP[a]||1>__FRMLOOKUP[a].dependents.length||null===b||"undefined"===typeof b)){a=__FRMLOOKUP[a];b=F(b[0].name);for(var d=0,e=a.dependents.length;d<e;d++)X(a.dependents[d],b,c)}}function X(a,b,c){a=T(a);if(!(!1===a||1>a.parents.length))if("lookup"==a.fieldType){b=[];a.isRepeating?b=document.querySelectorAll(".frm_field_"+
a.fieldId+"_container"):(c=document.getElementById("frm_field_"+a.fieldId+"_container"),null!==c&&b.push(c));c=0;for(var d=b.length;c<d;c++){ia(a,b[c].id);var e=a,f=b[c];e.parentVals=U(e);if("select"==e.inputType)Sa(e,f);else if("radio"==e.inputType||"checkbox"==e.inputType)if(!1===e.parentVals){var h=f.getElementsByTagName("input");ua(e,f);W(h)}else Ta(e,f)}}else if("value changed"===c)for(c="field_"+a.fieldKey,c=a.isRepeating?""!==b.repeatingSection?'[id="'+c+"-"+b.repeatRow+'"]':'[id^="'+c+'-"]':
...
break}return b}function Sa(a,b){var c=b.getElementsByTagName("SELECT")[0];if(null!==c){var d=c.value;!1===a.parentVals?(c.options.length=1,""!==d&&(c.value="",S(c),u(jQuery(c),a.fieldKey))):jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_lookup_field_options",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(b){var d=a.fieldKey,h=c.value;b=JSON.parse(b);for(var g=c.options.length;0<g;g--)c.remove(g);for(var k=b.length,g=
0;g<k;g++)c.options[g+1]=new Option(b[g],b[g],!1,!1);c.value=h;""===c.value&&(b=c.getAttribute("data-frmval"),null!==b&&(c.value=b));S(c);c.value!=h&&u(jQuery(c),d)}})}}function S(a){-1<a.className.indexOf("frm_chzn")&&jQuery().chosen&&jQuery(a).trigger("chosen:updated")}function Ta(a,b){var c=b.getElementsByClassName("frm_opt_container")[0],d=c.getElementsByTagName("input");Ua(b,c);var e="",e="radio"==a.inputType?qa(d):R(d);jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_cb_radio_lookup_options",
parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,row_index:a.repeatRow,current_value:e,nonce:frm_js.nonce},success:function(e){c.innerHTML=e;e=b.getElementsByClassName("frm-loading-img")[0];null!==e&&void 0!==e&&e.parentNode.removeChild(e);c.style.display="block";1==d.length&&""===d[0].value?ua(a,b):!1!==B(b.id,a.formId)&&(e=N(a.fieldId),!1===e||1>e.conditions.length?(H(b.id,a.formId),jQuery("#"+b.id).show()):(e.containerId=b.id,e.repeatRow=a.repeatRow,ja(e)));u(jQuery(d[0]),a.fieldKey)}})}
function ua(a,b){B(b.id,a.formId)||(jQuery("#"+b.id).hide(),ta(b.id,a.formId))}function sa(a,b){if(!ra(b,a.formId))if(!1===a.parentVals){var c=b.getAttribute("data-frmval");null===c&&(c="");va(a,b,c)}else jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_get_lookup_text_value",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(c){b.value!=c&&va(a.fieldKey,b,c)}})}function va(a,b,c){b.value=c;u(jQuery(b),a)}function Oa(a,b){if(b){var c=
