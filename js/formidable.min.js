...
d=jQuery(a).val();if("string"!==typeof d)for(var c=d,d="",f=0;f<c.length;f++)""!==c[f]&&(d=c[f]);e=-1===e.indexOf("frm_other_input")?q(a,!0):q(a,!1)}""===d&&(""===e&&(e=q(a,!0)),e in b||(b[e]=F(a,"data-reqmsg")));return b}function fb(a){var b="";jQuery('input[name="file'+a+'"], input[name="file'+a+'[]"], input[name^="item_meta['+a+']"]').each(function(){""===b&&(b=this.value)});return b}function ja(a,b,c){var d=a.value,e=q(a,!0);if(e in b)return b;var f=0===e.indexOf("conf_");if(""!==d||f){var h=
/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/i,g=F(a,"data-invmsg");""!==d&&!1===h.test(d)?(b[e]=g,f&&(b[e.replace("conf_","")]="")):f&&(a=a.name.replace("conf_",""),c.filter('[name="'+a+'"]').val()!==d&&(b[e]="",b[e.replace("conf_","")]=""))}return b}function ka(a,b){var c=a.value;""!==c&&!1!==isNaN(c/1)&&(c=q(a,!0),c in b||(b[c]=F(a,"data-invmsg")));return b}function la(a,b){var c=a.value,
d=F(a,"pattern");if(""!==d&&""!==c){var e=q(a,!0);e in b||(d=new RegExp("^"+d+"$","i"),!1===d.test(c)&&(b[e]=F(a,"data-invmsg")))}return b}function F(a,b){var c=a.getAttribute(b);null===c&&(c="");return c}function gb(a,b){"undefined"==typeof b&&jQuery(a).find('input[name="frm_action"]').val();var c=jQuery(a).find(".frm_form_field");c.addClass("frm_doing_ajax");jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:jQuery(a).serialize()+"&action=frm_entries_"+b+"&nonce="+frm_js.nonce,success:function(b){var d=
{content:"",errors:{},pass:!1};null===b&&(b=d);b=b.replace(/^\s+|\s+$/g,"");b=0===b.indexOf("{")?jQuery.parseJSON(b):d;if("undefined"!=typeof b.redirect)window.location=b.redirect;else if(""!==b.content){M(a);-1!=frm_js.offset&&frmFrontForm.scrollMsg(jQuery(a),!1);var f=jQuery(a).find('input[name="form_id"]').val();jQuery(a).find(".frm_form_field").fadeOut("slow",function(){b.content=b.content.replace(/ class="frm_form_field /g,' class="frm_hidden frm_form_field ');b.content=b.content.replace(/ frm_pro_form /g,
" frm_pro_form frm_no_hide ");jQuery(a).closest(".frm_forms").replaceWith(b.content);jQuery("#frm_form_"+f+"_container .frm_form_field").fadeIn("slow")});hb(b);if("function"==typeof frmThemeOverride_frmAfterSubmit){var h=jQuery('input[name="frm_page_order_'+f+'"]').val(),d=jQuery(b.content).find('input[name="form_id"]').val();frmThemeOverride_frmAfterSubmit(d,h,b.content,a)}h=jQuery(a).find('input[name="id"]');h.length&&jQuery(document.getElementById("frm_edit_"+h.val())).find("a").addClass("frm_ajax_edited").click();
jQuery(b.content).find(".frm_message").length&&da("pageLoad");ea()}else if(Object.keys(b.errors).length){M(a,"enable");d=!0;La();var g=!1,k=null;for(h in b.errors)if(k=jQuery(a).find("#frm_field_"+h+"_container"),k.length){if(!k.is(":visible")){var m=k.closest(".frm_toggle_container");m.length&&(m=m.prev(),m.hasClass("frm_trigger")||(m=m.prev(".frm_trigger")),m.click())}k.is(":visible")&&(O(k,h,b.errors),d=!1,k=jQuery(a).find("#frm_field_"+h+"_container .frm-g-recaptcha, #frm_field_"+h+"_container .g-recaptcha"),
k.length&&(g=!0,k=k.data("rid"),jQuery().grecaptcha&&(k?grecaptcha.reset(k):grecaptcha.reset())))}c.removeClass("frm_doing_ajax");Ma(a);!0!==g&&Na(a,!1);d?a.submit():jQuery(a).prepend(b.error_message)}else ib(a),Na(a,!0),a.submit()},error:function(){jQuery(a).find('input[type="submit"], input[type="button"]').removeAttr("disabled");a.submit()}})}function hb(a){if(history.pushState&&"undefined"!=typeof a.page){var b,c=a.page;b=encodeURI("frm_page");for(var c=encodeURI(c),d=document.location.search.substr(1).split("&"),
e=d.length,f;e--;)if(f=d[e].split("="),f[0]==b){f[1]=c;d[e]=f.join("=");break}0>e&&(d[d.length]=[b,c].join("="));b=d.join("&");window.history.pushState({html:a.html},"","?"+b)}}function O(a,b,c){a.length&&a.is(":visible")&&(a.addClass("frm_blank_field"),"function"==typeof frmThemeOverride_frmPlaceError?frmThemeOverride_frmPlaceError(b,c):a.append('<div class="frm_error">'+c[b]+"</div>"))}function La(){jQuery(".form-field").removeClass("frm_blank_field");jQuery(".form-field .frm_error").replaceWith("");
jQuery(".frm_error_style").remove()}function Ma(a){var b=jQuery(a).find(".frm_blank_field:first");b.length&&frmFrontForm.scrollMsg(b,a,!0)}function fa(a){-1===a.className.indexOf("frm_loading_form")&&(a.className+=" frm_loading_form");jQuery(a).find('input[type="submit"], input[type="button"], button[type="submit"]').attr("disabled","disabled")}function M(a,b){a.className=a.className.replace(/(?:^|\s)frm_loading_form(?:\s|$)/," ");"enable"==b&&jQuery(a).find('input[type="submit"], input[type="button"], button[type="submit"]').removeAttr("disabled")}
...
(a.addClass("ui-icon-triangle-1-e").removeClass("ui-icon-triangle-1-s"),jQuery(this).next(".frm_toggle_container").hide())});da("pageLoad");ea();vb();wb();xb();yb()},submitForm:function(a){frmFrontForm.submitFormManual(a,this)},submitFormManual:function(a,b){var c=b.className.trim().split(/\s+/gi);if((!c||-1<c.indexOf("frm_pro_form"))&&!jQuery("body").hasClass("wp-admin")){a.preventDefault();var d=frmFrontForm.validateFormSubmit(b);0===Object.keys(d).length&&(fa(b),-1<c.indexOf("frm_ajax_submit")?
1>jQuery(b).find('input[type="file"]').length?(C=jQuery(b).find('input[name="frm_action"]').val(),frmFrontForm.checkFormErrors(b,C)):b.submit():b.submit())}},validateFormSubmit:function(a){"undefined"!=typeof tinyMCE&&jQuery(this).find(".wp-editor-wrap").length&&tinyMCE.triggerSave();w=[];var b=jQuery(a).hasClass("frm_js_validate");b&&(Ja(a)||Ka(a))&&(b=!1);b&&(frmFrontForm.getAjaxFormErrors(a),Object.keys(w).length&&frmFrontForm.addAjaxFormErrors(a));return w},getAjaxFormErrors:function(a){var b=
