...
(b="");return b}function R(a,b,c){b=Ra(b);c=Sa(b,c);return"string"===typeof b&&"-1"!=b.indexOf("&quot;")&&R(a,b.replace("&quot;",'"'),c)?!0:{"==":function(a,b){return a==b},"!=":function(a,b){return a!=b},"<":function(a,b){return a>b},">":function(a,b){return a<b},LIKE:function(a,b){if(!b)return!1;b=J(b);a=J(a);return-1!=b.indexOf(a)},"not LIKE":function(a,b){if(!b)return!0;b=J(b);a=J(a);return-1==b.indexOf(a)}}[a](b,c)}function Ra(a){-1!==String(a).search(/^\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*$/)?
    ...
    function pa(a){if("divider"==a.fieldType){var b=[];"divider"==a.fieldType&&(b=document.querySelectorAll('[data-sectionid="'+a.fieldId+'"]'));a=b}else a="form"==a.fieldType?document.querySelectorAll('[id^="field_'+a.fieldKey+'-"]'):document.querySelectorAll('[name^="'+(a.isRepeating?"item_meta["+a.inSection+"]["+a.repeatRow+"]["+a.fieldId+"]":"item_meta["+a.fieldId+"]")+'"]');return a}function oa(a,b,c){if(a.length)for(var d,e=["checkbox","radio"],f=0;f<a.length;f++)if(!(0<f&&"undefined"!==typeof d&&
        ...
        b=G(b[0].name);for(var d=0,e=a.dependents.length;d<e;d++)Z(a.dependents[d],b,c)}}function Z(a,b,c){a=V(a);if(!(!1===a||1>a.parents.length))if("lookup"==a.fieldType){b=[];a.isRepeating?b=document.querySelectorAll(".frm_field_"+a.fieldId+"_container"):(c=document.getElementById("frm_field_"+a.fieldId+"_container"),null!==c&&b.push(c));c=0;for(var d=b.length;c<d;c++){ka(a,b[c].id);var e=a,f=b[c];e.parentVals=W(e);if("select"==e.inputType)Ta(e,f);else if("radio"==e.inputType||"checkbox"==e.inputType)if(!1===
        ...
        [],c=a.parents,d,e=0,f=c.length;e<f;e++){d=V(c[e]);d=qa(d,a);if(""===d||!1===d){b=!1;break}b[e]=d}return b}function sa(a){for(var b=!1,c=a.length,d=0;d<c;d++)if("hidden"==a[d].type||a[d].checked){b=a[d].value;break}return b}function Ta(a,b){var c=b.getElementsByTagName("SELECT")[0];if(null!==c){var d=c.value;!1===a.parentVals?(c.options.length=1,""!==d&&(c.value="",U(c),u(jQuery(c),a.fieldKey))):(Va(c),jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_lookup_field_options",parent_fields:a.parents,
        parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(b){var d=a.fieldKey,h=c.value;b=JSON.parse(b);for(var g=c.options.length;0<g;g--)c.remove(g);for(var k=b.length,g=0;g<k;g++)c.options[g+1]=new Option(b[g],b[g],!1,!1);c.value=h;""===c.value&&(b=c.getAttribute("data-frmval"),null!==b&&(c.value=b));U(c);c.value!=h&&u(jQuery(c),d)}}))}}function U(a){-1<a.className.indexOf("frm_chzn")&&jQuery().chosen&&jQuery(a).trigger("chosen:updated")}function Va(a){a.value||(a.options.length=
        1,a.options[1]=new Option(frm_js.loading_text,"",!1,!1))}function Ua(a,b){var c=b.getElementsByClassName("frm_opt_container")[0],d=c.getElementsByTagName("input");Wa(b,c);var e="",e="radio"==a.inputType?sa(d):S(d);jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_cb_radio_lookup_options",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,row_index:a.repeatRow,current_value:e,nonce:frm_js.nonce},success:function(e){c.innerHTML=e;e=b.getElementsByClassName("frm-loading-img")[0];
        null!==e&&void 0!==e&&e.parentNode.removeChild(e);c.style.display="block";1==d.length&&""===d[0].value?va(a,b):!1!==B(b.id,a.formId)&&(e=O(a.fieldId),!1===e||1>e.conditions.length?(I(b.id,a.formId),jQuery("#"+b.id).show()):(e.containerId=b.id,e.repeatRow=a.repeatRow,la(e)));u(jQuery(d[0]),a.fieldKey)}})}function va(a,b){B(b.id,a.formId)||(jQuery("#"+b.id).hide(),ua(b.id,a.formId))}function ta(a,b){if(!T(b,a.formId))if(!1===a.parentVals){var c=b.getAttribute("data-frmval");null===c&&(c="");wa(a,b,
        c)}else jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_get_lookup_text_value",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(c){b.value!=c&&wa(a.fieldKey,b,c)}})}function wa(a,b,c){b.value=c;u(jQuery(b),a)}function Pa(a,b){if(b){var c=jQuery("#"+a.containerId);xa(c)}jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",entry_id:a.dataLogic.actualValue,current_field:a.fieldId,hide_id:a.containerId,
        nonce:frm_js.nonce},success:function(d){if(b){var e=c.find(".frm_opt_container");e.html(d);var f=e.children("input"),h=f.val();ya(e);""===d||""===h?Q(a,!0):za(a,c,f)}else e="field_"+a.fieldKey,""!==a.repeatRow&&(e+="-"+a.repeatRow),e=document.getElementById(e),e.value=d,B(a.containerId,a.formId)&&I(a.containerId,a.formId),u(jQuery(e))}})}function Qa(a,b){var c=jQuery("#"+a.containerId),d=c.find('select[name^="item_meta"], textarea[name^="item_meta"], input[name^="item_meta"]'),e=Xa(d),d=d.data("frmval");
        xa(c);jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_data_options",trigger_field_id:a.dataLogic.fieldId,entry_id:a.dataLogic.actualValue,field_id:a.fieldId,default_value:d,container_id:a.containerId,prev_val:e,nonce:frm_js.nonce},success:function(b){var d=c.find(".frm_opt_container");d.html(b);var e=d.find("select, input, textarea");ya(d);""===b||1==e.length&&"hidden"==e.attr("type")?Q(a,!0):za(a,c,e)}})}function xa(a){var b=a.html();-1<b.indexOf("frm-loading-img")||(a.html(b+
        '<span class="frm-loading-img"></span>'),a.find(".frm_opt_container").hide())}function Wa(a,b){if(!(-1<a.innerHTML.indexOf("frm-loading-img"))){b.style.display="none";var c=document.createElement("span");c.setAttribute("class","frm-loading-img");a.insertBefore(c,b.nextSibling)}}function ya(a){a.next(".frm-loading-img").remove();a.show()}function Xa(a){var b=[],c="";a.each(function(){c=this.value;"radio"===this.type||"checkbox"===this.type?!0===this.checked&&b.push(c):""!==c&&b.push(c)});0===b.length&&
    (b="");return b}function za(a,b,c){B(a.containerId,a.formId)&&(I(a.containerId,a.formId),b.show());c.hasClass("frm_chzn")&&aa();u(c)}function M(a,b){if("undefined"!==typeof __FRMCALC){var c=__FRMCALC,d=c.fields[a];if("undefined"!==typeof d)for(var d=d.total,e=[],f=0,h=d.length;f<h;f++){var g;g=c.calc[d[f]];var k=b.attr("name"),m=!1,l=g.field_id,n=D(g.form_id);1>n.length||("0"===g.inSection&&"0"===g.inEmbedForm?m=K(l,n):(k=G(k),K(l,n)?m=!0:Aa(l,k,n)?m=!0:"0"!==g.inSection&&"0"!==g.inEmbedForm?m=Aa(g.inSection,
    ...
    "undefined"!==typeof d&&(g.inSection=!0,g.thisFieldId=Ya(a.fieldsWithCalc,b),h=Ba(g));if(!(1>h.length)){f=Za(e,f,a,c,g);if("text"!=e.calc_type){a=e.calc_dec;f.indexOf(").toFixed(")&&(c=f.split(").toFixed("),Ca(c[1])&&(a=c[1],f=f.replace(").toFixed("+a,"")));f=parseFloat(eval(f));if("undefined"===typeof f||isNaN(f))f=0;Ca(a)&&(f=f.toFixed(a))}h.val()!=f&&(h.val(f),u(h,b))}}function Za(a,b,c,d,e){for(var f=0,h=a.fields.length;f<h;f++){var g={triggerField:e.triggerField,thisFieldId:a.fields[f],inSection:e.inSection,
        ...
        k.fieldKeys[g.thisFieldId]);if("text"==a.calc_type)g.valKey="text"+g.valKey,d=$a(g,d),"undefined"===typeof d[g.valKey]&&(d[g.valKey]="");else{g.valKey="num"+g.valKey;d=ab(g,c,d);if("undefined"===typeof d[g.valKey]||isNaN(d[g.valKey]))d[g.valKey]=0;"date"==g.thisField.type&&0===d[g.valKey]&&(b="")}k="["+g.thisFieldId+"]";k=k.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1");b=b.replace(new RegExp(k,"g"),d[g.valKey])}return b}function ab(a,b,c){if("undefined"!==typeof c[a.valKey]&&0!==c[a.valKey])return c;
        c[a.valKey]=0;var d=Da(a);if(!1===d)return c;d.each(function(){var d=Ea(a.thisField,this);if("date"==a.thisField.type){var f;f=b.date;var h=0;if(d)if("undefined"===typeof jQuery.datepicker){h="-";-1<f.indexOf("/")&&(h="/");f=f.split(h);var d=d.split(h),g,k;g=h=k="";for(var m=0;m<f.length;m++)if("y"==f[m])g=((new Date).getFullYear()+15).toString().substr(2,2),g=d[m]>g?"19"+d[m]:"20"+d[m];else if("yy"==f[m])g=d[m];else if("m"==f[m]||"mm"==f[m])h=d[m],2>h.length&&(h="0"+h);else if("d"==f[m]||"dd"==f[m])k=
            d[m],2>k.length&&(k="0"+k);h=Date.parse(g+"-"+h+"-"+k)}else h=jQuery.datepicker.parseDate(f,d);f=h;null!==f&&(c[a.valKey]=Math.ceil(f/864E5))}else{f=d;""!==f&&0!==f&&(f=f.trim(),f=parseFloat(f.replace(/,/g,"").match(/-?[\d\.]+$/)));if("undefined"===typeof f||isNaN(f)||""===f)f=0;c[a.valKey]+=f}});return c}function $a(a,b){if("undefined"!==typeof b[a.valKey]&&""!==b[a.valKey])return b;b[a.valKey]="";var c=Da(a);if(!1===c)return b;c.each(function(){var c=Ea(a.thisField,this),c=c.trim();b[a.valKey]+=
        c});return b}function Da(a){var b;if(!1===a.inSection)b=jQuery(a.thisFieldCall);else if(b=Ba(a),null===b||"undefined"===typeof b)b=jQuery(a.thisFieldCall);if(null===b||"undefined"===typeof b||1>b.length)b=!1;return b}function Ba(a){if("undefined"===typeof a.triggerField)return null;var b=a.triggerField.closest(".frm_repeat_sec, .frm_repeat_inline, .frm_repeat_grid");return b.length?(a=a.thisFieldCall.replace("[id=","[id^="),b.find(a)):null}function Ea(a,b){var c;c=!1;if("hidden"==b.type)""!==ba(b)&&
    ...
    function ob(){var a=jQuery(this).data("frmconfirm");return confirm(a)}function pb(){var a=jQuery(this).data("frmtoggle");jQuery(a).is(":visible")?jQuery(a).slideUp("fast"):jQuery(a).slideDown("fast");return!1}function Ya(a,b){for(var c in a)if(a.hasOwnProperty(c)&&a[c]===b)return c;return null}function Ca(a){return!jQuery.isArray(a)&&0<=a-parseFloat(a)+1}function qb(){Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){var c=this.length>>>0,d=Number(b)||0,d=0>d?Math.ceil(d):Math.floor(d);
    ...
    (Object.keys=function(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&b.push(c);return b})}var L=!1,C="",x=[];return{init:function(){jQuery(document).off("submit.formidable",".frm-show-form");jQuery(document).on("submit.formidable",".frm-show-form",frmFrontForm.submitForm);jQuery(document).on("click",".frm_trigger",n);var a=jQuery(".frm_blank_field");a.length&&a.closest(".frm_toggle_container").prev(".frm_trigger").click();jQuery.isFunction(jQuery.fn.placeholder)?jQuery(".frm-show-form input, .frm-show-form textarea").placeholder():
        jQuery(".frm-show-form input[onblur], .frm-show-form textarea[onblur]").each(function(){""===jQuery(this).val()&&jQuery(this).blur()});jQuery(document).on("focus",".frm_toggle_default",eb);jQuery(document).on("blur",".frm_toggle_default",fb);jQuery(".frm_toggle_default").blur();jQuery(document.getElementById("frm_resend_email")).click(gb);jQuery(document).on("click",".frm_remove_link",w);jQuery(document).on("focusin","input[data-frmmask]",function(){jQuery(this).mask(jQuery(this).data("frmmask").toString())});
        jQuery(document).on("change",'.frm-show-form input[name^="item_meta"], .frm-show-form select[name^="item_meta"], .frm-show-form textarea[name^="item_meta"]',F);jQuery(document).on("click",'.frm-show-form input[type="submit"], .frm-show-form input[name="frm_prev_page"], .frm-show-form .frm_save_draft',l);jQuery(document).on("change",'.frm_other_container input[type="checkbox"], .frm_other_container input[type="radio"], .frm_other_container select',A);jQuery(document).on("click",".frm_remove_form_row",
            jb);jQuery(document).on("click",".frm_add_form_row",kb);jQuery(document).on("click","a[data-frmconfirm]",ob);jQuery("a[data-frmtoggle]").click(pb);jQuery(".frm_edit_link_container").on("click","a.frm_inplace_edit",lb);jQuery(".frm_edit_link_container").on("click","a.frm_cancel_edit",mb);jQuery(document).on("click",".frm_ajax_delete",nb);jQuery(".frm_month_heading, .frm_year_heading").click(function(){var a=jQuery(this).children(".ui-icon-triangle-1-e, .ui-icon-triangle-1-s");a.hasClass("ui-icon-triangle-1-e")?
            (a.addClass("ui-icon-triangle-1-s").removeClass("ui-icon-triangle-1-e"),jQuery(this).next(".frm_toggle_container").fadeIn("slow")):(a.addClass("ui-icon-triangle-1-e").removeClass("ui-icon-triangle-1-s"),jQuery(this).next(".frm_toggle_container").hide())});ca("pageLoad");da();qb();rb();sb();tb()},submitForm:function(a){frmFrontForm.submitFormManual(a,this)},submitFormManual:function(a,b){var c=b.classList;if((!c||c.contains("frm_pro_form"))&&!jQuery("body").hasClass("wp-admin")){a.preventDefault();
