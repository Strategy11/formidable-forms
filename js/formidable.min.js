...
a.fieldId+"]"}function M(a){for(var b=[],c=0,d=a.length;c<d;c++)("hidden"==a[c].type||a[c].checked)&&b.push(a[c].value);0===b.length&&(b=!1);return b}function X(a,b,c){b=eb(b);c=fb(b,c);return"string"===typeof b&&"-1"!=b.indexOf("&quot;")&&X(a,b.replace("&quot;",'"'),c)?!0:{"==":function(a,b){return a==b},"!=":function(a,b){return a!=b},"<":function(a,b){return a>b},">":function(a,b){return a<b},LIKE:function(a,b){if(!b)return!1;a=Z(a);b=za(a,b);return-1!=b.indexOf(a)},"not LIKE":function(a,b){if(!b)return!0;
a=Z(a);b=za(a,b);return-1==b.indexOf(a)}}[a](b,c)}function eb(a){-1!==String(a).search(/^\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*$/)?a=parseFloat(a):"string"===typeof a&&(a=a.trim());return a}function fb(a,b){"undefined"===typeof b&&(b="");jQuery.isArray(b)&&-1<jQuery.inArray(String(a),b)&&(b=a);"number"===typeof a&&"string"===typeof b&&(b=parseFloat(b));"string"===typeof b&&(b=b.trim());return b}function za(a,b){b=Z(b);var c;if(jQuery.isArray(b))for(var d=0,e=b.length;d<e;d++)if(c=b[d].toLowerCase(),
...
e.inputType)gb(e,f);else if("radio"==e.inputType||"checkbox"==e.inputType)if(!1===e.parentVals){var h=f.getElementsByTagName("input");Ea(e,f);ca(h)}else hb(e,f)}}else if("value changed"===c)for(c="field_"+a.fieldKey,c=a.isRepeating?""!==b.repeatingSection?'[id="'+c+"-"+b.repeatRow+'"]':'[id^="'+c+'-"]':'[id="'+c+'"]',b=document.querySelectorAll(c),c=0,d=b.length;c<d;c++)e=a,f=J(b[c].name),e.repeatRow=""!==f.repeatRow?f.repeatRow:"",Ba(a,b[c])}function aa(a){return"undefined"===typeof __FRMLOOKUP||
"undefined"===typeof __FRMLOOKUP[a]?!1:__FRMLOOKUP[a]}function Ba(a,b){a.parentVals=Da(a);var c=b.id;c in r&&0<r[c].length?Fa(a,b):(Fa(a,b),Ga(a,b))}function Da(a){for(var b=[],c=a.parents,d,e=0,f=c.length;e<f;e++){d=aa(c[e]);d=xa(d,a);if(""===d||!1===d){b=!1;break}b[e]=d}return b}function Y(a){for(var b=!1,c=a.length,d=0;d<c;d++)if("hidden"==a[d].type||a[d].checked){b=a[d].value;break}return b}function gb(a,b){var c=b.getElementsByTagName("SELECT")[0];if(null!==c){var d=c.value;!1===a.parentVals?
(c.options.length=1,c.value="",O(c),""!==d&&v(jQuery(c),a.fieldKey)):(ib(c),ea(a.formId),jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_lookup_field_options",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(b){var d=c.value;b=JSON.parse(b);for(var e=c.options.length;0<e;e--)c.remove(e);for(var g=b.length,e=0;e<g;e++)c.options[e+1]=new Option(b[e],b[e],!1,!1);c.value=d;""===c.value&&(b=c.getAttribute("data-frmval"),null!==
b&&(c.value=b));!1===a.isReadOnly&&(c.disabled=!1);c.className=c.className.replace(" frm_loading_lookup","");O(c);c.value!=d&&v(jQuery(c),a.fieldKey);fa(a.formId)}}))}}function O(a){-1<a.className.indexOf("frm_chzn")&&jQuery().chosen&&jQuery(a).trigger("chosen:updated")}function ib(a){a.className+=" frm_loading_lookup";a.disabled=!0;O(a)}function ea(a){P++;1>=P&&(a=Ha(a),null!==a&&S(jQuery(a)))}function fa(a){P--;0>=P&&(a=Ha(a),null!==a&&I(jQuery(a),"enable"))}function Ha(a){return document.querySelector("#frm_form_"+
a+"_container form")}function hb(a,b){var c=b.getElementsByClassName("frm_opt_container")[0],d=c.getElementsByTagName("input");jb(b,c);var e="",e="radio"==a.inputType?Y(d):M(d),f=jQuery(d[0]).data("frmval");ea(a.formId);jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_cb_radio_lookup_options",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,container_field_id:L(a),row_index:a.repeatRow,current_value:e,default_value:f,nonce:frm_js.nonce},success:function(e){c.innerHTML=
e;e=b.getElementsByClassName("frm-loading-img")[0];null!==e&&void 0!==e&&e.parentNode.removeChild(e);c.style.display="block";1==d.length&&""===d[0].value?Ea(a,b):(!1!==C(b.id,a.formId)&&(e=V(a.fieldId),!1===e||1>e.conditions.length?(E(b.id,a.formId),jQuery("#"+b.id).show()):(e.containerId=b.id,e.repeatRow=a.repeatRow,sa(e))),void 0!==f&&(!1!==("radio"==a.inputType?Y(d):M(d))||1>d.length||Aa(d[0].name,f)));v(jQuery(d[0]),a.fieldKey);fa(a.formId)}})}function Ea(a,b){C(b.id,a.formId)||(jQuery("#"+b.id).hide(),
Ca(b.id,a.formId))}function Ga(a,b){if(N(b,a.formId))ga(b.id);else if(!1===a.parentVals){var c=b.getAttribute("data-frmval");null===c&&(c="");Ia(a,b,c);ga(b.id)}else ea(a.formId),jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_get_lookup_text_value",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(c){N(b,a.formId)||b.value==c||Ia(a.fieldKey,b,c);fa(a.formId);ga(b.id)}})}function Fa(a,b){var c=b.id;c in r?2<=r[c].length&&(r[c]=
r[c].slice(0,1)):r[c]=[];r[c].push({childFieldArgs:a,childInput:b})}function ga(a){r[a].shift();a in r&&0<r[a].length&&Ga(r[a][0].childFieldArgs,r[a][0].childInput)}function Ia(a,b,c){c=c.replace(/&amp;/g,"&");b.value=c;v(jQuery(b),a)}function cb(a,b){if(b){var c=jQuery("#"+a.containerId);Ja(c)}jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",entry_id:a.dataLogic.actualValue,current_field:a.fieldId,hide_id:a.containerId,on_current_page:b,nonce:frm_js.nonce},success:function(d){if(b){var e=
c.find(".frm_opt_container");e.html(d);var f=e.children("input"),h=f.val();Ka(e);""===d||""===h?W(a,!0):La(a,c,f,!0)}else e="field_"+a.fieldKey,""!==a.repeatRow&&(e+="-"+a.repeatRow),e=document.getElementById(e),e.value=d,C(a.containerId,a.formId)&&E(a.containerId,a.formId),v(jQuery(e))}})}function db(a,b){var c=jQuery("#"+a.containerId),d=c.find('select[name^="item_meta"], input[name^="item_meta"]'),e=Ma(d),d=d.data("frmval"),f=c.closest("form").find('input[name="id"]').val();Ja(c);jQuery.ajax({type:"POST",
url:frm_js.ajax_url,data:{action:"frm_fields_ajax_data_options",trigger_field_id:a.dataLogic.fieldId,entry_id:a.dataLogic.actualValue,field_id:a.fieldId,default_value:d,container_id:a.containerId,editing_entry:f,prev_val:e,nonce:frm_js.nonce},success:function(b){var d=c.find(".frm_opt_container");d.html(b);var f=d.find('select, input[type="checkbox"], input[type="radio"]');Ka(d);""===b||1>f.length?W(a,!0):(b=Ma(f),La(a,c,f,e!==b))}})}function Ja(a){var b=a.html();-1<b.indexOf("frm-loading-img")||
(a.html(b+'<span class="frm-loading-img"></span>'),a.find(".frm_opt_container").hide())}function jb(a,b){if(!(-1<a.innerHTML.indexOf("frm-loading-img"))){b.style.display="none";var c=document.createElement("span");c.setAttribute("class","frm-loading-img");a.insertBefore(c,b.nextSibling)}}function Ka(a){a.parent().children(".frm-loading-img").remove();a.show()}function Ma(a){var b=[],c="";a.each(function(){c=this.value;"radio"===this.type||"checkbox"===this.type?!0===this.checked&&b.push(c):""!==c&&
b.push(c)});0===b.length&&(b="");return b}function La(a,b,c,d){C(a.containerId,a.formId)&&(E(a.containerId,a.formId),b.show());c.hasClass("frm_chzn")&&ha();!0===d&&v(c)}function T(a,b){if("undefined"!==typeof __FRMCALC){var c=__FRMCALC,d=c.fields[a];if("undefined"!==typeof d)for(var d=d.total,e=[],f=0,h=d.length;f<h;f++){var g;g=c.calc[d[f]];var k=b.attr("name"),n=!1,l=g.field_id,m=F(g.form_id);1>m.length||("0"===g.inSection&&"0"===g.inEmbedForm?n=Q(l,m):(k=J(k),Q(l,m)?n=!0:Na(l,k,m)?n=!0:"0"!==g.inSection&&
"0"!==g.inEmbedForm?n=Na(g.inSection,k,m):"0"!==g.inSection?n=Q(g.inSection,m):"0"!==g.inEmbedForm&&(n=Q(g.inEmbedForm,m))));g=n;!1===g&&ba(c,d[f],e,b)}}}function Q(a,b){return-1<b.indexOf("frm_field_"+a+"_container")}function Na(a,b,c){var d=!1;b.repeatingSection&&(a="frm_field_"+a+"-"+b.repeatingSection,a+="-"+b.repeatRow+"_container",d=-1<c.indexOf(a));return d}function ba(a,b,c,d){var e=a.calc[b],f=e.calc,h=jQuery(document.getElementById("field_"+b)),g={triggerField:d,inSection:!1,thisFieldCall:'input[id^="field_'+
b+'-"]'};1>h.length&&"undefined"!==typeof d&&(g.inSection=!0,g.thisFieldId=kb(a.fieldsWithCalc,b),h=Oa(g));if(!(null===h||1>h.length)){f=lb(e,f,a,c,g);if("text"!=e.calc_type){a=e.calc_dec;-1<f.indexOf(").toFixed(")&&(c=f.split(").toFixed("),Pa(c[1])&&(a=c[1],f=f.replace(").toFixed("+a,"")));f=mb(f);f=parseFloat(eval(f));if("undefined"===typeof f||isNaN(f))f=0;Pa(a)&&(f=f.toFixed(a))}h.val()!=f&&(h.val(f),v(h,b))}}function lb(a,b,c,d,e){for(var f=0,h=a.fields.length;f<h;f++){var g={triggerField:e.triggerField,
thisFieldId:a.fields[f],inSection:e.inSection,valKey:e.inSection+""+a.fields[f],thisField:c.fields[a.fields[f]],thisFieldCall:"input"+c.fieldKeys[a.fields[f]]},k=c;"checkbox"==g.thisField.type||"radio"==g.thisField.type||"scale"==g.thisField.type?g.thisFieldCall=g.thisFieldCall+":checked,"+g.thisFieldCall+"[type=hidden]":"select"==g.thisField.type||"time"==g.thisField.type?g.thisFieldCall="select"+k.fieldKeys[g.thisFieldId]+" option:selected,"+g.thisFieldCall+"[type=hidden]":"textarea"==g.thisField.type&&
(g.thisFieldCall=g.thisFieldCall+",textarea"+k.fieldKeys[g.thisFieldId]);if("text"==a.calc_type)g.valKey="text"+g.valKey,d=nb(g,d),"undefined"===typeof d[g.valKey]&&(d[g.valKey]="");else{g.valKey="num"+g.valKey;d=ob(g,c,d);if("undefined"===typeof d[g.valKey]||isNaN(d[g.valKey]))d[g.valKey]=0;"date"==g.thisField.type&&0===d[g.valKey]&&(b="")}k="["+g.thisFieldId+"]";k=k.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1");b=b.replace(new RegExp(k,"g"),d[g.valKey])}return b}function mb(a){var b=a.charAt(a.length-
1);if("+"===b||"-"===b)a=a.substr(0,a.length-1);return a}function H(a){return 3<=a.split("][").length}function ob(a,b,c){if("undefined"!==typeof c[a.valKey]&&0!==c[a.valKey])return c;c[a.valKey]=0;var d=Qa(a);if(!1===d)return c;d.each(function(){var d=Ra(a.thisField,this);if("date"==a.thisField.type){var f;f=b.date;var h=0;if(d)if("undefined"===typeof jQuery.datepicker){h="-";-1<f.indexOf("/")&&(h="/");f=f.split(h);var d=d.split(h),g,k;g=h=k="";for(var n=0;n<f.length;n++)if("y"==f[n])g=((new Date).getFullYear()+
15).toString().substr(2,2),g=d[n]>g?"19"+d[n]:"20"+d[n];else if("yy"==f[n])g=d[n];else if("m"==f[n]||"mm"==f[n])h=d[n],2>h.length&&(h="0"+h);else if("d"==f[n]||"dd"==f[n])k=d[n],2>k.length&&(k="0"+k);h=Date.parse(g+"-"+h+"-"+k)}else h=jQuery.datepicker.parseDate(f,d);f=h;null!==f&&(c[a.valKey]=Math.ceil(f/864E5))}else{f=d;""!==f&&0!==f&&(f=f.trim(),f=parseFloat(f.replace(/,/g,"").match(/-?[\d\.]+$/)));if("undefined"===typeof f||isNaN(f)||""===f)f=0;c[a.valKey]+=f}});return c}function nb(a,b){if("undefined"!==
typeof b[a.valKey]&&""!==b[a.valKey])return b;b[a.valKey]="";var c=Qa(a);if(!1===c)return b;var d=0,e="";c.each(function(){var c=Ra(a.thisField,this),c=c.trim();0<d&&("time"==a.thisField.type?1==d?e=":":2==d&&(e=" "):e=", ");""!==c&&(b[a.valKey]+=e+c,d++)});return b}function Qa(a){var b;if(!1===a.inSection)b=jQuery(a.thisFieldCall);else if(b=Oa(a),null===b||"undefined"===typeof b)b=jQuery(a.thisFieldCall);if(null===b||"undefined"===typeof b||1>b.length)b=!1;return b}function Oa(a){if("undefined"===
typeof a.triggerField)return null;var b=a.triggerField.closest(".frm_repeat_sec, .frm_repeat_inline, .frm_repeat_grid");return b.length?(a=a.thisFieldCall.replace("[id=","[id^="),b.find(a)):null}function Ra(a,b){var c;c=!1;if("hidden"==b.type)""!==ia(b)&&(c=!0);else if("select"==a.type){var d=b.className;d&&-1<d.indexOf("frm_other_trigger")&&(c=!0)}else("checkbox"==a.type||"radio"==a.type)&&-1<b.id.indexOf("-other_")&&0>b.id.indexOf("-otext")&&(c=!0);c?(c=0,"select"==a.type?"hidden"==b.type?(d=!1,
2<b.name.split("[").length&&(d=!0),d||(c=ia(b))):c=jQuery(b).closest(".frm_other_container").find(".frm_other_input").val():"checkbox"!=a.type&&"radio"!=a.type||"hidden"==b.type||(c=ia(b))):c="checkbox"!==b.type&&"radio"!==b.type||!b.checked?jQuery(b).val():b.value;"undefined"===typeof c&&(c="");return c}function ia(a){var b="";a=document.getElementById(a.id+"-otext");null!==a&&""!==a.value&&(b=a.value);return b}function Sa(a){var b=!1;a=jQuery(a).find(".frm_saving_draft");a.length&&(b=a.val());return b}
function Ta(a){var b=!1,c=jQuery(a).find(".frm_next_page");if(c.length&&c.val()){var d=jQuery(a).find('input[name="form_id"]').val();a=jQuery(a).find('input[name="frm_page_order_'+d+'"]');a=a.length?a.val():0;if(!a||c.val()<a)b=!0}return b}function na(a,b){var c=a.getAttribute("data-frmfile");if("hidden"==a.type&&null===c)return b;var d="",e="";if("checkbox"==a.type||"radio"==a.type)c=jQuery('input[name="'+a.name+'"]').closest(".frm_required_field").find("input:checked"),jQuery(c).each(function(){d=
this.value});else if("file"==a.type||c)"undefined"===typeof c&&(c=p(a,!0),c=c.replace("file","")),"undefined"===typeof b[c]&&(d=pb(c)),e=c;else{c=a.className;if(-1!==c.indexOf("frm_pos_none"))return b;d=jQuery(a).val();if(null===d)d="";else if("string"!==typeof d)for(var e=d,d="",f=0;f<e.length;f++)""!==e[f]&&(d=e[f]);e=-1===c.indexOf("frm_other_input")?p(a,!0):p(a,!1);-1!==c.indexOf("frm_time_select")&&(e=e.replace("-H","").replace("-m",""))}""===d&&(""===e&&(e=p(a,!0)),e in b||(b[e]=G(a,"data-reqmsg")));
return b}function pb(a){var b="";jQuery('input[name="file'+a+'"], input[name="file'+a+'[]"], input[name^="item_meta['+a+']"]').each(function(){""===b&&(b=this.value)});return b}function oa(a,b,c){var d=a.value,e=p(a,!0);if(e in b)return b;var f=0===e.indexOf("conf_");if(""!==d||f){var h=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/i,g=G(a,"data-invmsg");""!==d&&!1===h.test(d)?(b[e]=g,f&&(b[e.replace("conf_",
"")]="")):f&&(a=a.name.replace("conf_",""),c.filter('[name="'+a+'"]').val()!==d&&(b[e]="",b[e.replace("conf_","")]=""))}return b}function pa(a,b){var c=a.value;""!==c&&!1!==isNaN(c/1)&&(c=p(a,!0),c in b||(b[c]=G(a,"data-invmsg")));return b}function qa(a,b){var c=a.value,d=G(a,"pattern");if(""!==d&&""!==c){var e=p(a,!0);e in b||(d=new RegExp("^"+d+"$","i"),!1===d.test(c)&&(b[e]=G(a,"data-invmsg")))}return b}function G(a,b){var c=a.getAttribute(b);null===c&&(c="");return c}function qb(a,b){"undefined"==
typeof b&&jQuery(a).find('input[name="frm_action"]').val();var c=jQuery(a).find(".frm_form_field");c.addClass("frm_doing_ajax");jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:jQuery(a).serialize()+"&action=frm_entries_"+b+"&nonce="+frm_js.nonce,success:function(b){var d={content:"",errors:{},pass:!1};null===b&&(b=d);b=b.replace(/^\s+|\s+$/g,"");b=0===b.indexOf("{")?jQuery.parseJSON(b):d;if("undefined"!=typeof b.redirect)window.location=b.redirect;else if(""!==b.content){I(jQuery(a));-1!=frm_js.offset&&
frmFrontForm.scrollMsg(jQuery(a),!1);var f=jQuery(a).find('input[name="form_id"]').val();b.content=b.content.replace(/ frm_pro_form /g," frm_pro_form frm_no_hide ");jQuery(a).closest(".frm_forms").replaceWith(b.content);d=b;if(history.pushState&&"undefined"!=typeof d.page){var h,g=d.page;h=encodeURI("frm_page");for(var g=encodeURI(g),k=document.location.search.substr(1).split("&"),n=k.length,l;n--;)if(l=k[n].split("="),l[0]==h){l[1]=g;k[n]=l.join("=");break}0>n&&(k[k.length]=[h,g].join("="));h=k.join("&");
window.history.pushState({html:d.html},"","?"+h)}"function"==typeof frmThemeOverride_frmAfterSubmit&&(f=jQuery('input[name="frm_page_order_'+f+'"]').val(),d=jQuery(b.content).find('input[name="form_id"]').val(),frmThemeOverride_frmAfterSubmit(d,f,b.content,a));f=jQuery(a).find('input[name="id"]');f.length&&jQuery(document.getElementById("frm_edit_"+f.val())).find("a").addClass("frm_ajax_edited").click();jQuery(b.content).find(".frm_message").length&&ja("pageLoad");ka()}else if(Object.keys(b.errors).length){I(jQuery(a),
"enable");d=!0;Ua();h=!1;for(f in b.errors)g=jQuery(a).find("#frm_field_"+f+"_container"),g.length&&(g.is(":visible")||(k=g.closest(".frm_toggle_container"),k.length&&(k=k.prev(),k.hasClass("frm_trigger")||(k=k.prev(".frm_trigger")),k.click())),g.is(":visible")&&(U(g,f,b.errors),d=!1,g=jQuery(a).find("#frm_field_"+f+"_container .frm-g-recaptcha, #frm_field_"+f+"_container .g-recaptcha"),g.length&&(h=!0,g=g.data("rid"),jQuery().grecaptcha&&(g?grecaptcha.reset(g):grecaptcha.reset()))));c.removeClass("frm_doing_ajax");
Va(a);!0!==h&&Wa(a,!1);d?a.submit():jQuery(a).prepend(b.error_message)}else rb(a),Wa(a,!0),a.submit()},error:function(){jQuery(a).find('input[type="submit"], input[type="button"]').removeAttr("disabled");a.submit()}})}function U(a,b,c){a.length&&a.is(":visible")&&(a.addClass("frm_blank_field"),"function"==typeof frmThemeOverride_frmPlaceError?frmThemeOverride_frmPlaceError(b,c):a.append('<div class="frm_error">'+c[b]+"</div>"))}function Ua(){jQuery(".form-field").removeClass("frm_blank_field");jQuery(".form-field .frm_error").replaceWith("");
jQuery(".frm_error_style").remove()}function Va(a){var b=jQuery(a).find(".frm_blank_field:first");b.length&&frmFrontForm.scrollMsg(b,a,!0)}function S(a){a.hasClass("frm_loading_form")||a.addClass("frm_loading_form");a.find('input[type="submit"], input[type="button"], button[type="submit"]').attr("disabled","disabled")}function I(a,b){a.removeClass("frm_loading_form");"enable"==b&&a.find('input[type="submit"], input[type="button"], button[type="submit"]').removeAttr("disabled")}function rb(a){var b=
...
function tb(){Xa(jQuery(this),"replace")}function Xa(a,b){var c=a.data("frmval").replace(/(\n|\r\n)/g,"\r");if(""===c||"undefined"==typeof c)return!1;var d=a.val().replace(/(\n|\r\n)/g,"\r");"replace"==b?""===d&&a.addClass("frm_default").val(c):d==c&&a.removeClass("frm_default").val("")}function ub(){var a=jQuery(this),b=a.data("eid"),c=a.data("fid");a.append('<span class="spinner" style="display:inline"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_send_email",
entry_id:b,form_id:c,nonce:frm_js.nonce},success:function(b){a.replaceWith(b)}});return!1}function vb(a,b){google.load("visualization","1.0",{packages:[b],callback:function(){var b=new google.visualization.DataTable,d=!1;-1!==jQuery.inArray("id",a.options.fields)&&(d=!0,b.addColumn("number",frm_js.id));for(var e=a.fields.length,f,h=0,g=e;h<g;h++){var k=a.fields[h];f=Ya(k);b.addColumn(f,k.name)}h=!1;a.options.edit_link&&(h=!0,b.addColumn("string",a.options.edit_link));g=!1;a.options.delete_link&&(g=
!0,b.addColumn("string",a.options.delete_link));if(null!==a.entries){var l=a.entries.length;b.addRows(l);for(var m=0,q=0;q<l;q++){var k=0,p=a.entries[q];d&&(b.setCell(m,k,p.id),k++);for(var r=0,t=e;r<t;r++){var u=a.fields[r];f=Ya(u);u=p.metas[u.id];"number"!=f||null!==u&&""!==u?"boolean"==f&&(u=null===u||"false"==u||!1===u?!1:!0):u=0;b.setCell(m,k,u);k++}h&&("undefined"!==typeof p.editLink?b.setCell(m,k,'<a href="'+p.editLink+'">'+a.options.edit_link+"</a>"):b.setCell(m,k,""),k++);g&&("undefined"!==
typeof p.deleteLink?b.setCell(m,k,'<a href="'+p.deleteLink+'" class="frm_delete_link" data-frmconfirm="'+a.options.confirm+'">'+a.options.delete_link+"</a>"):b.setCell(m,k,""));m++}}else for(b.addRows(1),h=k=0,g=e;h<g;h++)0<k?b.setCell(0,k,""):b.setCell(0,k,a.options.no_entries),k++;(new google.visualization.Table(document.getElementById("frm_google_table_"+a.options.form_id))).draw(b,a.graphOpts)}})}function wb(a){google.load("visualization","1.0",{packages:[a["package"]],callback:function(){var b;
new google.visualization.DataTable;b=google.visualization.arrayToDataTable(a.data);var c=document.getElementById("chart_"+a.graph_id);if(null!==c){var d=a.type.charAt(0).toUpperCase()+a.type.slice(1);"Histogram"!==d&&"Table"!==d&&(d+="Chart");c=new google.visualization[d](c);c.draw(b,a.options);jQuery(document).trigger("frmDrawChart",[c,"chart_"+a.graph_id,b])}}})}function Ya(a){var b="string";if("number"==a.type)b="number";else if("checkbox"==a.type||"select"==a.type){var c=a.options.length;"select"==
a.type&&""===a.options[0]&&(c="post_status"==a.field_options.post_field?3:c-1);1==c&&(b="boolean")}return b}function xb(){var a=jQuery(this).data("key"),b=jQuery(this).data("parent"),c="frm_section_"+b+"-"+a,d=jQuery(document.getElementById(c)),e=d.find("input, select, textarea"),f=jQuery(this).closest("form").find('input[name="form_id"]').val();d.fadeOut("slow",function(){d.remove();e.each(function(){var c=p(this,!1);"file"!=this.type&&T(c,jQuery(this));E("frm_field_"+c+"-"+b+"-"+a+"_container",
f)});"function"==typeof frmThemeOverride_frmRemoveRow&&frmThemeOverride_frmRemoveRow(c,d)});return!1}function yb(){if(!0===R)return!1;R=!0;var a=jQuery(this).data("parent"),b=0;if(0<jQuery(".frm_repeat_"+a).length)var c=jQuery(".frm_repeat_"+a+":last").attr("id").replace("frm_section_"+a+"-",""),b=-1<c.indexOf("i")?1:1+parseInt(c);jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"json",data:{action:"frm_add_form_row",field_id:a,i:b,nonce:frm_js.nonce},success:function(c){var d=c.html,f=jQuery(d).hide().fadeIn("slow");
jQuery(".frm_repeat_"+a+":last").after(f);var h=["other"],g,k,l={repeatingSection:a.toString(),repeatRow:b.toString()};jQuery(d).find("input, select, textarea").each(function(){if("file"!=this.type){if(""===this.name)return!0;g=this.name.replace("item_meta[","").split("]")[2].replace("[","");-1==jQuery.inArray(g,h)&&!1!==this.id&&""!==this.id&&(k=jQuery("#"+this.id),h.push(g),K(g,l),da(g,l,"value changed"),la(g,k),ma(g,k,"value changed"),T(g,k))}});t(l.repeatRow);Za();ha();"function"==typeof frmThemeOverride_frmAddRow&&
...
post_id:d,entry_id:b,id:e,nonce:frm_js.nonce,fields:h,exclude_fields:g},success:function(d){k.children(".frm-loading-img").replaceWith(d);a.removeClass("frm_inplace_edit").addClass("frm_cancel_edit");a.html(f);ja("editInPlace");jQuery(document).on("change",'.frm-show-form input[name^="item_meta"], .frm-show-form select[name^="item_meta"], .frm-show-form textarea[name^="item_meta"]',A);ka(c+b)}});return!1}function Ab(){var a=jQuery(this),b=a.data("entryid"),c=a.data("prefix"),d=a.data("edit");a.hasClass("frm_ajax_edited")||
...
1>jQuery(b).find('input[type="file"]').filter(function(){return!!this.value}).length?(D=jQuery(b).find('input[name="frm_action"]').val(),frmFrontForm.checkFormErrors(b,D)):b.submit():b.submit())}},validateFormSubmit:function(a){"undefined"!=typeof tinyMCE&&jQuery(a).find(".wp-editor-wrap").length&&tinyMCE.triggerSave();x=[];var b=jQuery(a).hasClass("frm_js_validate");b&&(Sa(a)||Ta(a))&&(b=!1);b&&(frmFrontForm.getAjaxFormErrors(a),Object.keys(x).length&&frmFrontForm.addAjaxFormErrors(a));return x},
