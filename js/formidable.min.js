...
b){var c=!1;-1<I(b.FormId).indexOf(b.hideContainerID)&&(c=!0);c||(a.length?(a.hide(),c=X(a),c.length&&Y(c)):(c=Z(b.HideField,b.hideContainerID),c=jQuery('input[name^="'+c+'"]'),Y(c)),aa(b.hideContainerID,b.FormId))}function Y(a){a.prop("checked",!1).prop("selectedIndex",0);a.not(":checkbox, :radio, select").val("");var b=!1;a.each(function(){"SELECT"==this.tagName&&null!==document.getElementById(this.id+"_chosen")&&jQuery(this).trigger("chosen:updated");(!1===b||0>["checkbox","radio"].indexOf(this.type))&&
E(jQuery(this));b=!0})}function aa(a,b){var c=I(b);-1<c.indexOf(a)||(c.push(a),F["form_"+b]=c,c=JSON.stringify(c),document.getElementById("frm_hide_fields_"+b).value=c)}function I(a){var b=[];"undefined"!==typeof F["form_"+a]?b=F["form_"+a]:(b=(b=document.getElementById("frm_hide_fields_"+a).value)?JSON.parse(b):[],F["form_"+a]=b);return b}function V(a,b){if(-1===I(a.FormId).indexOf(a.hideContainerID)){var c=jQuery(document.getElementById(a.hideContainerID));"hide"===b&&(c.hide(),aa(a.hideContainerID,
