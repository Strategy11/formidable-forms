function frmFrontFormJS(){function l(a){var b=jQuery(this),c=b.attr("type");"submit"!==c&&a.preventDefault();a=b.parents("form:first");var d="",e="",f=this.name;"frm_prev_page"===f||-1!==this.className.indexOf("frm_prev_page")?d=jQuery(a).find(".frm_next_page").attr("id").replace("frm_next_p_",""):"frm_save_draft"===f||-1!==this.className.indexOf("frm_save_draft")?e=1:-1!==this.className.indexOf("frm_page_skip")?(b=b.data("page"),f=jQuery(a).find('input[name="form_id"]').val(),f=jQuery(a).find('input[name="frm_page_order_'+
    ...
    b.type||(c=ca(b))):c="checkbox"!==b.type&&"radio"!==b.type||!b.checked?jQuery(b).val():b.value;"undefined"===typeof c&&(c="");return c}function ca(a){var b="";a=document.getElementById(a.id+"-otext");null!==a&&""!==a.value&&(b=a.value);return b}function Ja(a){var b=!1;a=jQuery(a).find(".frm_saving_draft");a.length&&(b=a.val());return b}function Ka(a){var b=!1,c=jQuery(a).find(".frm_next_page");if(c.length&&c.val()){var d=jQuery(a).find('input[name="form_id"]').val();a=jQuery(a).find('input[name="frm_page_order_'+
        ...
        d=jQuery(a).val();if(null===d)d="";else if("string"!==typeof d)for(var e=d,d="",f=0;f<e.length;f++)""!==e[f]&&(d=e[f]);e=-1===c.indexOf("frm_other_input")?q(a,!0):q(a,!1);-1!==c.indexOf("frm_time_select")&&(e=e.replace("-H","").replace("-m",""))}""===d&&(""===e&&(e=q(a,!0)),e in b||(b[e]=F(a,"data-reqmsg")));return b}function fb(a){var b="";jQuery('input[name="file'+a+'"], input[name="file'+a+'[]"], input[name^="item_meta['+a+']"]').each(function(){""===b&&(b=this.value)});return b}function ja(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           b,c){var d=a.value,e=q(a,!0);if(e in b)return b;var f=0===e.indexOf("conf_");if(""!==d||f){var h=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/i,g=F(a,"data-invmsg");""!==d&&!1===h.test(d)?(b[e]=g,f&&(b[e.replace("conf_","")]="")):f&&(a=a.name.replace("conf_",""),c.filter('[name="'+a+'"]').val()!==d&&(b[e]="",b[e.replace("conf_","")]=""))}return b}function ka(a,b){var c=a.value;""!==c&&!1!==isNaN(c/
        1)&&(c=q(a,!0),c in b||(b[c]=F(a,"data-invmsg")));return b}function la(a,b){var c=a.value,d=F(a,"pattern");if(""!==d&&""!==c){var e=q(a,!0);e in b||(d=new RegExp("^"+d+"$","i"),!1===d.test(c)&&(b[e]=F(a,"data-invmsg")))}return b}function F(a,b){var c=a.getAttribute(b);null===c&&(c="");return c}function gb(a,b){"undefined"==typeof b&&jQuery(a).find('input[name="frm_action"]').val();var c=jQuery(a).find(".frm_form_field");c.addClass("frm_doing_ajax");jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:jQuery(a).serialize()+
    "&action=frm_entries_"+b+"&nonce="+frm_js.nonce,success:function(b){var d={content:"",errors:{},pass:!1};null===b&&(b=d);b=b.replace(/^\s+|\s+$/g,"");b=0===b.indexOf("{")?jQuery.parseJSON(b):d;if("undefined"!=typeof b.redirect)window.location=b.redirect;else if(""!==b.content){M(jQuery(a));-1!=frm_js.offset&&frmFrontForm.scrollMsg(jQuery(a),!1);var f=jQuery(a).find('input[name="form_id"]').val();jQuery(a).find(".frm_form_field").fadeOut("slow",function(){b.content=b.content.replace(/ class="frm_form_field /g,
    ...
    jQuery(document.getElementById("frm_edit_"+h.val())).find("a").addClass("frm_ajax_edited").click();jQuery(b.content).find(".frm_message").length&&da("pageLoad");ea()}else if(Object.keys(b.errors).length){M(jQuery(a),"enable");d=!0;La();var g=!1,k=null;for(h in b.errors)if(k=jQuery(a).find("#frm_field_"+h+"_container"),k.length){if(!k.is(":visible")){var m=k.closest(".frm_toggle_container");m.length&&(m=m.prev(),m.hasClass("frm_trigger")||(m=m.prev(".frm_trigger")),m.click())}k.is(":visible")&&(O(k,
        h,b.errors),d=!1,k=jQuery(a).find("#frm_field_"+h+"_container .frm-g-recaptcha, #frm_field_"+h+"_container .g-recaptcha"),k.length&&(g=!0,k=k.data("rid"),jQuery().grecaptcha&&(k?grecaptcha.reset(k):grecaptcha.reset())))}c.removeClass("frm_doing_ajax");Ma(a);!0!==g&&Na(a,!1);d?a.submit():jQuery(a).prepend(b.error_message)}else ib(a),Na(a,!0),a.submit()},error:function(){jQuery(a).find('input[type="submit"], input[type="button"]').removeAttr("disabled");a.submit()}})}function hb(a){if(history.pushState&&
        ...
        c[b]+"</div>"))}function La(){jQuery(".form-field").removeClass("frm_blank_field");jQuery(".form-field .frm_error").replaceWith("");jQuery(".frm_error_style").remove()}function Ma(a){var b=jQuery(a).find(".frm_blank_field:first");b.length&&frmFrontForm.scrollMsg(b,a,!0)}function fa(a){a.hasClass("frm_loading_form")||a.addClass("frm_loading_form");a.find('input[type="submit"], input[type="button"], button[type="submit"]').attr("disabled","disabled")}function M(a,b){a.removeClass("frm_loading_form");
        "enable"==b&&a.find('input[type="submit"], input[type="button"], button[type="submit"]').removeAttr("disabled")}function ib(a){var b=document.getElementById("frm_loading");null!==b&&(a=jQuery(a).find("input[type=file]").val(),"undefined"!=typeof a&&""!==a&&setTimeout(function(){jQuery(b).fadeIn("slow")},2E3))}function Na(a,b){var c=jQuery(a).find(".frm-g-recaptcha, .g-recaptcha");c.length&&(!b||1>jQuery(a).find(".frm_next_page").length||1>jQuery(a).find(".frm_next_page").val())&&c.closest(".frm_form_field").replaceWith('<input type="hidden" name="recaptcha_checked" value="'+
        frm_js.nonce+'">')}function jb(){Oa(jQuery(this),"clear")}function kb(){Oa(jQuery(this),"replace")}function Oa(a,b){var c=a.data("frmval").replace(/(\n|\r\n)/g,"\r");if(""===c||"undefined"==typeof c)return!1;var d=a.val().replace(/(\n|\r\n)/g,"\r");"replace"==b?""===d&&a.addClass("frm_default").val(c):d==c&&a.removeClass("frm_default").val("")}function lb(){var a=jQuery(this),b=a.data("eid"),c=a.data("fid");a.append('<span class="spinner" style="display:inline"></span>');jQuery.ajax({type:"POST",
        url:frm_js.ajax_url,data:{action:"frm_entries_send_email",entry_id:b,form_id:c,nonce:frm_js.nonce},success:function(b){a.replaceWith(b)}});return!1}function mb(a,b){google.load("visualization","1.0",{packages:[b],callback:function(){var b=new google.visualization.DataTable,d=!1;-1!==jQuery.inArray("id",a.options.fields)&&(d=!0,b.addColumn("number",frm_js.id));for(var e=a.fields.length,f,h=0,g=e;h<g;h++){var k=a.fields[h];f=Pa(k);b.addColumn(f,k.name)}h=!1;a.options.edit_link&&(h=!0,b.addColumn("string",
    ...
    (b=jQuery(document.getElementById(c+b)),b.children(".frm_forms").replaceWith(""),b.children(".frm_orig_content").fadeIn("slow").removeClass("frm_orig_content"));a.removeClass("frm_cancel_edit").addClass("frm_inplace_edit");a.html(d);return!1}function sb(){var a=jQuery(this),b=a.data("deleteconfirm");if(confirm(b)){var c=a.data("entryid"),d=a.data("prefix");a.replaceWith('<span class="frm-loading-img" id="frm_delete_'+c+'"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_destroy",
        ...
        jQuery(a).slideUp("fast"):jQuery(a).slideDown("fast");return!1}function bb(a,b){for(var c in a)if(a.hasOwnProperty(c)&&a[c]===b)return c;return null}function Ga(a){return!jQuery.isArray(a)&&0<=a-parseFloat(a)+1}function vb(){Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){var c=this.length>>>0,d=Number(b)||0,d=0>d?Math.ceil(d):Math.floor(d);for(0>d&&(d+=c);d<c;d++)if(d in this&&this[d]===a)return d;return-1})}function wb(){"function"!==typeof String.prototype.trim&&(String.prototype.trim=
    ...
    jQuery(this).val()&&jQuery(this).blur()});jQuery(document).on("focus",".frm_toggle_default",jb);jQuery(document).on("blur",".frm_toggle_default",kb);jQuery(".frm_toggle_default").blur();jQuery(document.getElementById("frm_resend_email")).click(lb);jQuery(document).on("click",".frm_remove_link",A);jQuery(document).on("focusin","input[data-frmmask]",function(){jQuery(this).mask(jQuery(this).data("frmmask").toString())});jQuery(document).on("change",'.frm-show-form input[name^="item_meta"], .frm-show-form select[name^="item_meta"], .frm-show-form textarea[name^="item_meta"]',
        ...
        1>jQuery(b).find('input[type="file"]').filter(function(){return!!this.value}).length?(tinyMCE.triggerSave(),C=jQuery(b).find('input[name="frm_action"]').val(),frmFrontForm.checkFormErrors(b,C)):b.submit():b.submit())}},validateFormSubmit:function(a){"undefined"!=typeof tinyMCE&&jQuery(this).find(".wp-editor-wrap").length&&tinyMCE.triggerSave();w=[];var b=jQuery(a).hasClass("frm_js_validate");b&&(Ja(a)||Ka(a))&&(b=!1);b&&(frmFrontForm.getAjaxFormErrors(a),Object.keys(w).length&&frmFrontForm.addAjaxFormErrors(a));
        return w},getAjaxFormErrors:function(a){var b=[],c=jQuery(a).find(".frm_required_field:visible input, .frm_required_field:visible select, .frm_required_field:visible textarea").filter(":not(.frm_optional)");if(c.length)for(var d=0,e=c.length;d<e;d++)b=ia(c[d],b);c=jQuery(a).find("input[type=email]").filter(":visible");d=jQuery(a).find("input,select,textarea");if(d.length)for(var e=0,f=d.length;e<f;e++){var h=d[e];""!==h.value&&"hidden"!=h.type&&("number"==h.type?b=ka(h,b):"email"==h.type?b=ja(h,b,
        c):null!==h.pattern&&(b=la(h,b)))}c=jQuery(a).find(".frm-g-recaptcha");c.length&&(d=c.data("rid"),0===grecaptcha.getResponse(d).length&&(c=c.closest(".frm_form_field").attr("id").replace("frm_field_","").replace("_container",""),b[c]=""));w=b;if("function"==typeof frmThemeOverride_jsErrors&&(C=jQuery(a).find('input[name="frm_action"]').val(),a=frmThemeOverride_jsErrors(C,a),Object.keys(a).length))for(var g in a)w[g]=a[g];return w},addAjaxFormErrors:function(a){La();for(var b in w){var c=jQuery(a).find("#frm_field_"+
