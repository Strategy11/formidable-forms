...
d);if(1>g.length)d=!0;else{e=!0;for(var h=0,l=g.length;h<l&&g[h].id!==d;h++)if(!(-1<g[h].className.indexOf("frm_optional")||null!==g[h].getAttribute("data-frmfile")))if(1>O(g[h],[]).length){e=!0;break}else e=!1;d=e}}if(d){d=""!==document.getElementById("frm_verify_"+k).value||window._phantom||window.callPhantom||window.__phantomas||window.Buffer||window.emit||window.spawn?!0:!1;if(d)return this.removeFile(b),alert(frm_js.file_spam),!1;f.append("action","frm_submit_dropzone");f.append("field_id",c[a].fieldID);
f.append("form_id",c[a].formID);f.append("nonce",frm_js.nonce)}else return this.removeFile(b),alert(frm_js.empty_fields),!1});this.on("success",function(b,d){for(var e=jQuery.parseJSON(d),g=0;g<e.length;g++)!0!==c[a].uploadMultiple&&jQuery('input[name="'+f+'"]').val(e[g])});this.on("successmultiple",function(b,d){for(var e=jQuery.parseJSON(d),g=0;g<b.length;g++)jQuery(b[g].previewElement).append(ia(c[a],e[g],f))});this.on("complete",function(b){if("undefined"!==typeof b.mediaID){c[a].uploadMultiple&&
jQuery(b.previewElement).append(ia(c[a],b.mediaID,f));for(var d=b.previewElement.querySelectorAll("[data-dz-name]"),e=0,g=d.length;e<g;e++)d[e].innerHTML='<a href="'+b.url+'">'+b.name+"</a>"}});this.on("addedfile",function(){P(h)});this.on("queuecomplete",function(){E(h,"enable")});this.on("removedfile",function(b){!1!==b.accepted&&!0!==c[a].uploadMultiple&&jQuery('input[name="'+f+'"]').val("");!1!==b.accepted&&"undefined"!==typeof b.mediaID&&(jQuery(b.previewElement).remove(),this.options.maxFiles=
c[a].maxFiles-this.files.length)});if("undefined"!==typeof c[a].mockFiles)for(var b=0;b<c[a].mockFiles.length;b++){var d={name:c[a].mockFiles[b].name,size:c[a].mockFiles[b].size,url:c[a].mockFiles[b].file_url,mediaID:c[a].mockFiles[b].id};this.emit("addedfile",d);this.emit("thumbnail",d,c[a].mockFiles[b].url);this.emit("complete",d);this.files.push(d)}}})}}function ia(a,b,c){return'<input name="'+c+'[]" type="hidden" value="'+b+'" data-frmfile="'+a.fieldID+'" />'}function ab(){var a=jQuery(this).data("frm-remove");
...
function ja(a){var b=q(this,!1);if(b&&"undefined"!==typeof b&&(!a.frmTriggered||a.frmTriggered!=b)&&(ka(b,jQuery(this)),a="undefined"!==typeof a.originalEvent||-1<a.currentTarget.className.indexOf("frm_chzn")?"value changed":"other",la(b,jQuery(this),a),Q(b,jQuery(this)),jQuery(this).closest("form").hasClass("frm_js_validate"))){b=[];a=jQuery(this).closest(".frm_form_field");a.hasClass("frm_required_field")&&!jQuery(this).hasClass("frm_optional")&&(b=O(this,b));if(1>b.length)if("email"==this.type)var c=
jQuery(this).closest("form").find("input[type=email]"),b=ma(this,b,c);else"number"==this.type?b=na(this,b):null!==this.pattern&&(b=oa(this,b));a.removeClass("frm_blank_field has-error");a.find(".frm_error").remove();if(0<Object.keys(b).length)for(var d in b)R(a,d,b)}}function q(a,b){var c="",c=a instanceof jQuery?a.attr("name"):a.name;if(""===c)return c=a instanceof jQuery?a.data("name"):a.getAttribute("data-name"),""!==c&&c?c:0;c=c.replace("item_meta[","").replace("[]","").split("]");if(1>c.length)return 0;
...
typeof b))for(var c=__FRMRULES[a],d=F(b[0].name),f=0,e=c.dependents.length;f<e;f++)G(c.dependents[f],d)}function G(a,b){var c=S(a);if(!(!1===c||1>c.conditions.length)){var d=[];if(c.isRepeating)if(""!==b.repeatingSection){var f="frm_field_"+c.fieldId+"-",f=f+(b.repeatingSection+"-"+b.repeatRow+"_container");d.push(f)}else if(d=H(c),null!==document.getElementById("frm_field_"+d+"_container")){d=[];for(var f=document.querySelectorAll(".frm_field_"+c.fieldId+"_container"),e=0,g=f.length;e<g;e++)d.push(f[e].id)}else{d=
[];for(var e=H(c),f="frm_field_"+c.fieldId+"-"+e+"-",e=document.querySelectorAll('[name="item_meta['+e+'][row_ids][]"]'),g=0,h=e.length;g<h;g++)""!==e[g].value&&d.push(f+e[g].value+"_container");1>d.length&&d.push(f+"0_container")}else d.push("frm_field_"+c.fieldId+"_container");f=d.length;for(e=0;e<f;e++)c.containerId=d[e],pa(c,d[e]),qa(c)}}function H(a){var b="";"0"!==a.inEmbedForm?b=a.inEmbedForm:"0"!==a.inSection&&(b=a.inSection);return b}function pa(a,b){if(a.isRepeating){var c=b.replace("_container",
"").split("-");a.repeatRow=c[2]}else a.repeatRow=""}function qa(a){for(var b=[],c=a.conditions.length,d=0;d<c;d++)b.push(db(a.conditions[d],a));c=y="any"==a.anyAll?-1<b.indexOf(!0)?a.showHide:ra(a.showHide):-1<b.indexOf(!1)?ra(a.showHide):a.showHide;b=null!==document.getElementById(a.containerId);"show"==c?"data"==a.fieldType&&a.hasOwnProperty("dataLogic")?(a={fieldId:a.fieldId,fieldKey:a.fieldKey,formId:a.formId,containerId:a.containerId,repeatRow:a.repeatRow,dataLogic:{actualValue:a.dataLogic.actualValue,
fieldId:a.dataLogic.fieldId},children:"",inputType:a.inputType},"data"==a.inputType?eb(a,b):b&&fb(a)):!1!==x(a.containerId,a.formId)&&(z(a.containerId,a.formId),b?(b=sa(a.containerId),ta(b,"divider"==a.fieldType||"form"==a.fieldType,a.formId),jQuery("#"+a.containerId).show()):(b=ua(a),ta(b,"divider"==a.fieldType||"form"==a.fieldType,a.formId))):T(a,b)}function S(a){return"undefined"===typeof __FRMRULES||"undefined"===typeof __FRMRULES[a]?!1:__FRMRULES[a]}function db(a,b){var c=S(a.fieldId),d=va(c,
b);"data"==b.fieldType&&"data"==c.fieldType?(c=""===a.value?""===d||1==d.length&&""===d[0]?!1:!0:U(a.operator,a.value,d),b.dataLogic=a,b.dataLogic.actualValue=d,d=c):d=U(a.operator,a.value,d);return d}function va(a,b){if("radio"==a.inputType||"checkbox"==a.inputType){var c=wa(a,b);c=document.querySelectorAll('input[name^="'+c+'"]');c="checkbox"==a.inputType?I(c):V(c)}else if(!0===a.isMultiSelect){c=wa(a,b);var d=document.querySelectorAll('[name^="'+c+'"]');1==d.length&&"hidden"!=d[0].type?(c=jQuery('[name^="'+
c+'"]').val(),null===c&&(c="")):c=I(d)}else if(c="field_"+a.fieldKey,a.isRepeating&&(c+="-"+b.repeatRow),d=document.getElementById(c),null===d){d="";if("time"==a.fieldType){var f=document.getElementById(c+"_H");null!==f&&(d=document.getElementById(c+"_m"),d=f.value+":"+d.value,c=document.getElementById(c+"_A"),":"==d?d="":null!==c&&(d+=" "+c.value))}c=d}else c=d.value;"undefined"===typeof c?c="":"string"===typeof c&&(c=c.trim());return c}function wa(a,b){return a.isRepeating?"item_meta["+("0"!==b.inEmbedForm?
b.inEmbedForm:b.inSection)+"]["+b.repeatRow+"]["+a.fieldId+"]":"item_meta["+a.fieldId+"]"}function I(a){for(var b=[],c=0,d=a.length;c<d;c++)("hidden"==a[c].type||a[c].checked)&&b.push(a[c].value);0===b.length&&(b=!1);return b}function U(a,b,c){b=gb(b);c=hb(b,c);return"string"===typeof b&&"-1"!=b.indexOf("&quot;")&&U(a,b.replace("&quot;",'"'),c)?!0:{"==":function(a,b){return a==b},"!=":function(a,b){return a!=b},"<":function(a,b){return a>b},">":function(a,b){return a<b},LIKE:function(a,b){if(!b)return!1;
a=W(a);b=xa(a,b);return-1!=b.indexOf(a)},"not LIKE":function(a,b){if(!b)return!0;a=W(a);b=xa(a,b);return-1==b.indexOf(a)}}[a](b,c)}function gb(a){-1!==String(a).search(/^\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*$/)?a=parseFloat(a):"string"===typeof a&&(a=a.trim());return a}function hb(a,b){"undefined"===typeof b&&(b="");jQuery.isArray(b)&&-1<jQuery.inArray(String(a),b)&&(b=a);"number"===typeof a&&"string"===typeof b&&(b=parseFloat(b));"string"===typeof b&&(b=b.trim());return b}function xa(a,b){b=W(b);
if(jQuery.isArray(b))for(var c=0,d=b.length;c<d;c++){var f=b[c].toLowerCase();if(-1<f.indexOf(a)){b=a;break}}return b}function W(a){"string"===typeof a?a=a.toLowerCase():"number"===typeof a&&(a=a.toString());return a}function ra(a){return"show"==a?"hide":"show"}function sa(a){return document.getElementById(a).querySelectorAll('select[name^="item_meta"], textarea[name^="item_meta"], input[name^="item_meta"]')}function ua(a){if("divider"==a.fieldType){var b=[];"divider"==a.fieldType&&(b=document.querySelectorAll('[data-sectionid="'+
a.fieldId+'"]'));a=b}else"form"==a.fieldType?a=document.querySelectorAll('[id^="field_'+a.fieldKey+'-"]'):(a=a.isRepeating?"item_meta["+H(a)+"]["+a.repeatRow+"]["+a.fieldId+"]":"item_meta["+a.fieldId+"]",a=document.querySelectorAll('[name^="'+a+'"]'));return a}function ta(a,b,c){if(a.length)for(var d,f=["checkbox","radio"],e=0;e<a.length;e++)if(!(0<e&&"undefined"!==typeof d&&d.name==a[e].name&&-1<f.indexOf(d.type)||b&&J(a[e],c))){d=a[e];var g=jQuery(d),h=g.data("frmval");if("undefined"!==typeof h){if("checkbox"==
d.type||"radio"==d.type)ya(d.name,h);else if(-1<d.name.indexOf("[]")){var k=document.getElementsByName(d.name);if(jQuery.isArray(h))for(var l=0,m=h.length;l<m;l++)l in k&&(k[l].value=h[l]);else null!==k[0]&&(k[0].value=h)}else h.constructor===Object&&(k=d.getAttribute("name").split("[").slice(-1)[0],null!==k&&(k=k.replace("]",""),h=h[k],"undefined"==typeof h&&(h=""))),d.value=h;"SELECT"==d.tagName&&K(d);u(g)}d=a[e];g=q(d,!1);g=X(g);!1!==g&&"lookup"!=g.fieldType&&za(g,d,"value changed");d=a[e];if(g=
"undefined"!==typeof __FRMCALC){g=d.type;h=!1;if("text"==g||"hidden"==g||"number"==g)h=!0;g=h}if(g){g=__FRMCALC;h=d.name;k=d.id.replace("field_","");if(C(h))for(h=k.split("-"),k="",l=0;l<h.length-1;l++)k=""===k?h[l]:k+"-"+h[l];h=k;k=null;C(d.name)&&(k="hidden"!=d.type?jQuery(d).closest(".frm_form_field"):jQuery(d));d=k;void 0!==g.calc[h]&&Y(g,h,[],d)}d=a[e]}}function J(a,b){var c=q(a,!0);return x("frm_field_"+c+"_container",b)}function T(a,b){if(!x(a.containerId,a.formId)){if(b){jQuery("#"+a.containerId).hide();
var c=sa(a.containerId)}else c=ua(a);Z(c);Aa(a.containerId,a.formId)}}function Z(a){if(!(1>a.length)){for(var b,c=!0,d=0,f=a.length;d<f;d++)-1<a[d].className.indexOf("frm_dnc")||(0<d&&b.name!=a[d].name&&!0===c&&u(jQuery(b)),c=!0,"radio"==a[d].type||"checkbox"==a[d].type?a[d].checked=!1:"SELECT"==a[d].tagName?(0===a[d].selectedIndex?c=!1:a[d].selectedIndex=0,b=a[d].id.replace(/[^\w]/g,"_"),null!==document.getElementById(b+"_chosen")&&jQuery(a[d]).trigger("chosen:updated")):a[d].value=""),b=a[d];!0===
c&&u(jQuery(b))}}function x(a,b){var c=!1;-1<A(b).indexOf(a)&&(c=!0);return c}function Aa(a,b){var c=A(b);if(!(-1<c.indexOf(a))){c.push(a);var c=JSON.stringify(c),d=document.getElementById("frm_hide_fields_"+b);null!==d&&(d.value=c)}}function A(a){var b=[];a=document.getElementById("frm_hide_fields_"+a);return null===a?b:b=(b=a.value)?JSON.parse(b):[]}function ya(a,b){for(var c=document.getElementsByName(a),d=0,f=c.length;d<f;d++)if("hidden"==c[d].type)jQuery.isArray(b)&&null!==b[d]?c[d].value=b[d]:
c[d].value=b;else if(c[d].value==b||jQuery.isArray(b)&&-1<b.indexOf(c[d].value))if(c[d].checked=!0,"radio"==c[d].type)break}function z(a,b){var c=A(b),d=c.indexOf(a);-1<d&&(c.splice(d,1),c=JSON.stringify(c),document.getElementById("frm_hide_fields_"+b).value=c)}function la(a,b,c){if(!("undefined"===typeof __FRMLOOKUP||"undefined"===typeof __FRMLOOKUP[a]||1>__FRMLOOKUP[a].dependents.length||null===b||"undefined"===typeof b)){a=__FRMLOOKUP[a];b=F(b[0].name);for(var d=0,f=a.dependents.length;d<f;d++)aa(a.dependents[d],
b,c)}}function aa(a,b,c){a=X(a);if(!(!1===a||1>a.parents.length))if("lookup"==a.fieldType){if(""!==b.repeatRow){c=[];var d="frm_field_"+a.fieldId+"-",d=d+(b.repeatingSection+"-"+b.repeatRow+"_container");b=document.getElementById(d);null!==b&&c.push(b);b=c}else b=[],a.isRepeating?b=document.querySelectorAll(".frm_field_"+a.fieldId+"_container"):(c=document.getElementById("frm_field_"+a.fieldId+"_container"),null!==c&&b.push(c));c=0;for(d=b.length;c<d;c++){pa(a,b[c].id);var f=a,e=b[c];f.parentVals=
Ba(f);if("select"==f.inputType)ib(f,e);else if("radio"==f.inputType||"checkbox"==f.inputType)if(!1===f.parentVals){var g=e.getElementsByTagName("input");Ca(f,e);Z(g)}else jb(f,e)}}else if("value changed"===c)for(c="field_"+a.fieldKey,c=a.isRepeating?""!==b.repeatingSection?'[id="'+c+"-"+b.repeatRow+'"]':'[id^="'+c+'-"]':'[id="'+c+'"]',b=document.querySelectorAll(c),c=0,d=b.length;c<d;c++)f=a,e=F(b[c].name),f.repeatRow=""!==e.repeatRow?e.repeatRow:"",za(a,b[c])}function X(a){return"undefined"===typeof __FRMLOOKUP||
"undefined"===typeof __FRMLOOKUP[a]?!1:__FRMLOOKUP[a]}function za(a,b){a.parentVals=Ba(a);var c=b.id;c in p&&0<p[c].length?Da(a,b):(Da(a,b),Ea(a,b))}function Ba(a){for(var b=[],c=a.parents,d,f=0,e=c.length;f<e;f++){d=X(c[f]);d=va(d,a);if(""===d||!1===d){b=!1;break}b[f]=d}return b}function V(a){for(var b=!1,c=a.length,d=0;d<c;d++)if("hidden"==a[d].type||a[d].checked){b=a[d].value;break}return b}function ib(a,b){var c=b.getElementsByTagName("SELECT")[0];if(null!==c){var d=c.value;!1===a.parentVals?
(c.options.length=1,c.value="",K(c),""!==d&&u(jQuery(c),a.fieldKey)):(kb(c),ba(a.formId),jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_lookup_field_options",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(d){var f=c.value;d=JSON.parse(d);for(var g=c.options.length;0<g;g--)c.remove(g);for(var h=d.length,g=0;g<h;g++)c.options[g+1]=new Option(d[g],d[g],!1,!1);c.value=f;""===c.value&&(d=c.getAttribute("data-frmval"),null!==
d&&(c.value=d));!1===a.isReadOnly&&(c.disabled=!1);c.className=c.className.replace(" frm_loading_lookup","");K(c);c.value!=f&&u(jQuery(c),a.fieldKey);Fa(jQuery(b));ca(a.formId)}}))}}function K(a){-1<a.className.indexOf("frm_chzn")&&jQuery().chosen&&jQuery(a).trigger("chosen:updated")}function kb(a){a.className+=" frm_loading_lookup";a.disabled=!0;K(a)}function ba(a){L++;1>=L&&(a=Ga(a),null!==a&&P(jQuery(a)))}function ca(a){L--;0>=L&&(a=Ga(a),null!==a&&E(jQuery(a),"enable"))}function Ga(a){return document.querySelector("#frm_form_"+
a+"_container form")}function jb(a,b){var c=b.getElementsByClassName("frm_opt_container")[0],d=c.getElementsByTagName("input");lb(b,c);var f="",f="radio"==a.inputType?V(d):I(d),e=jQuery(d[0]).data("frmval");ba(a.formId);jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_cb_radio_lookup_options",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,container_field_id:H(a),row_index:a.repeatRow,current_value:f,default_value:e,nonce:frm_js.nonce},success:function(f){c.innerHTML=
...
function Ca(a,b){x(b.id,a.formId)||(jQuery("#"+b.id).hide(),Aa(b.id,a.formId))}function Ea(a,b){if(J(b,a.formId))da(b.id);else if(!1===a.parentVals){var c=b.getAttribute("data-frmval");null===c&&(c="");Ha(a,b,c);da(b.id)}else ba(a.formId),jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_get_lookup_text_value",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(c){J(b,a.formId)||b.value==c||Ha(a.fieldKey,b,c);ca(a.formId);da(b.id)}})}
function Da(a,b){var c=b.id;c in p?2<=p[c].length&&(p[c]=p[c].slice(0,1)):p[c]=[];p[c].push({childFieldArgs:a,childInput:b})}function da(a){p[a].shift();a in p&&0<p[a].length&&Ea(p[a][0].childFieldArgs,p[a][0].childInput)}function Ha(a,b,c){c=c.replace(/&amp;/g,"&");b.value=c;u(jQuery(b),a)}function eb(a,b){if(b){var c=jQuery("#"+a.containerId);Ia(c)}jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",entry_id:a.dataLogic.actualValue,current_field:a.fieldId,hide_id:a.containerId,
on_current_page:b,nonce:frm_js.nonce},success:function(d){if(b){var f=c.find(".frm_opt_container");f.html(d);var e=f.children("input"),g=e.val();Ja(f);""===d||""===g?T(a,!0):Ka(a,c,e,!0)}else f="field_"+a.fieldKey,""!==a.repeatRow&&(f+="-"+a.repeatRow),f=document.getElementById(f),f.value=d,x(a.containerId,a.formId)&&z(a.containerId,a.formId),u(jQuery(f))}})}function fb(a,b){var c=jQuery("#"+a.containerId),d=c.find('select[name^="item_meta"], input[name^="item_meta"]'),f=La(d),d=d.data("frmval"),
e=c.closest("form").find('input[name="id"]').val();Ia(c);jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_data_options",trigger_field_id:a.dataLogic.fieldId,entry_id:a.dataLogic.actualValue,field_id:a.fieldId,default_value:d,container_id:a.containerId,editing_entry:e,prev_val:f,nonce:frm_js.nonce},success:function(b){var d=c.find(".frm_opt_container");d.html(b);var e=d.find('select, input[type="checkbox"], input[type="radio"]');Ja(d);""===b||1>e.length?T(a,!0):(b=La(e),Ka(a,
c,e,f!==b))}})}function Ia(a){var b=a.html();-1<b.indexOf("frm-loading-img")||(a.html(b+'<span class="frm-loading-img"></span>'),a.find(".frm_opt_container").hide())}function lb(a,b){if(!(-1<a.innerHTML.indexOf("frm-loading-img"))){b.style.display="none";var c=document.createElement("span");c.setAttribute("class","frm-loading-img");a.insertBefore(c,b.nextSibling)}}function Ja(a){a.parent().children(".frm-loading-img").remove();a.show()}function La(a){var b=[],c="";a.each(function(){c=this.value;"radio"===
this.type||"checkbox"===this.type?!0===this.checked&&b.push(c):""!==c&&b.push(c)});0===b.length&&(b="");return b}function Ka(a,b,c,d){x(a.containerId,a.formId)&&(z(a.containerId,a.formId),b.show());c.hasClass("frm_chzn")&&ea();!0===d&&u(c)}function Q(a,b){if("undefined"!==typeof __FRMCALC){var c=__FRMCALC,d=c.fields[a];if("undefined"!==typeof d)for(var d=d.total,f=[],e=0,g=d.length;e<g;e++){var h=c.calc[d[e]];var k=b.attr("name"),l=!1,m=h.field_id,n=A(h.form_id);1>n.length||("0"===h.inSection&&"0"===
h.inEmbedForm?l=M(m,n):(k=F(k),M(m,n)?l=!0:Ma(m,k,n)?l=!0:"0"!==h.inSection&&"0"!==h.inEmbedForm?l=Ma(h.inSection,k,n):"0"!==h.inSection?l=M(h.inSection,n):"0"!==h.inEmbedForm&&(l=M(h.inEmbedForm,n))));h=l;!1===h&&Y(c,d[e],f,b)}}}function M(a,b){return-1<b.indexOf("frm_field_"+a+"_container")}function Ma(a,b,c){var d=!1;b.repeatingSection&&(a="frm_field_"+a+"-"+b.repeatingSection,a+="-"+b.repeatRow+"_container",d=-1<c.indexOf(a));return d}function Y(a,b,c,d){var f=a.calc[b],e=f.calc,g=jQuery(document.getElementById("field_"+
b)),h={triggerField:d,inSection:!1,thisFieldCall:'input[id^="field_'+b+'-"]'};1>g.length&&"undefined"!==typeof d&&(h.inSection=!0,h.thisFieldId=mb(a.fieldsWithCalc,b),g=Na(h));if(!(null===g||1>g.length)){e=nb(f,e,a,c,h);if("text"!=f.calc_type){a=f.calc_dec;-1<e.indexOf(").toFixed(")&&(c=e.split(").toFixed("),Oa(c[1])&&(a=c[1],e=e.replace(").toFixed("+a,"")));e=ob(e);e=parseFloat(eval(e));if("undefined"===typeof e||isNaN(e))e=0;Oa(a)&&(e=e.toFixed(a))}g.val()!==e&&(g.val(e),u(g,b))}}function nb(a,
b,c,d,f){for(var e=0,g=a.fields.length;e<g;e++){var h={triggerField:f.triggerField,thisFieldId:a.fields[e],inSection:f.inSection,valKey:f.inSection+""+a.fields[e],thisField:c.fields[a.fields[e]],thisFieldCall:"input"+c.fieldKeys[a.fields[e]]},k=c;"checkbox"==h.thisField.type||"radio"==h.thisField.type||"scale"==h.thisField.type?h.thisFieldCall=h.thisFieldCall+":checked,"+h.thisFieldCall+"[type=hidden]":"select"==h.thisField.type||"time"==h.thisField.type?h.thisFieldCall="select"+k.fieldKeys[h.thisFieldId]+
" option:selected,"+h.thisFieldCall+"[type=hidden]":"textarea"==h.thisField.type&&(h.thisFieldCall=h.thisFieldCall+",textarea"+k.fieldKeys[h.thisFieldId]);if("text"==a.calc_type)h.valKey="text"+h.valKey,d=pb(h,d),"undefined"===typeof d[h.valKey]&&(d[h.valKey]="");else{h.valKey="num"+h.valKey;d=qb(h,c,d);if("undefined"===typeof d[h.valKey]||isNaN(d[h.valKey]))d[h.valKey]=0;"date"==h.thisField.type&&0===d[h.valKey]&&(b="")}k="["+h.thisFieldId+"]";k=k.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1");b=
b.replace(new RegExp(k,"g"),d[h.valKey])}return b}function ob(a){var b=a.charAt(a.length-1);if("+"===b||"-"===b)a=a.substr(0,a.length-1);return a}function C(a){return 3<=a.split("][").length}function qb(a,b,c){if("undefined"!==typeof c[a.valKey]&&0!==c[a.valKey])return c;c[a.valKey]=0;var d=Pa(a);if(!1===d)return c;d.each(function(){var d=Qa(a.thisField,this);if("date"==a.thisField.type){var e=b.date;var g=0;if(d)if("undefined"===typeof jQuery.datepicker){g="-";-1<e.indexOf("/")&&(g="/");e=e.split(g);
var d=d.split(g),h;var k=g=h="";for(var l=0;l<e.length;l++)if("y"==e[l])k=((new Date).getFullYear()+15).toString().substr(2,2),k=d[l]>k?"19"+d[l]:"20"+d[l];else if("yy"==e[l])k=d[l];else if("m"==e[l]||"mm"==e[l])g=d[l],2>g.length&&(g="0"+g);else if("d"==e[l]||"dd"==e[l])h=d[l],2>h.length&&(h="0"+h);g=Date.parse(k+"-"+g+"-"+h)}else g=jQuery.datepicker.parseDate(e,d);e=g;null!==e&&(c[a.valKey]=Math.ceil(e/864E5))}else{e=d;""!==e&&0!==e&&(e=e.trim(),e=parseFloat(e.replace(/,/g,"").match(/-?[\d\.]+$/)));
...
a&&setTimeout(function(){jQuery(b).fadeIn("slow")},2E3))}function Wa(a,b){var c=jQuery(a).find(".frm-g-recaptcha, .g-recaptcha");c.length&&(!b||1>jQuery(a).find(".frm_next_page").length||1>jQuery(a).find(".frm_next_page").val())&&c.closest(".frm_form_field").replaceWith('<input type="hidden" name="recaptcha_checked" value="'+frm_js.nonce+'">')}function ub(){Xa(jQuery(this),"clear")}function vb(){Xa(jQuery(this),"replace")}function Xa(a,b){var c=a.data("frmval").replace(/(\n|\r\n)/g,"\r");if(""===
c||"undefined"==typeof c)return!1;var d=a.val().replace(/(\n|\r\n)/g,"\r");"replace"==b?""===d&&a.addClass("frm_default").val(c):d==c&&a.removeClass("frm_default").val("")}function wb(){var a=jQuery(this),b=a.data("eid"),c=a.data("fid");a.append('<span class="spinner" style="display:inline"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_send_email",entry_id:b,form_id:c,nonce:frm_js.nonce},success:function(b){a.replaceWith(b)}});return!1}function xb(a,b){google.load("visualization",
"1.0",{packages:[b],callback:function(){var b=new google.visualization.DataTable,d=!1;-1!==jQuery.inArray("id",a.options.fields)&&(d=!0,b.addColumn("number",frm_js.id));for(var f=a.fields.length,e,g=0,h=f;g<h;g++){var k=a.fields[g];e=Ya(k);b.addColumn(e,k.name)}g=!1;a.options.edit_link&&(g=!0,b.addColumn("string",a.options.edit_link));h=!1;a.options.delete_link&&(h=!0,b.addColumn("string",a.options.delete_link));if(null!==a.entries){var l=a.entries.length;b.addRows(l);for(var m=0,n=0;n<l;n++){var k=
0,p=a.entries[n];d&&(b.setCell(m,k,p.id),k++);for(var q=0,t=f;q<t;q++){var r=a.fields[q];e=Ya(r);r=p.metas[r.id];"number"!=e||null!==r&&""!==r?"boolean"==e&&(r=null===r||"false"==r||!1===r?!1:!0):r=0;b.setCell(m,k,r);k++}g&&("undefined"!==typeof p.editLink?b.setCell(m,k,'<a href="'+p.editLink+'">'+a.options.edit_link+"</a>"):b.setCell(m,k,""),k++);h&&("undefined"!==typeof p.deleteLink?b.setCell(m,k,'<a href="'+p.deleteLink+'" class="frm_delete_link" data-frmconfirm="'+a.options.confirm+'">'+a.options.delete_link+
"</a>"):b.setCell(m,k,""));m++}}else for(b.addRows(1),g=k=0,h=f;g<h;g++)0<k?b.setCell(0,k,""):b.setCell(0,k,a.options.no_entries),k++;(new google.visualization.Table(document.getElementById("frm_google_table_"+a.options.form_id))).draw(b,a.graphOpts)}})}function yb(a){google.load("visualization","1.0",{packages:[a["package"]],callback:function(){new google.visualization.DataTable;var b=google.visualization.arrayToDataTable(a.data);var c=document.getElementById("chart_"+a.graph_id);if(null!==c){var d=
a.type.charAt(0).toUpperCase()+a.type.slice(1);"Histogram"!==d&&"Table"!==d&&(d+="Chart");c=new google.visualization[d](c);c.draw(b,a.options);jQuery(document).trigger("frmDrawChart",[c,"chart_"+a.graph_id,b])}}})}function Ya(a){var b="string";if("number"==a.type)b="number";else if("checkbox"==a.type||"select"==a.type){var c=a.options.length;"select"==a.type&&""===a.options[0]&&(c="post_status"==a.field_options.post_field?3:c-1);1==c&&(b="boolean")}return b}function zb(){var a=jQuery(this).data("key"),
b=jQuery(this).data("parent"),c="frm_section_"+b+"-"+a,d=jQuery(document.getElementById(c)),f=d.find("input, select, textarea"),e=jQuery(this).closest("form").find('input[name="form_id"]').val();d.fadeOut("slow",function(){d.remove();f.each(function(){var c=q(this,!1);"file"!=this.type&&Q(c,jQuery(this));z("frm_field_"+c+"-"+b+"-"+a+"_container",e)});"function"==typeof frmThemeOverride_frmRemoveRow&&frmThemeOverride_frmRemoveRow(c,d);jQuery(document).trigger("frmAfterRemoveRow")});return!1}function Ab(){if(!0===
N)return!1;N=!0;var a=jQuery(this).data("parent"),b=0;if(0<jQuery(".frm_repeat_"+a).length)var c=jQuery(".frm_repeat_"+a+":last").attr("id").replace("frm_section_"+a+"-",""),b=-1<c.indexOf("i")?1:1+parseInt(c);jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"json",data:{action:"frm_add_form_row",field_id:a,i:b,nonce:frm_js.nonce},success:function(c){var d=c.html,e=jQuery(d).hide().fadeIn("slow");jQuery(".frm_repeat_"+a+":last").after(e);var g=["other"],h,k,l={repeatingSection:a.toString(),repeatRow:b.toString()};
jQuery(d).find("input, select, textarea").each(function(){if("file"!=this.type){if(""===this.name)return!0;h=this.name.replace("item_meta[","").split("]")[2].replace("[","");-1==jQuery.inArray(h,g)&&!1!==this.id&&""!==this.id&&(k=jQuery("#"+this.id),g.push(h),G(h,l),aa(h,l,"value changed"),ka(h,k),la(h,k,"value changed"),Q(h,k))}});w(l.repeatRow);Za();ea();"function"==typeof frmThemeOverride_frmAddRow&&frmThemeOverride_frmAddRow(a,c);jQuery(document).trigger("frmAfterAddRow");N=!1},error:function(){N=
...
for(var f=[],e=0;e<d;e++)if(e in c){var g=c[e];a.call(b,g,e,c)&&f.push(g)}return f})}function Kb(){Object.keys||(Object.keys=function(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&b.push(c);return b})}var N=!1,y="",v=[],L=0,p={};return{init:function(){jQuery(document).off("submit.formidable",".frm-show-form");jQuery(document).on("submit.formidable",".frm-show-form",frmFrontForm.submitForm);jQuery(document).on("click",".frm_trigger",n);var a=jQuery(".frm_blank_field");a.length&&a.closest(".frm_toggle_container").prev(".frm_trigger").click();
jQuery.isFunction(jQuery.fn.placeholder)?jQuery(".frm-show-form input, .frm-show-form textarea").placeholder():jQuery(".frm-show-form input[onblur], .frm-show-form textarea[onblur]").each(function(){""===jQuery(this).val()&&jQuery(this).blur()});jQuery(document).on("focus",".frm_toggle_default",ub);jQuery(document).on("blur",".frm_toggle_default",vb);jQuery(".frm_toggle_default").blur();jQuery(document.getElementById("frm_resend_email")).click(wb);jQuery(document).on("click",".frm_remove_link",ab);
jQuery(document).on("focusin","input[data-frmmask]",function(){jQuery(this).mask(jQuery(this).data("frmmask").toString())});jQuery(document).on("change",'.frm-show-form input[name^="item_meta"], .frm-show-form select[name^="item_meta"], .frm-show-form textarea[name^="item_meta"]',ja);jQuery(document).on("click",'.frm-show-form input[type="submit"], .frm-show-form input[name="frm_prev_page"], .frm_page_back, .frm_page_skip, .frm-show-form .frm_save_draft, .frm_prev_page, .frm_button_submit',m);jQuery(document).on("change",
'.frm_other_container input[type="checkbox"], .frm_other_container input[type="radio"], .frm_other_container select',cb);jQuery(document).on("click",".frm_remove_form_row",zb);jQuery(document).on("click",".frm_add_form_row",Ab);jQuery(document).on("click","a[data-frmconfirm]",Fb);jQuery("a[data-frmtoggle]").click(Gb);jQuery(".frm_edit_link_container").on("click","a.frm_inplace_edit",Bb);jQuery(".frm_edit_link_container").on("click","a.frm_cancel_edit",Cb);jQuery(document).on("click",".frm_ajax_delete",
Db);jQuery(".frm_month_heading, .frm_year_heading").click(function(){var a=jQuery(this).children(".ui-icon-triangle-1-e, .ui-icon-triangle-1-s");a.hasClass("ui-icon-triangle-1-e")?(a.addClass("ui-icon-triangle-1-s").removeClass("ui-icon-triangle-1-e"),jQuery(this).next(".frm_toggle_container").fadeIn("slow")):(a.addClass("ui-icon-triangle-1-e").removeClass("ui-icon-triangle-1-s"),jQuery(this).next(".frm_toggle_container").hide())});ga("pageLoad");ha();Hb();Ib();Jb();Kb()},submitForm:function(a){frmFrontForm.submitFormManual(a,
