...
(B=e.attr("id"),d=!0));e={};h=0;for(g=f.length;h<g;h++)if(m=k=f[h].HideField,n=e,n[m]=m in n?n[m]+1:0,f[h].FieldName===a?v(e[k],f[h],b,c):v(e[k],f[h],b),h===g-1){a:for(m in k=b,m=n=void 0,D){n=D[m];delete D[m];if("undefined"===typeof n)break a;var l=jQuery("#"+n.hideContainerID),p=n.show;if("any"===n.match&&-1===jQuery.inArray(!0,q[n.hideContainerID])||"all"===n.match&&-1<jQuery.inArray(!1,q[n.hideContainerID]))p="show"===n.show?"hide":"show";if("show"===p){if(X(l,n),l=k,0<n.DynamicInfoIndices.length)for(var u=
    ...
    aa(b.HideField,d),d=x(b),A(b),H(a,b,d),I(a,b,c);else{if("undefined"===typeof d||null===d)if(d=jQuery('input[name^="'+b.inputName+'"], textarea[name^="'+b.inputName+'"], select[name^="'+b.inputName+'"]'),1>d.length){d=document.getElementsByClassName("frm_field_"+b.FieldName+"_container");for(var f=0;f<d.length;f++){b.inputName=N(b.FieldName,d[f].id);b.containerID=d[f].id;b.hideContainerID=d[f].id.replace(b.FieldName,b.HideField);var e=x(b);A(b);H(a,b,e);I(a,b,c)}return}d=x(b);if(M(b.HideField))for(f=
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              document.getElementsByClassName("frm_field_"+b.HideField+"_container"),e=0;e<f.length;e++)b.hideContainerID=f[e].id,A(b),H(a,b,d),I(a,b,c);else A(b),H(a,b,d),I(a,b,c)}}function x(a){var b="";if("checkbox"===a.Type||"data-checkbox"===a.Type)return a=qa(a.containerID,a.inputName),b=a.length?a:"";b=jQuery('input[name="'+a.inputName+'"][type="hidden"]').val();"undefined"===typeof b&&(b="radio"==a.Type||"data-radio"===a.Type?jQuery('input[name="'+a.inputName+'"]:checked').val():"select"===a.Type||"data-select"===
a.Type?jQuery('select[name^="'+a.inputName+'"]').val():jQuery('input[name="'+a.inputName+'"], textarea[name="'+a.inputName+'"]').val());"undefined"===typeof b&&(b="");"string"===typeof b&&(b=b.trim());return b}function A(a){"undefined"===typeof q[a.hideContainerID]&&(q[a.hideContainerID]=[])}function H(a,b,c){q[b.hideContainerID][a]=null===c||""===c||1>c.length?!1:{funcName:"getDataOpts",f:b,sel:c};if("checkbox"===b.Type||"data-checkbox"===b.Type&&"undefined"===typeof b.LinkedField){var d=q[b.hideContainerID][a]=
    !1;if(""!==c){"!="===b.Condition&&(q[b.hideContainerID][a]=!0);for(var f=0;f<c.length;f++)d=C(b.Condition,b.Value,c[f]),"!="===b.Condition?!0===q[b.hideContainerID][a]&&!1===d&&(q[b.hideContainerID][a]=!1):!1===q[b.hideContainerID][a]&&d&&(q[b.hideContainerID][a]=!0)}else d=C(b.Condition,b.Value,""),!1===q[b.hideContainerID][a]&&d&&(q[b.hideContainerID][a]=!0)}else if("undefined"!==typeof b.LinkedField&&0===b.Type.indexOf("data-")){if("undefined"===typeof b.DataType||"data"===b.DataType)""===c?ba(b,
    ...
    n=g.hiddenFields:(n=document.getElementById("frm_hide_fields_"+g.formId).value,g.hiddenFields=n);n&&(n=JSON.parse(n),-1<n.indexOf(k)&&(m=!0))}else m=!0;g=m}if(g)e.isHidden=!0,e.valSet=!1;else{e.isHidden=!1;g=e;f=d[f];d=!1;if("checkbox"==f.type||"radio"==f.type)for(f=document.getElementsByName(f.name),k=f.length,m=0;m<k;m++){if(f[m].checked){d=!0;break}}else f.value&&(d=!0);g.valSet=d}}if(e.valSet||e.isHidden)h=!0;if(!0!==h){e=jQuery(a[c]);if(d=e.length)for(h=0;h<d;h++)if(f=jQuery(e[h]),g=f.data("frmval"),
...
h.calc[d]&&ia(h,d,[],e)}}}}}function E(a,b){"undefined"===typeof b&&(b="dependent");1<a.length&&(a=a.eq(0));a.trigger({type:"change",selfTriggered:!0,frmTriggered:b})}function C(a,b,c){"undefined"===typeof c&&(c="");jQuery.isArray(c)&&-1<jQuery.inArray(b,c)&&(c=b);-1!==String(b).search(/^\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*$/)&&(b=parseFloat(b),c=parseFloat(c));return"-1"!=String(b).indexOf("&quot;")&&C(a,b.replace("&quot;",'"'),c)?!0:{"==":function(a,b){return a==b},"!=":function(a,b){return a!=
    ...
    0!==e&&(e=e.trim(),e=parseFloat(e.replace(/,/g,"").match(/-?[\d\.]+$/)));if("undefined"===typeof e||isNaN(e)||""===e)e=0;c[a.valKey]+=e}});return c}function la(a){if("undefined"===typeof a.triggerField)return null;var b=a.triggerField.closest(".frm_repeat_sec, .frm_repeat_inline, .frm_repeat_grid");return b.length?(a=a.thisFieldCall.replace("[id=","[id^="),b.find(a)):null}function R(a){var b="";a=document.getElementById(a.id+"-otext");null!==a&&""!==a.value&&(b=a.value);return b}function T(a,b){if("hidden"==
        a.type)return b;var c="",d="";if("checkbox"==a.type||"radio"==a.type){var f=jQuery('input[name="'+a.name+'"]').closest(".frm_required_field").find("input:checked");jQuery(f).each(function(){c=this.value})}else if("file"==a.type)d=jQuery(a).data("fid"),"undefined"===typeof d&&(d=t(a,!0),d=d.replace("file","")),"undefined"===typeof b[d]&&(c=wa(d));else{d=a.className;if(-1!==d.indexOf("frm_pos_none"))return b;c=jQuery(a).val();if("string"!==typeof c)for(var f=c,c="",e=0;e<f.length;e++)""!==f[e]&&(c=
        f[e]);d=-1===d.indexOf("frm_other_input")?t(a,!0):t(a,!1)}""===c&&(""===d&&(d=t(a,!0)),d in b||(b[d]=G(a,"data-reqmsg")));return b}function wa(a){var b="";jQuery('input[name="file'+a+'"], input[name="file'+a+'[]"], input[name^="item_meta['+a+']"]').each(function(){""===b&&(b=this.value)});return b}function U(a,b,c){var d=a.value,f=t(a,!0);if(f in b)return b;var e=0===f.indexOf("conf_");if(""!==d||e){var h=/^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i,g=G(a,"data-invmsg");
        ""!==d&&!1===h.test(d)?(b[f]=g,e&&(b[f.replace("conf_","")]="")):e&&(a=a.name.replace("conf_",""),c.filter('[name="'+a+'"]').val()!==d&&(b[f]=g,b[f.replace("conf_","")]=""))}return b}function V(a,b){var c=a.value;""!==c&&!1!==isNaN(c/1)&&(c=t(a,!0),c in b||(b[c]=G(a,"data-invmsg")));return b}function W(a,b){var c=a.value,d=G(a,"pattern");if(""!==d&&""!==c){var f=t(a,!0);f in b||(d=new RegExp("^"+d+"$","i"),!1===d.test(c)&&(b[f]=G(a,"data-invmsg")))}return b}function G(a,b){var c=a.getAttribute(b);
        ...
        b.val())).find("a").addClass("frm_ajax_edited").click()}else{jQuery(a).find('input[type="submit"], input[type="button"]').removeAttr("disabled");jQuery(a).find(".frm_ajax_loading").removeClass("frm_loading_now");f=!0;jQuery(".form-field").removeClass("frm_blank_field");jQuery(".form-field .frm_error").replaceWith("");var e=!1,h=null,g;for(g in b)if(h=jQuery(a).find("#frm_field_"+g+"_container"),h.length){if(!h.is(":visible")){var k=h.closest(".frm_toggle_container");k.length&&(k=k.prev(),k.hasClass("frm_trigger")||
    (k=k.prev(".frm_trigger")),k.click())}h.is(":visible")&&(L(h,g,b),f=!1,jQuery(a).find("#frm_field_"+g+"_container .frm-g-recaptcha").length&&(e=!0,grecaptcha.reset()))}else if("redirect"==g){window.location=b[g];return}na(a);!0!==e&&jQuery(a).find(".frm-g-recaptcha").closest(".frm_form_field").replaceWith('<input type="hidden" name="recaptcha_checked" value="'+frm_js.nonce+'">');f&&a.submit()}},error:function(){jQuery(a).find('input[type="submit"], input[type="button"]').removeAttr("disabled");a.submit()}})}
    ...
    function Pa(){"function"!==typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")})}function Qa(){Array.prototype.filter||(Array.prototype.filter=function(a,b){if(void 0===this||null===this)throw new TypeError;var c=Object(this),d=c.length>>>0;if("function"!==typeof a)throw new TypeError;for(var f=[],e=0;e<d;e++)if(e in c){var h=c[e];a.call(b,h,e,c)&&f.push(h)}return f})}function Ra(){Object.keys||(Object.keys=function(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&
    b.push(c);return b})}function qa(a,b){var c=[];if("undefined"==typeof document.querySelector)jQuery("#"+a+' input[type=checkbox]:checked, input[type=hidden][name^="'+b+'"]').each(function(){c.push(this.value)});else for(var d=document.querySelectorAll("#"+a+' input[type=checkbox], input[type=hidden][name^="'+b+'"]'),f=0;f<d.length;f++)("checkbox"==d[f].type&&d[f].checked||"hidden"==d[f].type)&&c.push(d[f].value);return c}var q=[],D={},F=[],Q=[],B="",J=!1,S="",y=[];return{init:function(){jQuery(document).on("click",
...
function frmRecaptcha(){for(var l=jQuery(".frm-g-recaptcha"),p=0,u=l.length;p<u;p++)grecaptcha.render(l[p].id,{sitekey:l[p].getAttribute("data-sitekey")})}
