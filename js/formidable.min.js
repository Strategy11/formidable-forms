...
frmTriggered:b})}function B(a,b,c){"undefined"===typeof c&&(c="");jQuery.isArray(c)&&-1<jQuery.inArray(b,c)&&(c=b);-1!==String(b).search(/^\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*$/)&&(b=parseFloat(b),c=parseFloat(c));return"-1"!=String(b).indexOf("&quot;")&&B(a,b.replace("&quot;",'"'),c)?!0:{"==":function(a,b){return a==b},"!=":function(a,b){return a!=b},"<":function(a,b){return a>b},">":function(a,b){return a<b},LIKE:function(a,b){return b?-1!=b.toLowerCase().indexOf(a.toLowerCase()):0},"not LIKE":function(a,
b){return b?-1==b.toLowerCase().indexOf(a.toLowerCase()):1}}[a](b,c)}function S(a,b,c){"getDataOpts"==a.funcName?ja(a.f,a.sel,b,c):"getData"==a.funcName&&W(a.f,a.sel,0)}function W(a,b,c){var d=document.getElementById(a.hideContainerID),f=jQuery(d).find(".frm_data_field_container");if(0===f.length)return!0;c||f.html('<span class="frm-loading-img"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",entry_id:b,field_id:a.LinkedField,current_field:a.HideField,
hide_id:a.hideContainerID,nonce:frm_js.nonce},success:function(a){c?f.append(a):f.html(a);var b=f.children("input"),g=b.val();d.style.display=""===a&&!c||""===g?"none":"";D(b);return!0}})}function ja(a,b,c,d){if(!("stop"==d&&-1<jQuery.inArray(a.HideField,O)&&a.parentField&&"hidden"==a.parentField.attr("type"))){var f=jQuery("#"+a.hideContainerID).find('select[name^="item_meta"], textarea[name^="item_meta"], input[name^="item_meta"]'),e=ka(f),k=f.data("frmval");if("select"!=a.DataType||"stop"!=d&&
!jQuery("#"+a.hideContainerID+" .frm-loading-img").length||!(-1<jQuery.inArray(a.HideField,O))){O.push(a.HideField);var g=document.getElementById(a.hideContainerID),h=jQuery(g).find(".frm_data_field_container");if(0===h.length&&f.length)return r(a.HideField,"stop",f),!1;if(""!==a.Value&&!B(a.Condition,a.Value,b))return g.style.display="none",h.html(""),r(a.HideField,"stop",f),!1;h.html('<span class="frm-loading-img" style="visibility:visible;display:inline;"></span>');var l=a.DataType;jQuery.ajax({type:"POST",
url:frm_js.ajax_url,data:{action:"frm_fields_ajax_data_options",hide_field:c,entry_id:b,selected_field_id:a.LinkedField,field_id:a.HideField,default_value:k,hide_id:a.hideContainerID,nonce:frm_js.nonce},success:function(b){h.html(b);var c=h.find("select, input, textarea"),d=1;"hidden"==c.attr("type")&&(d=c.val());""===b||""===d?(g.style.display="none",e=""):"all"!=a.MatchType&&(g.style.display="");""!==b&&(""!==e?(jQuery.isArray(e)||(b=[],b.push(e),e=b),jQuery.each(e,function(a,b){if("undefined"!==
typeof b&&""!==b)if("checkbox"==l||"radio"==l)1<c.length?c.filter('[value="'+b+'"]').attr("checked","checked"):c.val()==b&&c.attr("checked","checked");else if("select"==l){var d=c.children('option[value="'+b+'"]');d.length?d.prop("selected",!0):e.splice(a,1)}else c.val(b)})):aa(M(h)));c.hasClass("frm_chzn")&&jQuery().chosen&&jQuery(".frm_chzn").chosen({allow_single_deselect:!0});D(c)}})}}}function ka(a){var b=[],c="";a.each(function(){c=this.value;"radio"===this.type||"checkbox"===this.type?!0===
this.checked&&b.push(c):""!==c&&b.push(c)});0===b.length&&(b="");return b}function J(a,b){if("undefined"!==typeof __FRMCALC){var c=__FRMCALC,d=c.fields[a];if("undefined"!==typeof d)for(var d=d.total,f=[],e=0,k=d.length;e<k;e++){var g;var h=c.calc[d[e]],l=b.attr("name");g=h.field_id;var n=h.form_id;if(h=document.getElementById("frm_hide_fields_"+n).value){var h=JSON.parse(h),m=g;N(l)&&(l=l.replace("item_meta","").replace(/\[/g,"").split("]"),m=g+"-"+l[0]+"-"+l[1]);-1<h.indexOf("frm_field_"+m+"_container")?
g=!0:(l=void 0,g=(l=n=(n=document.getElementById("frm_helpers_"+n).value)?JSON.parse(n):[])&&null!==l[g]&&-1<h.indexOf("frm_field_"+l[g]+"_container")?!0:!1)}else g=!1;g||ba(c,d[e],f,b)}}}function N(a){var b=!1;4<=a.split("[").length&&(b=!0);return b}function ba(a,b,c,d){var f=a.calc[b],e=f.calc,k=jQuery(document.getElementById("field_"+b)),g={triggerField:d,inSection:!1,thisFieldCall:'input[id^="field_'+b+'-"]'};1>k.length&&"undefined"!==typeof d&&(g.inSection=!0,g.thisFieldId=la(a.fieldsWithCalc,
b),k=ca(g));e=ma(f,e,a,c,g);a=f.calc_dec;e.indexOf(").toFixed(")&&(c=e.split(").toFixed("),da(c[1])&&(a=c[1],e=e.replace(").toFixed("+a,"")));e=parseFloat(eval(e));"undefined"===typeof e&&(e=0);da(a)&&(e=e.toFixed(a));k.val()!=e&&(k.val(e),D(k,b))}function ma(a,b,c,d,f){for(var e=0,k=a.fields.length;e<k;e++){var g={triggerField:f.triggerField,thisFieldId:a.fields[e],inSection:f.inSection,valKey:f.inSection+""+a.fields[e],thisField:c.fields[a.fields[e]],thisFieldCall:"input"+c.fieldKeys[a.fields[e]]},
...
function P(a){var b="";a=document.getElementById(a.id+"-otext");null!==a&&""!==a.value&&(b=a.value);return b}function ea(a,b){jQuery(a).find('input[type="submit"], input[type="button"]').attr("disabled","disabled");jQuery(a).find(".frm_ajax_loading").addClass("frm_loading_now");"undefined"==typeof b&&jQuery(a).find('input[name="frm_action"]').val();jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:jQuery(a).serialize()+"&action=frm_entries_"+b+"&nonce="+frm_js.nonce,success:function(b){b=b.replace(/^\s+|\s+$/g,
...
a.submit()}})}function fa(a,b,c){a.length&&a.is(":visible")&&(a.addClass("frm_blank_field"),"function"==typeof frmThemeOverride_frmPlaceError?frmThemeOverride_frmPlaceError(b,c):a.append('<div class="frm_error">'+c[b]+"</div>"))}function oa(){ga(jQuery(this),"clear")}function pa(){ga(jQuery(this),"replace")}function ga(a,b){var c=a.data("frmval").replace(/(\n|\r\n)/g,"\r");if(""===c||"undefined"==typeof c)return!1;var d=a.val().replace(/(\n|\r\n)/g,"\r");"replace"==b?""===d&&a.addClass("frm_default").val(c):
d==c&&a.removeClass("frm_default").val("")}function qa(){var a=jQuery(this),b=a.data("eid"),c=a.data("fid");a.append('<span class="spinner" style="display:inline"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_send_email",entry_id:b,form_id:c,nonce:frm_js.nonce},success:function(b){a.replaceWith(b)}});return!1}function ra(a,b){google.load("visualization","1.0",{packages:[b],callback:function(){if("table"==b){var c=new google.visualization.DataTable,d=!1;-1!==jQuery.inArray("id",
a.options.fields)&&(d=!0,c.addColumn("number",frm_js.id));for(var f=a.fields.length,e="string",k=0,g=f;k<g;k++){var h=a.fields[k],e=ha(h);c.addColumn(e,h.name)}k=!1;a.options.edit_link&&(k=!0,c.addColumn("string",a.options.edit_link));g=!1;a.options.delete_link&&(g=!0,c.addColumn("string",a.options.delete_link));h=0;if(null!==a.entries){var l=a.entries.length;c.addRows(l);for(var n=0,m=0;m<l;m++){var h=0,p=a.entries[m];d&&(c.setCell(n,h,p.id),h++);for(var q=0,t=f;q<t;q++){var r=a.fields[q],e=ha(r),
...
h,""):c.setCell(0,h,a.options.no_entries),h++;(new google.visualization.Table(document.getElementById("frm_google_table_"+a.options.form_id))).draw(c,a.graphOpts)}else sa(a)}})}function ha(a){var b="string";if("number"==a.type)b="number";else if("checkbox"==a.type||"select"==a.type){var c=a.options.length;"select"==a.type&&""===a.options[0]&&(c="post_status"==a.field_options.post_field?3:c-1);1==c&&(b="boolean")}return b}function sa(a){var b=new google.visualization.DataTable,c=!1,d=!1,f=a.rows.length;
...
c)).replaceWith(a)}})}return!1}function va(a){a.fadeOut("slow",function(){a.remove()})}function Ca(){var a=jQuery(this).data("frmconfirm");return confirm(a)}function Da(){var a=jQuery(this).data("frmtoggle");jQuery(a).is(":visible")?jQuery(a).slideUp("fast"):jQuery(a).slideDown("fast");return!1}function la(a,b){for(var c in a)if(a.hasOwnProperty(c)&&a[c]===b)return c;return null}function da(a){return!jQuery.isArray(a)&&0<=a-parseFloat(a)+1}function M(a){return a.find('select[name^="item_meta"], textarea[name^="item_meta"], input[name^="item_meta"]')}
function Y(a,b){var c="item_meta["+a+"]";K(a)&&(c=L(a,b));return c}function L(a,b){var c="";-1<b.indexOf("frm_section")?(c=b.replace("frm_section_","").split("-"),c="item_meta["+c[0]+"]["+c[1]+"]["+a+"]"):(c=b.replace("frm_field_","").replace("_container","").split("-"),c="item_meta["+c[1]+"]["+c[2]+"]["+a+"]");return c}function U(a,b){var c=b.replace("frm_section_","").split("-");return"frm_field_"+a+"-"+c[0]+"-"+c[1]+"_container"}function K(a){var b=document.getElementById("frm_field_"+a+"_container");
return"undefined"!==typeof b&&null!==b?!1:1>jQuery('input[name^="item_meta['+a+']"],select[name^="item_meta['+a+']"], textarea[name^="item_meta['+a+']"]').length?!0:!1}function Ea(){Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){var c=this.length>>>0,d=Number(b)||0,d=0>d?Math.ceil(d):Math.floor(d);for(0>d&&(d+=c);d<c;d++)if(d in this&&this[d]===a)return d;return-1})}function Fa(){"function"!==typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,
...
jQuery(".frm-show-form input, .frm-show-form textarea").placeholder():jQuery(".frm-show-form input[onblur], .frm-show-form textarea[onblur]").each(function(){""===jQuery(this).val()&&jQuery(this).blur()});jQuery(document).on("focus",".frm_toggle_default",oa);jQuery(document).on("blur",".frm_toggle_default",pa);jQuery(".frm_toggle_default").blur();jQuery(document.getElementById("frm_resend_email")).click(qa);jQuery(document).on("change",".frm_multiple_file",ta);jQuery(document).on("click",".frm_clear_file_link",
wa);jQuery(document).on("click",".frm_remove_link",ua);jQuery(document).on("focusin","input[data-frmmask]",function(){jQuery(this).mask(jQuery(this).data("frmmask").toString())});jQuery(document).on("change",'.frm-show-form input[name^="item_meta"], .frm-show-form select[name^="item_meta"], .frm-show-form textarea[name^="item_meta"]',x);jQuery(document).on("click",'.frm-show-form input[type="submit"], .frm-show-form input[name="frm_prev_page"], .frm-show-form .frm_save_draft',m);jQuery(document).on("change",
'.frm_other_container input[type="checkbox"], .frm_other_container input[type="radio"], .frm_other_container select',v);jQuery(document).on("change","input[type=file].frm_transparent",t);jQuery(document).on("click",".frm_remove_form_row",xa);jQuery(document).on("click",".frm_add_form_row",ya);jQuery(document).on("click","a[data-frmconfirm]",Ca);jQuery("a[data-frmtoggle]").click(Da);jQuery(".frm_edit_link_container").on("click","a.frm_inplace_edit",za);jQuery(".frm_edit_link_container").on("click",
"a.frm_cancel_edit",Aa);jQuery(".frm_ajax_delete").click(Ba);jQuery(".frm_month_heading, .frm_year_heading").click(function(){var a=jQuery(this).children(".ui-icon-triangle-1-e, .ui-icon-triangle-1-s");a.hasClass("ui-icon-triangle-1-e")?(a.addClass("ui-icon-triangle-1-s").removeClass("ui-icon-triangle-1-e"),jQuery(this).next(".frm_toggle_container").fadeIn("slow")):(a.addClass("ui-icon-triangle-1-e").removeClass("ui-icon-triangle-1-s"),jQuery(this).next(".frm_toggle_container").hide())});Ea();Fa();
Ga();Ha()},submitForm:function(a){a.preventDefault();jQuery(this).find(".wp-editor-wrap").length&&"undefined"!=typeof tinyMCE&&tinyMCE.triggerSave();Q=jQuery(this).find('input[name="frm_action"]').val();F=[];frmFrontForm.getAjaxFormErrors(this);if(0===Object.keys(F).length)ea(this,Q);else{jQuery(".form-field").removeClass("frm_blank_field");jQuery(".form-field .frm_error").replaceWith("");for(var b in F)a=jQuery(this).find(jQuery("#frm_field_"+b+"_container")),fa(a,b,F)}},getAjaxFormErrors:function(a){"function"==
typeof frmThemeOverride_jsErrors&&(F=frmThemeOverride_jsErrors(Q,a))},checkFormErrors:function(a,b){ea(a,b)},scrollToID:function(a){a=jQuery(document.getElementById(a).offset());window.scrollTo(a.left,a.top)},scrollMsg:function(a,b,c){var d="";if(d="undefined"==typeof b?jQuery(document.getElementById("frm_form_"+a+"_container")).offset().top:jQuery(b).find(document.getElementById("frm_field_"+a+"_container")).offset().top){d-=frm_js.offset;a=jQuery("html").css("margin-top");b=jQuery("body").css("margin-top");
