...
typeof e.attr("id")&&(A=e.attr("id"),d=!0));e={};k=0;for(g=f.length;k<g;k++)if(l=h=f[k].HideField,n=e,n[l]=l in n?n[l]+1:0,f[k].FieldName===a?u(e[h],f[k],b,c):u(e[h],f[k],b),k===g-1){a:for(l in h=b,l=n=void 0,C){n=C[l];delete C[l];if("undefined"===typeof n)break a;var m=jQuery("#"+n.hideContainerID),q=n.show;if("any"===n.match&&-1===jQuery.inArray(!0,p[n.hideContainerID])||"all"===n.match&&-1<jQuery.inArray(!1,p[n.hideContainerID]))q="show"===n.show?"hide":"show";if("show"===q){if(R(m,n),m=h,0<n.DynamicInfoIndices.length)for(var q=
void 0,t=0;t<n.DynamicInfoIndices.length;t++)q=n.DynamicInfoIndices[t],S(p[n.hideContainerID][q],n.FieldName,m)}else T(m,n)}d&&(A="")}}}function u(a,b,c,d){b.inputName="item_meta["+b.FieldName+"]";b.hiddenName="item_meta["+b.HideField+"]";b.containerID="frm_field_"+b.FieldName+"_container";b.hideContainerID="frm_field_"+b.HideField+"_container";if(""!==A)d=A,K(b.FieldName)&&(b.inputName=L(b.FieldName,d),b.containerID=U(b.FieldName,d)),b.hideContainerID=U(b.HideField,d),d=w(b),z(b),G(a,b,d),H(a,b,
...
b.HideField+"_container"),e=0;e<f.length;e++)b.hideContainerID=f[e].id,z(b),G(a,b,d),H(a,b,c);else z(b),G(a,b,d),H(a,b,c)}}function w(a){var b="";if("checkbox"===a.Type||"data-checkbox"===a.Type)return a=ia(a.containerID,a.inputName),b=a.length?a:"";b=jQuery('input[name="'+a.inputName+'"][type="hidden"]').val();if("undefined"!==typeof b)return b;b="radio"==a.Type||"data-radio"===a.Type?jQuery('input[name="'+a.inputName+'"]:checked').val():"select"===a.Type||"data-select"===a.Type?jQuery('select[name^="'+
...
B(b.Condition,b.Value,c[f]),"!="===b.Condition?!0===p[b.hideContainerID][a]&&!1===d&&(p[b.hideContainerID][a]=!1):!1===p[b.hideContainerID][a]&&d&&(p[b.hideContainerID][a]=!0)}else d=B(b.Condition,b.Value,""),!1===p[b.hideContainerID][a]&&d&&(p[b.hideContainerID][a]=!0)}else if("undefined"!==typeof b.LinkedField&&0===b.Type.indexOf("data-")){if("undefined"===typeof b.DataType||"data"===b.DataType)""===c?V(b.hideContainerID,b.HideField,"hide"):"data-radio"===b.Type?p[b.hideContainerID][a]="undefined"===
typeof b.DataType?B(b.Condition,b.Value,c):{funcName:"getData",f:b,sel:c}:(!(d="data-checkbox"===b.Type)&&(d="data-select"===b.Type)&&(d=jQuery.isArray(c)&&(1<c.length||""!==c[0])),d?(V(b.hideContainerID,b.HideField,"show"),p[b.hideContainerID][a]=!0,W(b,c,0)):"data-select"===b.Type&&(p[b.hideContainerID][a]={funcName:"getData",f:b,sel:c}))}else"undefined"===typeof b.Value&&0===b.Type.indexOf("data")?(b.Value=""===c?"1":c,p[b.hideContainerID][a]=B(b.Condition,b.Value,c),b.Value=void 0):p[b.hideContainerID][a]=
B(b.Condition,b.Value,c)}function H(a,b,c){if("all"===b.MatchType||!1===p[b.hideContainerID][a]){b.hideContainerID in C||(C[b.hideContainerID]={show:b.Show,match:b.MatchType,FieldName:b.FieldName,HideField:b.HideField,hideContainerID:b.hideContainerID,FormId:b.FormId,DynamicInfoIndices:[]});b=b.hideContainerID;var d=!1;!1!==p[b][a]&&!0!==p[b][a]&&(d=a);!1!==d&&C[b].DynamicInfoIndices.push(d)}else{d="none";if("show"===b.Show){if(!0!==p[b.hideContainerID][a]){S(p[b.hideContainerID][a],b.FieldName,c);
return}d=""}a=jQuery(document.getElementById(b.hideContainerID));"none"==d?T(a,b):R(a,b)}}function T(a,b){if(a.length){if(a.hide(),-1===jQuery.inArray(a.attr("id"),E)){E[b.HideField]=a.attr("id");var c=M(a);c.length&&X(c)}}else c=Y(b.HideField,b.hideContainerID),c=jQuery('input[name^="'+c+'"]'),X(c);var c=b.hideContainerID,d=document.getElementById("frm_hide_fields_"+b.FormId),f=d.value,f=f?JSON.parse(f):[];-1<f.indexOf(c)||(f.push(c),f=JSON.stringify(f),d.value=f)}function X(a){a.prop("checked",
!1).prop("selectedIndex",0);a.not(":checkbox, :radio, select").val("");var b=!1;a.each(function(){"SELECT"==this.tagName&&null!==document.getElementById(this.id+"_chosen")&&jQuery(this).trigger("chosen:updated");(!1===b||0>["checkbox","radio"].indexOf(this.type))&&D(jQuery(this));b=!0})}function V(a,b,c){-1===jQuery.inArray(a,E)&&(E[b]=a,a=jQuery(document.getElementById(a)),"hide"===c&&a.hide(),a.find(".frm_data_field_container").empty())}function R(a,b){var c=!1;if(a.hasClass("frm_section_heading")||
a.hasClass("frm_embed_form_container"))c=!0;c={inSection:c,formId:b.FormId};var d=b.hideContainerID,f=document.getElementById("frm_hide_fields_"+b.FormId),e=f.value;e&&(e=JSON.parse(e),d=e.indexOf(d),-1<d&&(e.splice(d,1),e=JSON.stringify(e),f.value=e));a.length?(f=M(a),Z(f,c),a.show()):(f=Y(b.HideField,b.hideContainerID),f=jQuery('input[name^="'+f+'"]'),Z(f,c))}function Z(a,b){if(a.length){b.valSet=!1;b.isHidden=!1;for(var c=0;c<a.length;c++){var d=a,f=c,e=b,k=!1;if(0===f||d[f-1].name!=d[f].name){var g;
...
!0;g=l}if(g)e.isHidden=!0,e.valSet=!1;else{e.isHidden=!1;g=e;f=d[f];d=!1;if("checkbox"==f.type||"radio"==f.type)for(f=document.getElementsByName(f.name),h=f.length,l=0;l<h;l++){if(f[l].checked){d=!0;break}}else f.value&&(d=!0);g.valSet=d}}if(e.valSet||e.isHidden)k=!0;if(!0!==k&&(aa(jQuery(a[c])),k=a[c],"undefined"!==typeof __FRMCALC&&("text"==k.type||"hidden"==k.type))){e=__FRMCALC;d=k.name;f=k.id.replace("field_","");if(N(d))for(d=f.split("-"),f="",g=0;g<d.length-1;g++)f=""==f?d[g]:f+"-"+d[g];d=
f;f=null;N(k.name)&&(f="hidden"!=k.type?jQuery(k).closest(".frm_form_field"):jQuery(k));k=f;void 0!==e.calc[d]&&ba(e,d,[],k)}}}}function aa(a){var b=a.length;if(b)for(var c=0;c<b;c++){var d=jQuery(a[c]),f=d.data("frmval");if("undefined"!==typeof f)if(!d.is(":checkbox, :radio"))d.val(f),D(d);else if(d.val()==f||jQuery.isArray(f)&&-1!==jQuery.inArray(d.val(),f))d.prop("checked",!0),D(d)}}function D(a,b){"undefined"===typeof b&&(b="dependent");1<a.length&&(a=a.eq(0));a.trigger({type:"change",selfTriggered:!0,
frmTriggered:b})}function B(a,b,c){"undefined"===typeof c&&(c="");jQuery.isArray(c)&&-1<jQuery.inArray(b,c)&&(c=b);-1!==String(b).search(/^\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*$/)&&(b=parseFloat(b),c=parseFloat(c));return"-1"!=String(b).indexOf("&quot;")&&B(a,b.replace("&quot;",'"'),c)?!0:{"==":function(a,b){return a==b},"!=":function(a,b){return a!=b},"<":function(a,b){return a>b},">":function(a,b){return a<b},LIKE:function(a,b){return b?-1!=b.indexOf(a):0},"not LIKE":function(a,b){return b?-1==b.indexOf(a):
1}}[a](b,c)}function S(a,b,c){"getDataOpts"==a.funcName?ja(a.f,a.sel,b,c):"getData"==a.funcName&&W(a.f,a.sel,0)}function W(a,b,c){var d=document.getElementById(a.hideContainerID),f=jQuery(d).find(".frm_data_field_container");if(0===f.length)return!0;c||f.html('<span class="frm-loading-img"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",entry_id:b,field_id:a.LinkedField,current_field:a.HideField,hide_id:a.hideContainerID,nonce:frm_js.nonce},success:function(a){c?
f.append(a):f.html(a);var b=f.children("input"),g=b.val();d.style.display=""===a&&!c||""===g?"none":"";D(b);return!0}})}function ja(a,b,c,d){if(!("stop"==d&&-1<jQuery.inArray(a.HideField,O)&&a.parentField&&"hidden"==a.parentField.attr("type"))){var f=jQuery("#"+a.hideContainerID).find('select[name^="item_meta"], textarea[name^="item_meta"], input[name^="item_meta"]'),e=ka(f),k=f.data("frmval");if("select"!=a.DataType||"stop"!=d&&!jQuery("#"+a.hideContainerID+" .frm-loading-img").length||!(-1<jQuery.inArray(a.HideField,
O))){O.push(a.HideField);var g=document.getElementById(a.hideContainerID),h=jQuery(g).find(".frm_data_field_container");if(0===h.length&&f.length)return r(a.HideField,"stop",f),!1;if(""!==a.Value&&!B(a.Condition,a.Value,b))return g.style.display="none",h.html(""),r(a.HideField,"stop",f),!1;h.html('<span class="frm-loading-img" style="visibility:visible;display:inline;"></span>');var l=a.DataType;jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_data_options",hide_field:c,
entry_id:b,selected_field_id:a.LinkedField,field_id:a.HideField,default_value:k,hide_id:a.hideContainerID,nonce:frm_js.nonce},success:function(b){h.html(b);var c=h.find("select, input, textarea"),d=1;"hidden"==c.attr("type")&&(d=c.val());""===b||""===d?(g.style.display="none",e=""):"all"!=a.MatchType&&(g.style.display="");""!==b&&(""!==e?(jQuery.isArray(e)||(b=[],b.push(e),e=b),jQuery.each(e,function(a,b){if("undefined"!==typeof b&&""!==b)if("checkbox"==l||"radio"==l)1<c.length?c.filter('[value="'+
b+'"]').attr("checked","checked"):c.val()==b&&c.attr("checked","checked");else if("select"==l){var d=c.children('option[value="'+b+'"]');d.length?d.prop("selected",!0):e.splice(a,1)}else c.val(b)})):aa(M(h)));c.hasClass("frm_chzn")&&jQuery().chosen&&jQuery(".frm_chzn").chosen({allow_single_deselect:!0});D(c)}})}}}function ka(a){var b=[],c="";a.each(function(){c=this.value;"radio"===this.type||"checkbox"===this.type?!0===this.checked&&b.push(c):""!==c&&b.push(c)});0===b.length&&(b="");return b}function J(a,
b){if("undefined"!==typeof __FRMCALC){var c=__FRMCALC,d=c.fields[a];if("undefined"!==typeof d)for(var d=d.total,f=[],e=0,k=d.length;e<k;e++){var g;var h=c.calc[d[e]],l=b.attr("name");g=h.field_id;var n=h.form_id;if(h=document.getElementById("frm_hide_fields_"+n).value){var h=JSON.parse(h),m=g;N(l)&&(l=l.replace("item_meta","").replace(/\[/g,"").split("]"),m=g+"-"+l[0]+"-"+l[1]);-1<h.indexOf("frm_field_"+m+"_container")?g=!0:(l=void 0,g=(l=n=(n=document.getElementById("frm_helpers_"+n).value)?JSON.parse(n):
[])&&null!==l[g]&&-1<h.indexOf("frm_field_"+l[g]+"_container")?!0:!1)}else g=!1;g||ba(c,d[e],f,b)}}}function N(a){var b=!1;4<=a.split("[").length&&(b=!0);return b}function ba(a,b,c,d){var f=a.calc[b],e=f.calc,k=jQuery(document.getElementById("field_"+b)),g={triggerField:d,inSection:!1,thisFieldCall:'input[id^="field_'+b+'-"]'};1>k.length&&"undefined"!==typeof d&&(g.inSection=!0,g.thisFieldId=la(a.fieldsWithCalc,b),k=ca(g));e=ma(f,e,a,c,g);a=f.calc_dec;e.indexOf(").toFixed(")&&(c=e.split(").toFixed("),
da(c[1])&&(a=c[1],e=e.replace(").toFixed("+a,"")));e=parseFloat(eval(e));"undefined"===typeof e&&(e=0);da(a)&&(e=e.toFixed(a));k.val()!=e&&(k.val(e),D(k,b))}function ma(a,b,c,d,f){for(var e=0,k=a.fields.length;e<k;e++){var g={triggerField:f.triggerField,thisFieldId:a.fields[e],inSection:f.inSection,valKey:f.inSection+""+a.fields[e],thisField:c.fields[a.fields[e]],thisFieldCall:"input"+c.fieldKeys[a.fields[e]]},h=c;"checkbox"==g.thisField.type||"select"==g.thisField.type?g.thisFieldCall=g.thisFieldCall+
":checked,select"+h.fieldKeys[g.thisFieldId]+" option:selected,"+g.thisFieldCall+"[type=hidden]":"radio"==g.thisField.type||"scale"==g.thisField.type?g.thisFieldCall=g.thisFieldCall+":checked,"+g.thisFieldCall+"[type=hidden]":"textarea"==g.thisField.type&&(g.thisFieldCall=g.thisFieldCall+",textarea"+h.fieldKeys[g.thisFieldId]);d=na(g,c,d);if("undefined"===typeof d[g.valKey]||isNaN(d[g.valKey]))d[g.valKey]=0;h="["+g.thisFieldId+"]";h=h.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1");b=b.replace(new RegExp(h,
"g"),d[g.valKey])}return b}function na(a,b,c){if("undefined"!==typeof c[a.valKey]&&0!==c[a.valKey])return c;c[a.valKey]=0;var d;if(!1===a.inSection)d=jQuery(a.thisFieldCall);else if(d=ca(a),null===d||"undefined"===typeof d)d=jQuery(a.thisFieldCall);if(null===d||"undefined"===typeof d||1>d.length)return c;d.each(function(){var d,e=a.thisField;d=!1;if("hidden"==this.type)""!==P(this)&&(d=!0);else if("select"==e.type){var k=this.className;k&&-1<k.indexOf("frm_other_trigger")&&(d=!0)}else("checkbox"==
...
b.date;k=0;if(d)if("undefined"===typeof jQuery.datepicker){k="-";-1<e.indexOf("/")&&(k="/");e=e.split(k);d=d.split(k);var g,h;g=k=h="";for(var l=0;l<e.length;l++)if("y"==e[l])g=((new Date).getFullYear()+15).toString().substr(2,2),g=d[l]>g?"19"+d[l]:"20"+d[l];else if("yy"==e[l])g=d[l];else if("m"==e[l]||"mm"==e[l])k=d[l],2>k.length&&(k="0"+k);else if("d"==e[l]||"dd"==e[l])h=d[l],2>h.length&&(h="0"+h);k=Date.parse(g+"-"+k+"-"+h)}else k=jQuery.datepicker.parseDate(e,d);e=k;null!==e&&(c[a.valKey]=Math.ceil(e/
864E5))}else{e=d;""!==e&&0!==e&&(e=e.trim(),e=parseFloat(e.replace(/,/g,"").match(/-?[\d\.]+$/)));if("undefined"===typeof e||isNaN(e)||""===e)e=0;c[a.valKey]+=e}});return c}function ca(a){if("undefined"===typeof a.triggerField)return null;var b=a.triggerField.closest(".frm_repeat_sec, .frm_repeat_inline, .frm_repeat_grid");return b.length?(a=a.thisFieldCall.replace("[id=","[id^="),b.find(a)):null}function P(a){var b="";a=document.getElementById(a.id+"-otext");null!==a&&""!==a.value&&(b=a.value);return b}
function ea(a,b){jQuery(a).find('input[type="submit"], input[type="button"]').attr("disabled","disabled");jQuery(a).find(".frm_ajax_loading").addClass("frm_loading_now");"undefined"==typeof b&&jQuery(a).find('input[name="frm_action"]').val();jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:jQuery(a).serialize()+"&action=frm_entries_"+b+"&nonce="+frm_js.nonce,success:function(b){b=b.replace(/^\s+|\s+$/g,"");0===b.indexOf("{")&&(b=jQuery.parseJSON(b));if(""===b||!b||"0"===b||"object"!=typeof b&&0===
b.indexOf("<!DOCTYPE")){var d=document.getElementById("frm_loading");null!==d&&(b=jQuery(a).find("input[type=file]").val(),"undefined"!=typeof b&&""!==b&&setTimeout(function(){jQuery(d).fadeIn("slow")},2E3));b=jQuery(a).find(".g-recaptcha");b.length&&(1>jQuery(a).find(".frm_next_page").length||1>jQuery(a).find(".frm_next_page").val())&&b.closest(".frm_form_field").replaceWith('<input type="hidden" name="recaptcha_checked" value="'+frm_js.nonce+'">');a.submit()}else if("object"!=typeof b){jQuery(a).find(".frm_ajax_loading").removeClass("frm_loading_now");
var f=jQuery(a).find('input[name="form_id"]').val();jQuery(a).closest("#frm_form_"+f+"_container").replaceWith(b);frmFrontForm.scrollMsg(f);if("function"==typeof frmThemeOverride_frmAfterSubmit){var f=jQuery('input[name="frm_page_order_'+f+'"]').val(),e=jQuery(b).find('input[name="form_id"]').val();frmThemeOverride_frmAfterSubmit(e,f,b,a)}b=jQuery(a).find('input[name="id"]');b.length&&jQuery(document.getElementById("frm_edit_"+b.val())).find("a").addClass("frm_ajax_edited").click()}else{jQuery(a).find('input[type="submit"], input[type="button"]').removeAttr("disabled");
jQuery(a).find(".frm_ajax_loading").removeClass("frm_loading_now");f=!0;jQuery(".form-field").removeClass("frm_blank_field");jQuery(".form-field .frm_error").replaceWith("");var e="",k=!1,g=null,h;for(h in b)if(g=jQuery(a).find(jQuery(document.getElementById("frm_field_"+h+"_container"))),g.length){if(!g.is(":visible")){var l=g.closest(".frm_toggle_container");l.length&&l.prev(".frm_trigger").click()}g.is(":visible")&&(f=!1,""===e&&(frmFrontForm.scrollMsg(h,a,!0),e="#frm_field_"+h+"_container"),jQuery(a).find("#frm_field_"+
h+"_container .g-recaptcha").length&&(k=!0,grecaptcha.reset()),fa(g,h,b))}else if("redirect"==h){window.location=b[h];return}!0!==k&&jQuery(a).find(".g-recaptcha").closest(".frm_form_field").replaceWith('<input type="hidden" name="recaptcha_checked" value="'+frm_js.nonce+'">');f&&a.submit()}},error:function(){jQuery(a).find('input[type="submit"], input[type="button"]').removeAttr("disabled");a.submit()}})}function fa(a,b,c){a.length&&a.is(":visible")&&(a.addClass("frm_blank_field"),"function"==typeof frmThemeOverride_frmPlaceError?
frmThemeOverride_frmPlaceError(b,c):a.append('<div class="frm_error">'+c[b]+"</div>"))}function oa(){ga(jQuery(this),"clear")}function pa(){ga(jQuery(this),"replace")}function ga(a,b){var c=a.data("frmval").replace(/(\n|\r\n)/g,"\r");if(""===c||"undefined"==typeof c)return!1;var d=a.val().replace(/(\n|\r\n)/g,"\r");"replace"==b?""===d&&a.addClass("frm_default").val(c):d==c&&a.removeClass("frm_default").val("")}function qa(){var a=jQuery(this),b=a.data("eid"),c=a.data("fid");a.append('<span class="spinner" style="display:inline"></span>');
jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_send_email",entry_id:b,form_id:c,nonce:frm_js.nonce},success:function(b){a.replaceWith(b)}});return!1}function ra(a,b){google.load("visualization","1.0",{packages:[b],callback:function(){if("table"==b){var c=new google.visualization.DataTable,d=!1;-1!==jQuery.inArray("id",a.options.fields)&&(d=!0,c.addColumn("number",frm_js.id));for(var f=a.fields.length,e="string",k=0,g=f;k<g;k++){var h=a.fields[k],e=ha(h);c.addColumn(e,h.name)}k=
!1;a.options.edit_link&&(k=!0,c.addColumn("string",a.options.edit_link));g=!1;a.options.delete_link&&(g=!0,c.addColumn("string",a.options.delete_link));h=0;if(null!==a.entries){var l=a.entries.length;c.addRows(l);for(var n=0,m=0;m<l;m++){var h=0,p=a.entries[m];d&&(c.setCell(n,h,p.id),h++);for(var q=0,t=f;q<t;q++){var r=a.fields[q],e=ha(r),r=p.metas[r.id];"number"!=e||null!==r&&""!==r?"boolean"==e&&(r=null===r||"false"==r||!1===r?!1:!0):r=0;c.setCell(n,h,r);h++}k&&("undefined"!==typeof p.editLink?
c.setCell(n,h,'<a href="'+p.editLink+'">'+a.options.edit_link+"</a>"):c.setCell(n,h,""),h++);g&&("undefined"!==typeof p.deleteLink?c.setCell(n,h,'<a href="'+p.deleteLink+'" class="frm_delete_link" data-frmconfirm="'+a.options.confirm+'">'+a.options.delete_link+"</a>"):c.setCell(n,h,""));n++}}else for(c.addRows(1),k=h=0,g=f;k<g;k++)0<h?c.setCell(0,h,""):c.setCell(0,h,a.options.no_entries),h++;(new google.visualization.Table(document.getElementById("frm_google_table_"+a.options.form_id))).draw(c,a.graphOpts)}else sa(a)}})}
function ha(a){var b="string";if("number"==a.type)b="number";else if("checkbox"==a.type||"select"==a.type){var c=a.options.length;"select"==a.type&&""===a.options[0]&&(c="post_status"==a.field_options.post_field?3:c-1);1==c&&(b="boolean")}return b}function sa(a){var b=new google.visualization.DataTable,c=!1,d=!1,f=a.rows.length;if(0<f)if("table"==a.type){c=!0;b.addRows(a.rows[f-1][0]+1);for(var e=0;e<f;e++)b.setCell(a.rows[e])}else if("undefined"!=typeof a.rows[0].tooltip)for(var d=c=!0,k=0;k<f;k++){e=
...
a+']"],select[name^="item_meta['+a+']"], textarea[name^="item_meta['+a+']"]').length?!0:!1}function Ea(){Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){var c=this.length>>>0,d=Number(b)||0,d=0>d?Math.ceil(d):Math.floor(d);for(0>d&&(d+=c);d<c;d++)if(d in this&&this[d]===a)return d;return-1})}function Fa(){"function"!==typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")})}function Ga(){Array.prototype.filter||(Array.prototype.filter=
function(a,b){if(void 0===this||null===this)throw new TypeError;var c=Object(this),d=c.length>>>0;if("function"!==typeof a)throw new TypeError;for(var f=[],e=0;e<d;e++)if(e in c){var k=c[e];a.call(b,k,e,c)&&f.push(k)}return f})}function Ha(){Object.keys||(Object.keys=function(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&b.push(c);return b})}function ia(a,b){var c=[];if("undefined"==typeof document.querySelector)jQuery("#"+a+' input[type=checkbox]:checked, input[type=hidden][name^="'+b+'"]').each(function(){c.push(this.value)});
else for(var d=document.querySelectorAll("#"+a+' input[type=checkbox], input[type=hidden][name^="'+b+'"]'),f=0;f<d.length;f++)("checkbox"==d[f].type&&d[f].checked||"hidden"==d[f].type)&&c.push(d[f].value);return c}var p=[],C={},E=[],O=[],A="",I=!1,Q="",F=[];return{init:function(){jQuery(document).on("click",".frm_trigger",q);var a=jQuery(".frm_blank_field");a.length&&a.closest(".frm_toggle_container").prev(".frm_trigger").click();jQuery.isFunction(jQuery.fn.placeholder)?jQuery(".frm-show-form input, .frm-show-form textarea").placeholder():
jQuery(".frm-show-form input[onblur], .frm-show-form textarea[onblur]").each(function(){""===jQuery(this).val()&&jQuery(this).blur()});jQuery(document).on("focus",".frm_toggle_default",oa);jQuery(document).on("blur",".frm_toggle_default",pa);jQuery(".frm_toggle_default").blur();jQuery(document.getElementById("frm_resend_email")).click(qa);jQuery(document).on("change",".frm_multiple_file",ta);jQuery(document).on("click",".frm_clear_file_link",wa);jQuery(document).on("click",".frm_remove_link",ua);
...
v);jQuery(document).on("change","input[type=file].frm_transparent",t);jQuery(document).on("click",".frm_remove_form_row",xa);jQuery(document).on("click",".frm_add_form_row",ya);jQuery(document).on("click","a[data-frmconfirm]",Ca);jQuery("a[data-frmtoggle]").click(Da);jQuery(".frm_edit_link_container").on("click","a.frm_inplace_edit",za);jQuery(".frm_edit_link_container").on("click","a.frm_cancel_edit",Aa);jQuery(".frm_ajax_delete").click(Ba);jQuery(".frm_month_heading, .frm_year_heading").click(function(){var a=
jQuery(this).children(".ui-icon-triangle-1-e, .ui-icon-triangle-1-s");a.hasClass("ui-icon-triangle-1-e")?(a.addClass("ui-icon-triangle-1-s").removeClass("ui-icon-triangle-1-e"),jQuery(this).next(".frm_toggle_container").fadeIn("slow")):(a.addClass("ui-icon-triangle-1-e").removeClass("ui-icon-triangle-1-s"),jQuery(this).next(".frm_toggle_container").hide())});Ea();Fa();Ga();Ha()},submitForm:function(a){a.preventDefault();jQuery(this).find(".wp-editor-wrap").length&&"undefined"!=typeof tinyMCE&&tinyMCE.triggerSave();
Q=jQuery(this).find('input[name="frm_action"]').val();F=[];frmFrontForm.getAjaxFormErrors(this);if(0===Object.keys(F).length)ea(this,Q);else{jQuery(".form-field").removeClass("frm_blank_field");jQuery(".form-field .frm_error").replaceWith("");for(var b in F)a=jQuery(this).find(jQuery("#frm_field_"+b+"_container")),fa(a,b,F)}},getAjaxFormErrors:function(a){"function"==typeof frmThemeOverride_jsErrors&&(F=frmThemeOverride_jsErrors(Q,a))},checkFormErrors:function(a,b){ea(a,b)},scrollToID:function(a){a=
