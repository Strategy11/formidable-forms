...
"checkbox"===a&&(this.checked?jQuery(this).closest(".frm_checkbox").children(".frm_other_input").removeClass("frm_pos_none"):jQuery(this).closest(".frm_checkbox").children(".frm_other_input").addClass("frm_pos_none").val(""))}function A(a){var c=p(this,!1);if(c&&"undefined"!==typeof c&&(!a.frmTriggered||a.frmTriggered!=c)){x(c,jQuery(this));a="undefined"!==typeof a.originalEvent||-1<a.currentTarget.className.indexOf("frm_chzn")?"value changed":"other";Z(c,jQuery(this),a);J(c,jQuery(this));c=[];a=
    ...
    ""):d+"-"+b[0]+"-"+b[1].replace("[",""));return d}function x(a,c){if(!("undefined"===typeof __FRMRULES||"undefined"===typeof __FRMRULES[a]||1>__FRMRULES[a].dependents.length||null===c||"undefined"===typeof c))for(var b=__FRMRULES[a],d=E(c[0].name),f=0,e=b.dependents.length;f<e;f++)y(b.dependents[f],d)}function y(a,c){var b=L(a);if(!(!1===b||1>b.conditions.length)){var d;d=[];if(b.isRepeating)if(""!==c.repeatingSection){var f="frm_field_"+b.fieldId+"-",f=f+(c.repeatingSection+"-"+c.repeatRow+"_container");
...
null!==g[m]?k[m].value=g[m]:k[m].value=g;else{if(k[m].value==g||jQuery.isArray(g)&&-1<g.indexOf(k[m].value))if(k[m].checked=!0,"radio"==k[m].type)break}else if(-1<d.name.indexOf("[]"))if(k=document.getElementsByName(d.name),jQuery.isArray(g))for(m=0,l=g.length;m<l;m++)m in k&&(k[m].value=g[m]);else null!==k[0]&&(k[0].value=g);else d.value=g;"SELECT"==d.tagName&&Q(d);u(h)}d=a[e];h=p(d,!1);h=R(h);!1!==h&&"lookup"!=h.fieldType&&(h.parentVals=S(h),qa(h,d));d=a[e];if(h="undefined"!==typeof __FRMCALC){h=
    d.type;g=!1;if("text"==h||"hidden"==h||"number"==h)g=!0;h=g}if(h){h=__FRMCALC;g=d.name;k=d.id.replace("field_","");if(3<=g.split("][").length)for(g=k.split("-"),k="",m=0;m<g.length-1;m++)k=""===k?g[m]:k+"-"+g[m];g=k;k=null;3<=d.name.split("][").length&&(k="hidden"!=d.type?jQuery(d).closest(".frm_form_field"):jQuery(d));d=k;void 0!==h.calc[g]&&ra(h,g,[],d)}d=a[e]}}function pa(a,c){var b=p(a,!0);return B("frm_field_"+b+"_container",c)}function N(a,c){if(!B(a.containerId,a.formId)){if(c){jQuery("#"+
    a.containerId).hide();var b=ha(a.containerId)}else b=ja(a);T(b);sa(a.containerId,a.formId)}}function T(a){if(!(1>a.length)){for(var c,b=!0,d=0,f=a.length;d<f;d++)0<d&&c.name!=a[d].name&&!0===b&&u(jQuery(c)),b=!0,"radio"==a[d].type||"checkbox"==a[d].type?a[d].checked=!1:"SELECT"==a[d].tagName?(0===a[d].selectedIndex?b=!1:a[d].selectedIndex=0,null!==document.getElementById(a[d].id+"_chosen")&&jQuery(a[d]).trigger("chosen:updated")):a[d].value="",c=a[d];!0===b&&u(jQuery(c))}}function B(a,c){var b=!1;
    -1<C(c).indexOf(a)&&(b=!0);return b}function sa(a,c){var b=C(c);if(!(-1<b.indexOf(a))){b.push(a);var b=JSON.stringify(b),d=document.getElementById("frm_hide_fields_"+c);null!==d&&(d.value=b)}}function C(a){var c=[];a=document.getElementById("frm_hide_fields_"+a);return null===a?c:c=(c=a.value)?JSON.parse(c):[]}function G(a,c){var b=C(c),d=b.indexOf(a);-1<d&&(b.splice(d,1),b=JSON.stringify(b),document.getElementById("frm_hide_fields_"+c).value=b)}function Z(a,c,b){if(!("undefined"===typeof __FRMLOOKUP||
    ...
    var f=a,e=c[b];f.parentVals=S(f);if("select"==f.inputType)Ia(f,e);else if("radio"==f.inputType||"checkbox"==f.inputType)if(!1===f.parentVals){var h=e.getElementsByTagName("input");ta(f,e);T(h)}else Ja(f,e)}}else if("value changed"===b)for(b="field_"+a.fieldKey,b=a.isRepeating?""!==c.repeatingSection?'[id="'+b+"-"+c.repeatRow+'"]':'[id^="'+b+'-"]':'[id="'+b+'"]',c=document.querySelectorAll(b),b=0,d=c.length;b<d;b++)f=a,e=E(c[b].name),f.repeatRow=""!==e.repeatRow?e.repeatRow:"",f=a,e=c[b],f.parentVals=
    S(f),qa(f,e)}function R(a){return"undefined"===typeof __FRMLOOKUP||"undefined"===typeof __FRMLOOKUP[a]?!1:__FRMLOOKUP[a]}function S(a){var c=[],b=a.parents,d;d=!1;for(var f=0,e=b.length;f<e;f++){d=R(b[f]);d=ka(d,a);if(""===d||!1===d){c=!1;break}c[f]=d}return c}function ma(a){for(var c=!1,b=a.length,d=0;d<b;d++)if("hidden"==a[d].type||a[d].checked){c=a[d].value;break}return c}function Ia(a,c){var b=c.getElementsByTagName("SELECT")[0];if(null!==b){var d=b.value;!1===a.parentVals?(b.options.length=1,
""!==d&&(b.value="",Q(b),u(jQuery(b),a.fieldKey))):jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_lookup_field_options",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(c){var d=a.fieldKey,h=b.value;c=JSON.parse(c);for(var g=b.options.length;0<g;g--)b.remove(g);for(var k=c.length,g=0;g<k;g++)b.options[g+1]=new Option(c[g],c[g],!1,!1);b.value=h;""===b.value&&(c=b.getAttribute("data-frmval"),null!==c&&(b.value=c));Q(b);
    b.value!=h&&u(jQuery(b),d)}})}}function Q(a){-1<a.className.indexOf("frm_chzn")&&jQuery().chosen&&jQuery(a).trigger("chosen:updated")}function Ja(a,c){var b=c.getElementsByClassName("frm_opt_container")[0],d=b.getElementsByTagName("input"),f="",f="radio"==a.inputType?ma(d):P(d);b.innerHTML='<span class="frm-loading-img"></span>';jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_cb_radio_lookup_options",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,row_index:a.repeatRow,
    current_value:f,nonce:frm_js.nonce},success:function(f){b.innerHTML=f;1==d.length&&""===d[0].value?ta(a,c):!1!==B(c.id,a.formId)&&(f=L(a.fieldId),!1===f||1>f.conditions.length?(G(c.id,a.formId),jQuery("#"+c.id).show()):(f.containerId=c.id,f.repeatRow=a.repeatRow,fa(f)));u(jQuery(d[0]),a.fieldKey)}})}function ta(a,c){B(c.id,a.formId)||(jQuery("#"+c.id).hide(),sa(c.id,a.formId))}function qa(a,c){if(!pa(c,a.formId))if(!1===a.parentVals){var b=c.getAttribute("data-frmval");null===b&&(b="");ua(a,c,b)}else jQuery.ajax({type:"POST",
    url:frm_js.ajax_url,data:{action:"frm_get_lookup_text_value",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(b){c.value!=b&&ua(a.fieldKey,c,b)}})}function ua(a,c,b){c.value=b;u(jQuery(c),a)}function Ga(a,c){if(c){var b=jQuery("#"+a.containerId),d=b.find(".frm_opt_container");d.html('<span class="frm-loading-img"></span>')}jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",entry_id:a.dataLogic.actualValue,current_field:a.fieldId,
    hide_id:a.containerId,nonce:frm_js.nonce},success:function(f){if(c){d.html(f);var e=d.children("input"),h=e.val();""===f||""===h?N(a,!0):va(a,b,e)}else e="field_"+a.fieldKey,""!==a.repeatRow&&(e+="-"+a.repeatRow),e=document.getElementById(e),e.value=f,B(a.containerId,a.formId)&&G(a.containerId,a.formId),u(jQuery(e))}})}function Ha(a,c){var b=jQuery("#"+a.containerId),d=b.find('select[name^="item_meta"], textarea[name^="item_meta"], input[name^="item_meta"]'),f=Ka(d),d=d.data("frmval");La(b);jQuery.ajax({type:"POST",
    url:frm_js.ajax_url,data:{action:"frm_fields_ajax_data_options",trigger_field_id:a.dataLogic.fieldId,entry_id:a.dataLogic.actualValue,field_id:a.fieldId,default_value:d,container_id:a.containerId,prev_val:f,nonce:frm_js.nonce},success:function(c){var d=b.find(".frm_opt_container");d.html(c);var f=d.find("select, input, textarea");d.next(".frm-loading-img").remove();d.show();""===c||1==f.length&&"hidden"==f.attr("type")?N(a,!0):va(a,b,f)}})}function La(a){var c=a.html();-1<c.indexOf("frm-loading-img")||
...
(h="/");e=e.split(h);d=d.split(h);var g,k;g=h=k="";for(var m=0;m<e.length;m++)if("y"==e[m])g=((new Date).getFullYear()+15).toString().substr(2,2),g=d[m]>g?"19"+d[m]:"20"+d[m];else if("yy"==e[m])g=d[m];else if("m"==e[m]||"mm"==e[m])h=d[m],2>h.length&&(h="0"+h);else if("d"==e[m]||"dd"==e[m])k=d[m],2>k.length&&(k="0"+k);h=Date.parse(g+"-"+h+"-"+k)}else h=jQuery.datepicker.parseDate(e,d);e=h;null!==e&&(b[a.valKey]=Math.ceil(e/864E5))}else{e=d;""!==e&&0!==e&&(e=e.trim(),e=parseFloat(e.replace(/,/g,"").match(/-?[\d\.]+$/)));
    ...
    d==b&&a.removeClass("frm_default").val("")}function Ta(){var a=jQuery(this),c=a.data("eid"),b=a.data("fid");a.append('<span class="spinner" style="display:inline"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_send_email",entry_id:c,form_id:b,nonce:frm_js.nonce},success:function(b){a.replaceWith(b)}});return!1}function Ua(a,c){google.load("visualization","1.0",{packages:[c],callback:function(){if("table"==c){var b=new google.visualization.DataTable,d=!1;-1!==jQuery.inArray("id",
        ...
        ""!==this.id&&(k=jQuery("#"+this.id),h.push(g),y(g,m),U(g,m,"value changed"),x(g,k),Z(g,k,"value changed"),J(g,k))}});Ea();V();"function"==typeof frmThemeOverride_frmAddRow&&frmThemeOverride_frmAddRow(a,b);I=!1},error:function(){I=!1}});return!1}function bb(){var a=jQuery(this),c=a.data("entryid"),b=a.data("prefix"),d=a.data("pageid"),f=a.data("formid"),e=a.data("cancel"),h=a.data("fields"),g=a.data("excludefields"),k=jQuery(document.getElementById(b+c)),m=k.html();k.html('<span class="frm-loading-img" id="'+
        b+c+'"></span><div class="frm_orig_content" style="display:none">'+m+"</div>");jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"html",data:{action:"frm_entries_edit_entry_ajax",post_id:d,entry_id:c,id:f,nonce:frm_js.nonce,fields:h,exclude_fields:g},success:function(b){k.children(".frm-loading-img").replaceWith(b);a.removeClass("frm_inplace_edit").addClass("frm_cancel_edit");a.html(e);X("editInPlace");Y()}});return!1}function cb(){var a=jQuery(this),c=a.data("entryid"),b=a.data("prefix"),d=a.data("edit");
        a.hasClass("frm_ajax_edited")||(c=jQuery(document.getElementById(b+c)),c.children(".frm_forms").replaceWith(""),c.children(".frm_orig_content").fadeIn("slow").removeClass("frm_orig_content"));a.removeClass("frm_cancel_edit").addClass("frm_inplace_edit");a.html(d);return!1}function db(){var a=jQuery(this),c=a.data("deleteconfirm");if(confirm(c)){var b=a.data("entryid"),d=a.data("prefix");a.replaceWith('<span class="frm-loading-img" id="frm_delete_'+b+'"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,
        data:{action:"frm_entries_destroy",entry:b,nonce:frm_js.nonce},success:function(a){"success"==a.replace(/^\s+|\s+$/g,"")?(jQuery(document.getElementById(d+b)).fadeOut("slow"),jQuery(document.getElementById("frm_delete_"+b)).fadeOut("slow")):jQuery(document.getElementById("frm_delete_"+b)).replaceWith(a)}})}return!1}function Y(){"undefined"!==typeof __frmHideFields&&frmFrontForm.hidePreviouslyHiddenFields();jQuery(document).on("focusin",".frm_date",r);if("undefined"!==typeof __frmUniqueTimes)for(var a=
    ...
    function E(a){var c={repeatingSection:"",repeatRow:""};"undefined"!==typeof a&&3<=a.split("][").length&&(a=a.split("]["),c.repeatingSection=a[0].replace("item_meta[",""),c.repeatRow=a[1]);return c}function Ya(a){a.fadeOut("slow",function(){a.remove()})}function eb(){var a=jQuery(this).data("frmconfirm");return confirm(a)}function fb(){var a=jQuery(this).data("frmtoggle");jQuery(a).is(":visible")?jQuery(a).slideUp("fast"):jQuery(a).slideDown("fast");return!1}function Ma(a,c){for(var b in a)if(a.hasOwnProperty(b)&&
        a[b]===c)return b;return null}function ya(a){return!jQuery.isArray(a)&&0<=a-parseFloat(a)+1}function gb(){Array.prototype.indexOf||(Array.prototype.indexOf=function(a,c){var b=this.length>>>0,d=Number(c)||0,d=0>d?Math.ceil(d):Math.floor(d);for(0>d&&(d+=b);d<b;d++)if(d in this&&this[d]===a)return d;return-1})}function hb(){"function"!==typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")})}function ib(){Array.prototype.filter||(Array.prototype.filter=
        function(a,c){if(void 0===this||null===this)throw new TypeError;var b=Object(this),d=b.length>>>0;if("function"!==typeof a)throw new TypeError;for(var f=[],e=0;e<d;e++)if(e in b){var h=b[e];a.call(c,h,e,b)&&f.push(h)}return f})}function jb(){Object.keys||(Object.keys=function(a){var c=[],b;for(b in a)a.hasOwnProperty(b)&&c.push(b);return c})}var I=!1,F="",v=[];return{init:function(){jQuery(document).off("submit.formidable",".frm-show-form");jQuery(document).on("submit.formidable",".frm-show-form",
        frmFrontForm.submitForm);jQuery(document).on("click",".frm_trigger",n);var a=jQuery(".frm_blank_field");a.length&&a.closest(".frm_toggle_container").prev(".frm_trigger").click();jQuery.isFunction(jQuery.fn.placeholder)?jQuery(".frm-show-form input, .frm-show-form textarea").placeholder():jQuery(".frm-show-form input[onblur], .frm-show-form textarea[onblur]").each(function(){""===jQuery(this).val()&&jQuery(this).blur()});jQuery(document).on("focus",".frm_toggle_default",Ra);jQuery(document).on("blur",
        ".frm_toggle_default",Sa);jQuery(".frm_toggle_default").blur();jQuery(document.getElementById("frm_resend_email")).click(Ta);jQuery(document).on("change",".frm_multiple_file",Wa);jQuery(document).on("click",".frm_clear_file_link",Za);jQuery(document).on("click",".frm_remove_link",Xa);jQuery(document).on("focusin","input[data-frmmask]",function(){jQuery(this).mask(jQuery(this).data("frmmask").toString())});jQuery(document).on("change",'.frm-show-form input[name^="item_meta"], .frm-show-form select[name^="item_meta"], .frm-show-form textarea[name^="item_meta"]',
    ...
    tinyMCE.triggerSave();F=jQuery(a).find('input[name="frm_action"]').val();v=[];var c=jQuery(a).hasClass("frm_js_validate");c&&(za(a)||Aa(a))&&(c=!1);c&&(frmFrontForm.getAjaxFormErrors(a),Object.keys(v).length&&frmFrontForm.addAjaxFormErrors(a));return v},getAjaxFormErrors:function(a){var c=[],b=jQuery(a).find(".frm_required_field:visible input, .frm_required_field:visible select, .frm_required_field:visible textarea").filter(":not(.frm_optional)");if(b.length)for(var d=0,f=b.length;d<f;d++)c=aa(b[d],
        ...
        500),!1}},savingDraft:function(a){return za(a)},goingToPreviousPage:function(a){return Aa(a)},hideOrShowFields:function(a,c){if("pageLoad"===c){var b=document.querySelectorAll('[id^="frm_hide_fields_"]');T(b)}for(var b={repeatingSection:"",repeatRow:""},d=0,f=a.length;d<f;d++)y(a[d],b)},hidePreviouslyHiddenFields:function(){var a;a=[];for(var c=document.querySelectorAll('*[id^="frm_hide_fields_"]'),b=c.length,d,f=0;f<b;f++)d=c[f].id.replace("frm_hide_fields_",""),a=a.concat(C(d));c=0;for(b=a.length;c<
    b;c++)d=document.getElementById(a[c]),null!==d&&(d.style.display="none")},checkDependentDynamicFields:function(a){for(var c={repeatingSection:"",repeatRow:""},b=0,d=a.length;b<d;b++)y(a[b],c)},checkDependentLookupFields:function(a){for(var c,b={repeatingSection:"",repeatRow:""},d=0,f=a.length;d<f;d++)c=a[d],U(c,b,"value changed")},loadGoogle:function(){if("undefined"!==typeof google&&google&&google.load)for(var a=__FRMTABLES,c=Object.keys(a),b=0;b<c.length;b++)for(var d=a[c[b]],f=c[b],e=0;e<d.length;e++)Ua(d[e],
