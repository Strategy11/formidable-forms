...
(a=T(this,a));1>a.length&&("email"==this.type?(c=jQuery(this).closest("form").find("input[type=email]"),a=U(this,a,c)):"number"==this.type?a=V(this,a):null!==this.pattern&&(a=W(this,a)));b.removeClass("frm_blank_field");b.find(".frm_error").remove();if(0<Object.keys(a).length)for(var d in a)L(b,d,a)}}function t(a,b){var c="",c=a instanceof jQuery?a.attr("name"):a.name;if(""===c)return c=a instanceof jQuery?a.data("name"):a.getAttribute("data-name"),""!==c?c:0;c=c.replace("item_meta[","").replace("[]",
