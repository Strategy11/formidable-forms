...
c,d,e){if("undefined"!==typeof __FRMRULES){var f=__FRMRULES[a];if("undefined"!==typeof f){if("undefined"===typeof c||null===c)c="go";"persist"!==e&&(m=[]);e=[];for(var g=0,k=f.length;g<k;g++){var l=f[g];if("undefined"!==typeof l)for(var r=0,h=l.Conditions.length;r<h;r++){var t=l.Conditions[r];t.HideField=l.Setting.FieldName;t.MatchType=l.MatchType;t.Show=l.Show;e.push(t)}}f=e.length;g=0;for(k=f;g<k;g++)e[g].FieldName===a?u(g,e[g],a,b,c,d):u(g,e[g],a,b,c),g===f-1&&D(c)}}}function u(b,a,c,d,e,f){"undefined"===
...
e=jQuery(d).find(".frm_data_field_container");if(0===e.length)return!0;c||e.html('<span class="frm-loading-img"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",entry_id:a,field_id:b.LinkedField,current_field:b.HideField,hide_id:b.hideContainerID,nonce:frm_js.nonce},success:function(f){""!==f&&(d.style.display="");if(c)e.append(f);else{e.html(f);var g=e.children("input"),k=g.val();if(""===f||""===k)d.style.display="none";p(a,b.HideField,null,g)}return!0}})}
function O(b,a,c,d){if(!("stop"==d&&-1<jQuery.inArray(b.HideField,F)&&b.parentField&&"hidden"==b.parentField.attr("type"))){var e=jQuery('input[name^="'+b.hiddenName+'"], select[name^="'+b.hiddenName+'"]:not(":disabled"), textarea[name^="'+b.hiddenName+'"]'),f=[];e.each(function(){"radio"==this.type||"checkbox"==this.type?!0===this.checked&&f.push(jQuery(this).val()):f.push(jQuery(this).val())});if("select"!=b.DataType||"stop"!=d&&!jQuery("#"+b.hideContainerID+" .frm-loading-img").length||!(-1<jQuery.inArray(b.HideField,
F))){0===f.length&&(f="");F.push(b.HideField);var g=document.getElementById(b.hideContainerID),k=jQuery(g).find(".frm_data_field_container");if(0===k.length&&e.length)return p(f,b.HideField,"stop",e),!1;if(""!==b.Value&&!y(b.Condition,b.Value,a))return g.style.display="none",k.html(""),p("",b.HideField,"stop",e),!1;k.html('<span class="frm-loading-img" style="visibility:visible;display:inline;"></span>');var l=b.DataType;jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_data_options",
...
"checked");else if("select"==l){var d=c.children('option[value="'+b+'"]');d.length?d.prop("selected",!0):f.splice(a,1)}else c.val(b)}));c.hasClass("frm_chzn")&&jQuery().chosen&&jQuery(".frm_chzn").chosen({allow_single_deselect:!0});c.length?p(f,b.HideField,"stop",c):p(f,b.HideField,"stop")}})}}}function C(b,a){if("undefined"!=typeof __FRMCALC){var c=__FRMCALC,d=c.fields[a];if("undefined"!=typeof d){d=d.total;if(b.frmTriggered&&b.frmTriggered==a)return!1;for(var e=[],f=0,g=0,k=d.length;g<k;g++){for(var l=
c.calc[d[g]],r=l.calc,f=l.fields.length,h=0;h<f;h++){var t=l.fields[h],m=c.fields[t],n="input"+c.fieldKeys[t];"checkbox"==m.type||"select"==m.type?n=n+":checked,select"+c.fieldKeys[t]+" option:selected,"+n+"[type=hidden]":"radio"==m.type||"scale"==m.type?n=n+":checked,"+n+"[type=hidden]":"textarea"==m.type&&(n=n+",textarea"+c.fieldKeys[t]);e[t]=P(n,t,m,c,e);if("undefined"===typeof e[t]||isNaN(e[t]))e[t]=0;m="["+t+"]";m=m.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1");r=r.replace(new RegExp(m,"g"),
e[t])}l=l.calc_dec;r.indexOf(").toFixed(")&&(h=r.split(").toFixed("),J(h[1])&&(l=h[1],r=r.replace(").toFixed("+l,"")));r=parseFloat(eval(r));J(l)&&(r=r.toFixed(l));"undefined"===typeof r&&(r=0);jQuery(document.getElementById("field_"+d[g])).val(r).trigger({type:"change",frmTriggered:d[g],selfTriggered:!0})}}}}function P(b,a,c,d,e){if("undefined"!==typeof e[a]&&0!==e[a])return e[a];jQuery(b).each(function(){"undefined"===typeof e[a]&&(e[a]=0);var b;b=!1;if("checkbox"==c.type||"radio"==c.type){b=!1;
var g=c.key.replace('[id^="',""),g=g.replace('"]',"");-1<this.id.replace(g,"").indexOf("other")&&(b=!0)}else"select"==c.type&&(b=!1,"hidden"==this.type?(g=document.getElementById(this.id+"-other"),null!=g&&""!=g.value&&(b=!0)):(g=this.className)&&-1<g.indexOf("frm_other_trigger")&&(b=!0));if(b){b=0;if("hidden"==this.type)if("select"==c.type){g=b="";if(b=-1<this.name.indexOf("[other]")?this.name:this.name.replace("item_meta","item_meta[other]"))g=document.getElementsByName(b)[0].value;b=g}else b=-1<
this.name.indexOf("[other]")?this.value:void 0;else b="select"==c.type?jQuery(this).closest(".frm_other_container").children(".frm_other_input").val():jQuery(this).closest(".frm_"+c.type).children(".frm_other_input").val();"undefined"===typeof b&&(b=0)}else b=jQuery(this).val();"date"==c.type&&(g=jQuery.datepicker.parseDate(d.date,b),null!==g&&(e[a]=Math.ceil(g/864E5)));""!==b&&0!==b&&(b=parseFloat(b.replace(/,/g,"").match(/-?[\d\.]+$/)));if("undefined"===typeof b||isNaN(b)||""==b)b=0;e[a]+=b});return e[a]}
function K(b,a){jQuery(b).find('input[type="submit"], input[type="button"]').attr("disabled","disabled");jQuery(b).find(".frm_ajax_loading").addClass("frm_loading_now");"undefined"==typeof a&&jQuery(b).find('input[name="frm_action"]').val();jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:jQuery(b).serialize()+"&action=frm_entries_"+a+"&nonce="+frm_js.nonce,success:function(a){a=a.replace(/^\s+|\s+$/g,"");0===a.indexOf("{")&&(a=jQuery.parseJSON(a));if(""===a||!a||"0"===a||"object"!=typeof a&&0===
a.indexOf("<!DOCTYPE")){var d=document.getElementById("frm_loading");null!==d&&(a=jQuery(b).find("input[type=file]").val(),"undefined"!=typeof a&&""!==a&&setTimeout(function(){jQuery(d).fadeIn("slow")},2E3));a=jQuery(b).find(".g-recaptcha");a.length&&(1>jQuery(b).find(".frm_next_page").length||1>jQuery(b).find(".frm_next_page").val())&&a.closest(".frm_form_field").replaceWith('<input type="hidden" name="recaptcha_checked" value="'+frm_js.nonce+'">');b.submit()}else if("object"!=typeof a){jQuery(b).find(".frm_ajax_loading").removeClass("frm_loading_now");
var e=jQuery(b).find('input[name="form_id"]').val();jQuery(b).closest("#frm_form_"+e+"_container").replaceWith(a);frmFrontForm.scrollMsg(e);if("function"==typeof frmThemeOverride_frmAfterSubmit){var e=jQuery('input[name="frm_page_order_'+e+'"]').val(),f=jQuery(a).find('input[name="form_id"]').val();frmThemeOverride_frmAfterSubmit(f,e,a,b)}a=jQuery(b).find('input[name="id"]');a.length&&jQuery(document.getElementById("frm_edit_"+a.val())).find("a").addClass("frm_ajax_edited").click()}else{jQuery(b).find('input[type="submit"], input[type="button"]').removeAttr("disabled");
jQuery(b).find(".frm_ajax_loading").removeClass("frm_loading_now");e=!0;jQuery(".form-field").removeClass("frm_blank_field");jQuery(".form-field .frm_error").replaceWith("");var f="",g=!1,k=null,l;for(l in a)if(k=jQuery(b).find(jQuery(document.getElementById("frm_field_"+l+"_container"))),k.length&&k.is(":visible"))e=!1,""===f&&(frmFrontForm.scrollMsg(l,b,!0),f="#frm_field_"+l+"_container"),jQuery(b).find("#frm_field_"+l+"_container .g-recaptcha").length&&(g=!0,grecaptcha.reset()),k.addClass("frm_blank_field"),
"function"==typeof frmThemeOverride_frmPlaceError?frmThemeOverride_frmPlaceError(l,a):k.append('<div class="frm_error">'+a[l]+"</div>");else if("redirect"==l){window.location=a[l];return}!0!==g&&jQuery(b).find(".g-recaptcha").closest(".frm_form_field").replaceWith('<input type="hidden" name="recaptcha_checked" value="'+frm_js.nonce+'">');e&&b.submit()}},error:function(){jQuery(b).find('input[type="submit"], input[type="button"]').removeAttr("disabled");b.submit()}})}function Q(){L(jQuery(this),"clear")}
function R(){L(jQuery(this),"replace")}function L(b,a){var c=b.data("frmval").replace(/(\n|\r\n)/g,"\r");if(""===c||"undefined"==typeof c)return!1;var d=b.val().replace(/(\n|\r\n)/g,"\r");"replace"==a?""===d&&b.addClass("frm_default").val(c):d==c&&b.removeClass("frm_default").val("")}function S(){var b=jQuery(this),a=b.data("eid"),c=b.data("fid");b.append('<span class="spinner" style="display:inline"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_send_email",entry_id:a,
form_id:c,nonce:frm_js.nonce},success:function(a){b.replaceWith(a)}});return!1}function M(b){var a="string";if("number"==b.type)a="number";else if("checkbox"==b.type||"select"==b.type){var c=b.options.length;"select"==b.type&&""===b.options[0]&&(c="post_status"==b.field_options.post_field?3:c-1);1==c&&(a="boolean")}return a}function T(){var b=jQuery(this),a=b.data("fid");b.wrap('<div class="frm_file_names frm_uploaded_files">');for(var c=b.get(0).files,d=0;d<c.length;d++)1==c.length?b.after(c[d].name+
' <a href="#" class="frm_clear_file_link">'+frm_js.remove+"</a>"):b.after(c[d].name+"<br/>");b.hide();c=b.attr("name");c!="item_meta["+a+"][]"&&c.replace("item_meta[","").replace("[]","").split("][");b.closest(".frm_form_field").find(".frm_uploaded_files:last").after('<input name="'+c+'" data-fid="'+a+'"class="frm_transparent frm_multiple_file" multiple="multiple" type="file" />')}function U(){V(jQuery(this).parent(".frm_uploaded_files"))}function W(){jQuery(this).parent(".frm_file_names").replaceWith("");
return!1}function X(){var b="frm_section_"+jQuery(this).data("parent")+"-"+jQuery(this).data("key"),a=jQuery(document.getElementById(b)),c=a.find("input, select, textarea");a.fadeOut("slow",function(){a.remove();c.each(function(){if("file"!=this.type){var a=this.name.replace("item_meta[","").split("]")[2].replace("[","");C("",a)}})});return!1}function Y(){var b=jQuery(this).data("parent"),a=0;0<jQuery(".frm_repeat_"+b).length&&(a=1+parseInt(jQuery(".frm_repeat_"+b+":last").attr("id").replace("frm_section_"+
b+"-","")),"undefined"==typeof a&&(a=1));jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"json",data:{action:"frm_add_form_row",field_id:b,i:a,nonce:frm_js.nonce},success:function(a){var d=a.html,e=jQuery(d).hide().fadeIn("slow");jQuery(".frm_repeat_"+b+":last").after(e);var f=["other"],g,k="reset";jQuery(d).find("input, select, textarea").each(function(){"file"!=this.type&&(g=this.name.replace("item_meta[","").split("]")[2].replace("[",""),-1==jQuery.inArray(g,f)&&(f.push(g),p("und",g,null,
jQuery(this),k),C("",g),k="persist"))});for(var e=0,l=a.logic.check.length;e<l;e++)-1==jQuery.inArray(a.logic.check[e],f)&&1>jQuery(d).find(".frm_field_"+a.logic.check[e]+"_container").length&&(p("und",a.logic.check[e],null,null,k),k="persist");0<jQuery(d).find(".star").length&&jQuery(".star").rating();0<jQuery(d).find(".frm_chzn").length&&jQuery().chosen&&jQuery(".frm_chzn").chosen({allow_single_deselect:!0});"function"==typeof frmThemeOverride_frmAddRow&&frmThemeOverride_frmAddRow(b,a)}});return!1}
function V(b){b.fadeOut("slow",function(){b.remove()})}function Z(){var b=jQuery(this).data("frmtoggle");jQuery(b).is(":visible")?jQuery(b).slideUp("fast"):jQuery(b).slideDown("fast");return!1}function J(b){return!jQuery.isArray(b)&&0<=b-parseFloat(b)+1}function N(b,a){var c=[];if("undefined"==typeof document.querySelector)jQuery("#"+b+' input[type=checkbox]:checked, input[type=hidden][name^="'+a+'"]').each(function(){c.push(this.value)});else for(var d=document.querySelectorAll("#"+b+' input[type=checkbox], input[type=hidden][name^="'+
a+'"]'),e=0;e<d.length;e++)("checkbox"==d[e].type&&d[e].checked||"hidden"==d[e].type)&&c.push(d[e].value);return c}var m=[],E=[],F=[],G="",B=[];return{init:function(){jQuery(document).on("click",".frm_trigger",n);var b=jQuery(".frm_blank_field");b.length&&b.closest(".frm_toggle_container").prev(".frm_trigger").click();jQuery.isFunction(jQuery.fn.placeholder)?jQuery(".frm-show-form input, .frm-show-form textarea").placeholder():jQuery(".frm-show-form input[onblur], .frm-show-form textarea[onblur]").each(function(){""===
jQuery(this).val()&&jQuery(this).blur()});jQuery(document).on("focus",".frm_toggle_default",Q);jQuery(document).on("blur",".frm_toggle_default",R);jQuery(".frm_toggle_default").blur();jQuery(document.getElementById("frm_resend_email")).click(S);jQuery(document).on("change",".frm_multiple_file",T);jQuery(document).on("click",".frm_clear_file_link",W);jQuery(document).on("click",".frm_remove_link",U);jQuery(document).on("focusin","input[data-frmmask]",function(){jQuery(this).mask(jQuery(this).data("frmmask").toString())});
jQuery(document).on("change",'.frm-show-form input[name^="item_meta"], .frm-show-form select[name^="item_meta"], .frm-show-form textarea[name^="item_meta"]',z);jQuery(document).on("click",'.frm-show-form input[type="submit"], .frm-show-form input[name="frm_prev_page"], .frm-show-form .frm_save_draft',h);jQuery(document).on("change",'.frm_other_container input[type="checkbox"], .frm_other_container input[type="radio"], .frm_other_container select',x);jQuery(document).on("change","input[type=file].frm_transparent",
...
jQuery(this).next(".frm_toggle_container").hide())})},submitForm:function(b){b.preventDefault();jQuery(this).find(".wp-editor-wrap").length&&"undefined"!=typeof tinyMCE&&tinyMCE.triggerSave();G=jQuery(this).find('input[name="frm_action"]').val();B=[];"function"==typeof frmThemeOverride_jsErrors&&(B=frmThemeOverride_jsErrors(G,this));if(0===B.length)K(this,G);else for(var a in B)$fieldCont=jQuery(this).find(jQuery(document.getElementById("frm_field_"+a+"_container"))),$fieldCont.length&&$fieldCont.is(":visible")&&
...
"_container");null!==d?d.style.display="none":jQuery(".frm_field_"+b[a]+"_container").hide()}},checkDependent:function(b){b=JSON.parse(b);for(var a="reset",c=0,d=b.length;c<d;c++)p("und",b[c],null,null,a),a="persist"},generateGoogleTable:function(b,a){var c=__FRMTABLES;if("undefined"!=typeof c)if("table"==a){var c=c.table[b],d=new google.visualization.DataTable,e=!1;jQuery.inArray("id",c.options.fields)&&(e=!0,d.addColumn("number",frm_js.id));for(var f=c.fields.length,g="string",k=0,l=f;k<l;k++){var h=
c.fields[k],g=M(h);d.addColumn(g,h.name)}k=!1;c.options.edit_link&&(k=!0,d.addColumn("string",c.options.edit_link));l=!1;c.options.delete_link&&(l=!0,d.addColumn("string",c.options.delete_link));h=0;if(null!==c.entries){var m=c.entries.length;d.addRows(m);for(var n=0,p=0;p<m;p++){var h=0,q=c.entries[p];e&&(d.setCell(n,h,q.id),h++);for(var u=0,v=f;u<v;u++){var w=c.fields[u],g=M(w),w=q.metas[w.id];"number"!=g||null!==w&&""!==w?"boolean"==g&&(w=null===w||"false"==w||!1===w?"false":"true"):w=0;d.setCell(n,
h,w);h++}k&&("undefined"!==typeof q.editLink?d.setCell(n,h,'<a href="'+q.editLink+'">'+c.options.edit_link+"</a>"):d.setCell(n,h,""),h++);l&&("undefined"!==typeof q.deleteLink?d.setCell(n,h,'<a href="'+q.deleteLink+'" class="frm_delete_link" onclick="return confirm('+c.options.confirm+')">'+c.options.delete_link+"</a>"):d.setCell(n,h,""));n++}}else for(d.addRows(1),k=h=0,l=f;k<l;k++)0<h?d.setCell(0,h,""):d.setCell(0,h,c.options.no_entries),h++;(new google.visualization.Table(document.getElementById("frm_google_table_"+
c.options.form_id))).draw(d,c.graphOpts)}else{c=c[a][b];d=new google.visualization.DataTable;e=!1;f=c.rows.length;if(0<f)if("table"==c.type)for(e=!0,d.addRows(c.rows[f-1][0]+1),g=0;g<f;g++)d.setCell(c.rows[g]);else if("undefined"!=typeof c.rows[0].tooltip){e=!0;d.addColumn({type:"string",role:"tooltip"});for(g=0;g<f;g++)h=c.rows[g].tooltip,c.rows[g].tooltip=null,c.rows[g].push(h);d.addRows(c.rows)}f=c.cols.length;if(e){if(0<f)for(e=0;e<f;e++)g=c.cols[e],d.addColumn(g.type,g.name)}else{d=[[]];for(e=
0;e<f;e++)d[0].push(c.cols[e].name);d=d.concat(c.rows);d=google.visualization.arrayToDataTable(d)}e=c.type.charAt(0).toUpperCase()+c.type.slice(1)+"Chart";(new google.visualization[e](document.getElementById("chart_"+c.graph_id))).draw(d,c.options)}},removeUsedTimes:function(b,a){var c=jQuery(b).parents("form:first").find('input[name="id"]');jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"json",data:{action:"frm_fields_ajax_time_options",time_field:a,date_field:b.id,entry_id:c?c.val():"",date:jQuery(b).val(),
nonce:frm_js.nonce},success:function(b){var c=jQuery(document.getElementById(a));c.find("option").removeAttr("disabled");if(b&&""!==b)for(var f in b)c.find('option[value="'+f+'"]').attr("disabled","disabled")}})},escapeHtml:function(b){return b.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")},invisible:function(b){jQuery(b).css("visibility","hidden")},visible:function(b){jQuery(b).css("visibility","visible")}}}var frmFrontForm=frmFrontFormJS();
jQuery(document).ready(function(h){frmFrontForm.init()});
function frmEditEntry(h,n,q,x,z,p){var u=jQuery(document.getElementById("frm_edit_"+h)),v=u.html(),A=jQuery(document.getElementById(n+h)),D=A.html();A.html('<span class="frm-loading-img" id="'+n+h+'"></span><div class="frm_orig_content" style="display:none">'+D+"</div>");jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"html",data:{action:"frm_entries_edit_entry_ajax",post_id:q,entry_id:h,id:x,nonce:frm_js.nonce},success:function(y){A.children(".frm-loading-img").replaceWith(y);u.replaceWith('<span id="frm_edit_'+
h+'"><a onclick="frmCancelEdit('+h+",'"+n+"','"+frmFrontForm.escapeHtml(v)+"',"+q+","+x+",'"+p+'\')" class="'+p+'">'+z+"</a></span>")}})}
function frmCancelEdit(h,n,q,x,z,p){var u=jQuery(document.getElementById("frm_edit_"+h)),v=u.find("a"),A=v.html();v.hasClass("frm_ajax_edited")||(v=jQuery(document.getElementById(n+h)),v.children(".frm_forms").replaceWith(""),v.children(".frm_orig_content").fadeIn("slow").removeClass("frm_orig_content"));u.replaceWith('<a id="frm_edit_'+h+'" class="frm_edit_link '+p+'" href="javascript:frmEditEntry('+h+",'"+n+"',"+x+","+z+",'"+frmFrontForm.escapeHtml(A)+"','"+p+"')\">"+q+"</a>")}
function frmUpdateField(h,n,q,x,z){jQuery(document.getElementById("frm_update_field_"+h+"_"+n)).html('<span class="frm-loading-img"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_update_field_ajax",entry_id:h,field_id:n,value:q,nonce:frm_js.nonce},success:function(){""===x.replace(/^\s+|\s+$/g,"")?jQuery(document.getElementById("frm_update_field_"+h+"_"+n+"_"+z)).fadeOut("slow"):jQuery(document.getElementById("frm_update_field_"+h+"_"+n+"_"+z)).replaceWith(x)}})}
function frmDeleteEntry(h,n){jQuery(document.getElementById("frm_delete_"+h)).replaceWith('<span class="frm-loading-img" id="frm_delete_'+h+'"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_destroy",entry:h,nonce:frm_js.nonce},success:function(q){"success"==q.replace(/^\s+|\s+$/g,"")?jQuery(document.getElementById(n+h)).fadeOut("slow"):jQuery(document.getElementById("frm_delete_"+h)).replaceWith(q)}})}
