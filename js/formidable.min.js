...
jQuery(this).closest(".frm_checkbox").children(".frm_other_input").addClass("frm_pos_none").val(""))}function A(b){var a;a=this.name.replace("item_meta[","").split("]");var c=a[0];"other"==c&&(c=a[1].replace("[",""));jQuery('input[name="item_meta['+c+'][form]"]').length&&(c=a[2].replace("[",""));if(a=c)q("und",a,null,jQuery(this)),C(b,a)}function q(b,a,c,e,f){if("undefined"!=typeof __FRMRULES){var g=__FRMRULES[a];if("undefined"!=typeof g){if("undefined"==typeof c||null===c)c="go";"persist"!=f&&(l=
[]);f=[];for(var k=0,p=g.length;k<p;k++){var r=g[k];if("undefined"!=typeof r)for(var m=0,L=r.Conditions.length;m<L;m++){var h=r.Conditions[m];h.HideField=r.Setting.FieldName;h.MatchType=r.MatchType;h.Show=r.Show;f.push(h)}}g=f.length;k=0;for(p=g;k<p;k++)f[k].FieldName==a?v(k,f[k],a,b,c,e):v(k,f[k],a,b,c),k==g-1&&D(c)}}}function v(b,a,c,e,f,g){"undefined"==typeof l[a.HideField]&&(l[a.HideField]=[]);a.inputName="item_meta["+a.FieldName+"]";a.hiddenName="item_meta["+a.HideField+"]";a.containerID="frm_field_"+
a.FieldName+"_container";a.hideContainerID="frm_field_"+a.HideField+"_container";a.hideBy="#";var k=!1;if("undefined"!==typeof g&&null!==g){1<g.length&&(g=g.eq(0));if("undefined"===typeof g.attr("name"))return;a.inputName=g.attr("name").replace("[other]","").replace("[]","");var p=g.closest(".frm_repeat_sec");p.length&&(p=p.find(".frm_field_"+a.FieldName+"_container"),a.containerID=p.attr("id"),a.hideContainerID=a.containerID.replace(a.FieldName,a.HideField),a.hiddenName=a.inputName.replace("["+a.FieldName+
"]","["+a.HideField+"]"))}else{k=!0;g=jQuery('input[name^="'+a.inputName+'"], textarea[name^="'+a.inputName+'"], select[name^="'+a.inputName+'"]');if(1>g.length&&(g=jQuery("."+a.containerID+" input, ."+a.containerID+" textarea, ."+a.containerID+" select"),g.length)){v(b,a,c,e,f,g);return}1<g.length&&(g=g.eq(0))}null===document.getElementById(a.hideContainerID)&&(a.hideBy=".");if(a.FieldName!=c||"undefined"==typeof e||"und"==e)if(("radio"==a.Type||"data-radio"==a.Type)&&"radio"==g.attr("type"))e=jQuery('input[name="'+
a.inputName+'"]:checked').val(),"undefined"==typeof e&&(e="");else if("select"==a.Type||"time"==a.Type||"data-select"==a.Type||"checkbox"!=a.Type&&"data-checkbox"!=a.Type)e=g.val();"undefined"==typeof e&&(e=g.val());if("undefined"==typeof e){if(!0===k&&(c=jQuery("."+a.containerID+" input, ."+a.containerID+" select, ."+a.containerID+" textarea"),c.length)){c.each(function(){v(b,a,a.FieldName,e,f,jQuery(this))});return}e=""}c=[];if("checkbox"==a.Type||"data-checkbox"==a.Type)c=M(a.containerID,a.inputName),
e=c.length?c:"";l[a.HideField][b]=""===e?!1:{funcName:"getDataOpts",f:a,sel:e};if("checkbox"==a.Type||"data-checkbox"==a.Type&&"undefined"==typeof a.LinkedField)if(c=l[a.HideField][b]=!1,""!==e)for("!="==a.Condition&&(l[a.HideField][b]=!0),g=0;g<e.length;g++)c=z(a.Condition,a.Value,e[g]),"!="==a.Condition?!0===l[a.HideField][b]&&!1===c&&(l[a.HideField][b]=!1):!1===l[a.HideField][b]&&c&&(l[a.HideField][b]=!0);else c=z(a.Condition,a.Value,""),!1===l[a.HideField][b]&&c&&(l[a.HideField][b]=!0);else if("undefined"!=
typeof a.LinkedField&&0===a.Type.indexOf("data-")){if("undefined"==typeof a.DataType||"data"===a.DataType)""===e?w(a.hideContainerID,a.hideBy):"data-radio"==a.Type?l[a.HideField][b]="undefined"==typeof a.DataType?z(a.Condition,a.Value,e):{funcName:"getData",f:a,sel:e}:"data-checkbox"==a.Type||"data-select"==a.Type&&jQuery.isArray(e)?(w(a.hideContainerID,a.hideBy),l[a.HideField][b]=!0,G(a,e,1)):"data-select"==a.Type&&(l[a.HideField][b]={funcName:"getData",f:a,sel:e})}else"undefined"==typeof a.Value&&
...
else{var e="none";if("show"==a.Show){if(!0!==l[a.HideField][b]){H(l[a.HideField][b],a.FieldName,c);return}e=""}"."===a.hideBy?(b=jQuery("."+a.hideContainerID),b.length&&("none"===e?b.hide():b.show())):(b=document.getElementById(a.hideContainerID),null!==b&&(b.style.display=e))}}function D(b){jQuery.each(E,function(a,c){if("undefined"!=typeof c&&"undefined"!=typeof c.result){var e=jQuery(c.hideBy+c.hideContainerID),f=c.show;if(e.length){if("any"==c.match&&-1==jQuery.inArray(!0,l[c.fkey])||"all"==c.match&&
-1<jQuery.inArray(!1,l[c.fkey]))f="show"==c.show?"hide":"show";"show"==f?e.show():(e.filter(":hidden").hide(),e.hide());!1!==typeof c.result&&!0!==typeof c.result&&H(c.result,c.fname,b)}delete E[a]}})}function z(b,a,c){"undefined"==typeof c&&(c="");jQuery.isArray(c)&&-1<jQuery.inArray(a,c)&&(c=a);-1!=String(a).search(/^\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*$/)&&(a=parseFloat(a),c=parseFloat(c));return"-1"!=String(a).indexOf("&quot;")&&z(b,a.replace("&quot;",'"'),c)?!0:{"==":function(a,b){return a==
b},"!=":function(a,b){return a!=b},"<":function(a,b){return a>b},">":function(a,b){return a<b},LIKE:function(a,b){return b?-1!=b.indexOf(a):0},"not LIKE":function(a,b){return b?-1==b.indexOf(a):1}}[b](a,c)}function H(b,a,c){"getDataOpts"==b.funcName?N(b.f,b.sel,a,c):"getData"==b.funcName&&G(b.f,b.sel,0)}function G(b,a,c){var e=document.getElementById(b.hideContainerID),f=jQuery(e).find(".frm_data_field_container");if(0===f.length)return!0;c||f.html('<span class="frm-loading-img"></span>');jQuery.ajax({type:"POST",
...
"function"==typeof frmThemeOverride_frmAddRow&&frmThemeOverride_frmAddRow(b,a)}});return!1}function V(b){b.fadeOut("slow",function(){b.remove()})}function I(b){return!jQuery.isArray(b)&&0<=b-parseFloat(b)+1}function M(b,a){var c=[];if("undefined"==typeof document.querySelector)jQuery("#"+b+' input[type=checkbox]:checked, input[type=hidden][name^="'+a+'"]').each(function(){c.push(this.value)});else for(var e=document.querySelectorAll("#"+b+' input[type=checkbox], input[type=hidden][name^="'+a+'"]'),
f=0;f<e.length;f++)("checkbox"==e[f].type&&e[f].checked||"hidden"==e[f].type)&&c.push(e[f].value);return c}var l=[],E=[],F=[];return{init:function(){jQuery(document).on("click",".frm_trigger",n);var b=jQuery(".frm_blank_field");b.length&&b.closest(".frm_toggle_container").prev(".frm_trigger").click();jQuery.isFunction(jQuery.fn.placeholder)?jQuery(".frm-show-form input, .frm-show-form textarea").placeholder():jQuery(".frm-show-form input[onblur], .frm-show-form textarea[onblur]").each(function(){""===
...
c=0,e=b.length;c<e;c++)q("und",b[c],null,null,a),a="persist"},generateGoogleTable:function(b,a){var c=__FRMTABLES;if("undefined"!=typeof c)if("table"==a){var c=c.table[b],e=new google.visualization.DataTable,f=!1;jQuery.inArray("id",c.options.fields)&&(f=!0,e.addColumn("number",frm_js.id));for(var g=c.fields.length,k="string",h=0,l=g;h<l;h++){var m=c.fields[h],k=K(m);e.addColumn(k,m.name)}h=!1;c.options.edit_link&&(h=!0,e.addColumn("string",c.options.edit_link));l=!1;c.options.delete_link&&(l=!0,
e.addColumn("string",c.options.delete_link));m=0;if(null!==c.entries){var n=c.entries.length;e.addRows(n);for(var q=0,u=0;u<n;u++){var m=0,t=c.entries[u];f&&(e.setCell(q,m,t.id),m++);for(var v=0,w=g;v<w;v++){var x=c.fields[v],k=K(x),x=t.metas[x.id];"number"!=k||null!==x&&""!==x?"boolean"==k&&(x=null===x||"false"==x||!1===x?"false":"true"):x=0;e.setCell(q,m,x);m++}h&&("undefined"!==typeof t.editLink?e.setCell(q,m,'<a href="'+t.editLink+'">'+c.options.edit_link+"</a>"):e.setCell(q,m,""),m++);l&&("undefined"!==
typeof t.deleteLink?e.setCell(q,m,'<a href="'+t.deleteLink+'" class="frm_delete_link" onclick="return confirm('+c.options.confirm+')">'+c.options.delete_link+"</a>"):e.setCell(q,m,""));q++}}else for(e.addRows(1),h=m=0,l=g;h<l;h++)0<m?e.setCell(0,m,""):e.setCell(0,m,c.options.no_entries),m++;(new google.visualization.Table(document.getElementById("frm_google_table_"+c.options.form_id))).draw(e,c.graphOpts)}else{c=c[a][b];e=new google.visualization.DataTable;f=!1;g=c.rows.length;if(0<g)if("table"==
