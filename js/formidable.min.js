...
0<d&&("time"==a.thisField.type?1==d?e=":":2==d&&(e=" "):e=", ");""!==c&&(b[a.valKey]+=e+c,d++)});return b}function Sa(a){if(!1===a.inSection)var b=jQuery(a.thisFieldCall);else if(b=Qa(a),null===b||"undefined"===typeof b||1>b.length)b=jQuery(a.thisFieldCall);if(null===b||"undefined"===typeof b||1>b.length)b=!1;return b}function Qa(a){if("undefined"===typeof a.triggerField)return null;var b=a.triggerField.closest(".frm_repeat_sec, .frm_repeat_inline, .frm_repeat_grid");if(b.length){var c=a.thisFieldCall.replace("[id=",
"[id^=");b=b.find(c)}else b=jQuery(a.thisFieldCall);return ub(b,a)}function ub(a,b){if(a.length){var c=b.thisFieldCall.split("[id")[1].replace(/"|'|\^|=|]|:checked|,input| option:selected|,textarea/g,"");if(!c.match(RegExp("^field_[a-zA-Z0-9]*(-)?$","g")))return a;var d=new RegExp("^"+c+"((e)?\\d+(-\\d+)?)?$","g");a=a.filter(function(){var a=this.id;a||(a=this.parentElement.id);return a?a.match(d):!0})}return a}function Ta(a,b){var c=!1;if("hidden"==b.type)""!==ha(b)&&(c=!0);else if("select"==a.type){var d=
...
"");return c}function ha(a){var b="";a=document.getElementById(a.id+"-otext");null!==a&&""!==a.value&&(b=a.value);return b}function Ua(a){var b=!1;a=jQuery(a).find(".frm_saving_draft");a.length&&(b=a.val());return b}function ia(a){var b=!1,c=jQuery(a).find(".frm_next_page");if(c.length&&c.val()){var d=jQuery(a).find('input[name="form_id"]').val();a=jQuery(a).find('input[name="frm_page_order_'+d+'"]');a=a.length?a.val():0;if(!a||c.val()<a)b=!0}return b}function P(a,b){var c=a.getAttribute("data-frmfile");
...
e[f]&&(d=e[f])}e=-1===c.indexOf("frm_other_input")?q(a,!0):q(a,!1);-1!==c.indexOf("frm_time_select")&&(e=e.replace("-H","").replace("-m",""))}""===d&&(""===e&&(e=q(a,!0)),e in b||(b[e]=E(a,"data-reqmsg")));return b}function vb(a){var b="";jQuery('input[name="file'+a+'"], input[name="file'+a+'[]"], input[name^="item_meta['+a+']"]').each(function(){""===b&&(b=this.value)});return b}function pa(a,b,c){var d=a.value,e=q(a,!0);if(e in b)return b;var f=0===e.indexOf("conf_");if(""!==d||f){var g=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/i,
h=E(a,"data-invmsg");""!==d&&!1===g.test(d)?(b[e]=h,f&&(b[e.replace("conf_","")]="")):f&&(a=a.name.replace("conf_",""),c.filter('[name="'+a+'"]').val()!==d&&(b[e]="",b[e.replace("conf_","")]=""))}return b}function qa(a,b){var c=a.value;""!==c&&!1!==isNaN(c/1)&&(c=q(a,!0),c in b||(b[c]=E(a,"data-invmsg")));return b}function ra(a,b){var c=a.value,d=E(a,"pattern");if(""!==d&&""!==c){var e=q(a,!0);e in b||(d=new RegExp("^"+d+"$","i"),!1===d.test(c)&&(b[e]=E(a,"data-invmsg")))}return b}function E(a,b){var c=
a.getAttribute(b);null===c&&(c="");return c}function wb(a,b){"undefined"==typeof b&&jQuery(a).find('input[name="frm_action"]').val();var c=jQuery(a).find(".frm_form_field");c.addClass("frm_doing_ajax");jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:jQuery(a).serialize()+"&action=frm_entries_"+b+"&nonce="+frm_js.nonce,success:function(b){var d={content:"",errors:{},pass:!1};null===b&&(b=d);b=b.replace(/^\s+|\s+$/g,"");b=0===b.indexOf("{")?jQuery.parseJSON(b):d;if("undefined"!=typeof b.redirect)jQuery(document).trigger("frmBeforeFormRedirect",
...
(a.addClass("frm_loading_form"),a.trigger("frmStartFormLoading"));a.find('input[type="submit"], input[type="button"], button[type="submit"]').attr("disabled","disabled")}function G(a,b){0<w||(a.removeClass("frm_loading_form"),a.trigger("frmEndFormLoading"),"enable"==b&&a.find('input[type="submit"], input[type="button"], button[type="submit"]').removeAttr("disabled"))}function xb(a){var b=document.getElementById("frm_loading");null!==b&&(a=jQuery(a).find("input[type=file]").val(),"undefined"!=typeof a&&
""!==a&&setTimeout(function(){jQuery(b).fadeIn("slow")},2E3))}function Ya(a,b){var c=jQuery(a).find(".frm-g-recaptcha, .g-recaptcha");c.length&&(!b||1>jQuery(a).find(".frm_next_page").length||1>jQuery(a).find(".frm_next_page").val())&&c.closest(".frm_form_field").replaceWith('<input type="hidden" name="recaptcha_checked" value="'+frm_js.nonce+'">')}function yb(){Za(jQuery(this),"clear")}function zb(){Za(jQuery(this),"replace")}function Za(a,b){var c=a.data("frmval").replace(/(\n|\r\n)/g,"\r");if(""===
c||"undefined"==typeof c)return!1;var d=a.val().replace(/(\n|\r\n)/g,"\r");"replace"==b?""===d&&a.addClass("frm_default").val(c):d==c&&a.removeClass("frm_default").val("")}function Ab(){var a=jQuery(this),b=a.data("eid"),c=a.data("fid");a.append('<span class="spinner" style="display:inline"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_send_email",entry_id:b,form_id:c,nonce:frm_js.nonce},success:function(b){a.replaceWith(b)}});return!1}function Bb(a,b){google.load("visualization",
...
(b="dependent");1<a.length&&(a=a.eq(0));a.trigger({type:"change",selfTriggered:!0,frmTriggered:b})}function H(a){var b={repeatingSection:"",repeatRow:""};"undefined"!==typeof a&&F(a)&&(a=a.split("]["),b.repeatingSection=a[0].replace("item_meta[",""),b.repeatRow=a[1]);return b}function db(a){a.fadeOut("slow",function(){a.remove()})}function Jb(){var a=jQuery(this).data("frmconfirm");return confirm(a)}function Kb(){var a=jQuery(this).data("frmtoggle");jQuery(a).is(":visible")?jQuery(a).slideUp("fast"):
jQuery(a).slideDown("fast");return!1}function pb(a,b){for(var c in a)if(a.hasOwnProperty(c)&&a[c]===b)return c;return null}function Ra(a){return!jQuery.isArray(a)&&0<=a-parseFloat(a)+1}function Lb(){Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){var c=this.length>>>0,d=Number(b)||0;d=0>d?Math.ceil(d):Math.floor(d);for(0>d&&(d+=c);d<c;d++)if(d in this&&this[d]===a)return d;return-1})}function Mb(){"function"!==typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,
"")})}function Nb(){Array.prototype.filter||(Array.prototype.filter=function(a,b){if(void 0===this||null===this)throw new TypeError;var c=Object(this),d=c.length>>>0;if("function"!==typeof a)throw new TypeError;for(var e=[],f=0;f<d;f++)if(f in c){var g=c[f];a.call(b,g,f,c)&&e.push(g)}return e})}function Ob(){Object.keys||(Object.keys=function(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&b.push(c);return b})}var O=!1,B="",v=[],w=0,n={};return{init:function(){jQuery(document).off("submit.formidable",
...
eb);jQuery(document).on("click",".frm_remove_form_row",Db);jQuery(document).on("click",".frm_add_form_row",Eb);jQuery(document).on("click","a[data-frmconfirm]",Jb);jQuery("a[data-frmtoggle]").click(Kb);jQuery(".frm_edit_link_container").on("click","a.frm_inplace_edit",Fb);jQuery(".frm_edit_link_container").on("click","a.frm_cancel_edit",Gb);jQuery(document).on("click",".frm_ajax_delete",Hb);jQuery(".frm_month_heading, .frm_year_heading").click(function(){var a=jQuery(this).children(".ui-icon-triangle-1-e, .ui-icon-triangle-1-s");
a.hasClass("ui-icon-triangle-1-e")?(a.addClass("ui-icon-triangle-1-s").removeClass("ui-icon-triangle-1-e"),jQuery(this).next(".frm_toggle_container").fadeIn("slow")):(a.addClass("ui-icon-triangle-1-e").removeClass("ui-icon-triangle-1-s"),jQuery(this).next(".frm_toggle_container").hide())});ja("pageLoad");ka();Lb();Mb();Nb();Ob()},renderRecaptcha:function(a){var b=a.getAttribute("data-size"),c={sitekey:a.getAttribute("data-sitekey"),size:b,theme:a.getAttribute("data-theme")};if("invisible"==b){var d=
...
d))))},submitFormNow:function(a){-1<a.className.trim().split(/\s+/gi).indexOf("frm_ajax_submit")?1>jQuery(a).find('input[type="file"]').filter(function(){return!!this.value}).length?(B=jQuery(a).find('input[name="frm_action"]').val(),frmFrontForm.checkFormErrors(a,B)):a.submit():a.submit()},validateFormSubmit:function(a){"undefined"!=typeof tinyMCE&&jQuery(a).find(".wp-editor-wrap").length&&tinyMCE.triggerSave();v=[];var b=jQuery(a).hasClass("frm_js_validate");b&&(Ua(a)||ia(a))&&(b=!1);b&&(frmFrontForm.getAjaxFormErrors(a),
...
("number"==g.type?b=qa(g,b):"email"==g.type?b=pa(g,b,c):null!==g.pattern&&(b=ra(g,b)))}}c=jQuery(a).find(".frm-g-recaptcha");c.length&&(d=c.data("rid"),0===grecaptcha.getResponse(d).length&&(c=c.closest(".frm_form_field").attr("id").replace("frm_field_","").replace("_container",""),b[c]=""));v=b;if("function"==typeof frmThemeOverride_jsErrors&&(B=jQuery(a).find('input[name="frm_action"]').val(),a=frmThemeOverride_jsErrors(B,a),Object.keys(a).length))for(var h in a)v[h]=a[h];return v},addAjaxFormErrors:function(a){Wa();
for(var b in v){var c=jQuery(a).find("#frm_field_"+b+"_container");c.length?S(c,b,v):delete v[b]}Xa(a)},checkFormErrors:function(a,b){wb(a,b)},scrollToID:function(a){a=jQuery(document.getElementById(a));frmFrontForm.scrollMsg(a,!1)},scrollMsg:function(a,b,c){if("undefined"==typeof b){if(a=jQuery(document.getElementById("frm_form_"+a+"_container")),1>a.length)return}else a="string"==typeof a?jQuery(b).find("#frm_field_"+a+"_container"):a;if(a=a.offset().top){a-=frm_js.offset;b=jQuery("html").css("margin-top");
