...
window.frmFrontForm=frmFrontFormJS();jQuery(document).ready(function(){frmFrontForm.init()});function frmRecaptcha(){frmCaptcha(".frm-g-recaptcha")}function frmTurnstile(){frmCaptcha(".cf-turnstile")}function frmCaptcha(captchaSelector){var c;var captchas=document.querySelectorAll(captchaSelector);var cl=captchas.length;for(c=0;c<cl;c++){var isVisible=captchas[c].offsetParent!==null;if(!isVisible)continue;frmFrontForm.renderCaptcha(captchas[c],captchaSelector)}}
