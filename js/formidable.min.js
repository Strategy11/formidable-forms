...
jQuery(b.previewElement).append(y(c[a],b.mediaID,e));for(var d=b.previewElement.querySelectorAll("[data-dz-name]"),f=0,h=d.length;f<h;f++)d[f].innerHTML='<a href="'+b.url+'">'+b.name+"</a>"}});this.on("addedfile",function(){l.addClass("frm_loading_now");g.attr("disabled","disabled")});this.on("queuecomplete",function(){l.removeClass("frm_loading_now");g.removeAttr("disabled")});this.on("removedfile",function(b){!1!==b.accepted&&!0!==c[a].uploadMultiple&&jQuery('input[name="'+e+'"]').val("");!1!==
...
a.fieldKey+'-"]'):(a=a.isRepeating?"item_meta["+Q(a)+"]["+a.repeatRow+"]["+a.fieldId+"]":"item_meta["+a.fieldId+"]",a=document.querySelectorAll('[name^="'+a+'"]'));return a}function pa(a,b,c){if(a.length)for(var d,e=["checkbox","radio"],f=0;f<a.length;f++)if(!(0<f&&"undefined"!==typeof d&&d.name==a[f].name&&-1<e.indexOf(d.type)||b&&V(a[f],c))){d=a[f];var h=jQuery(d),g=h.data("frmval");if("undefined"!==typeof g){if("checkbox"==d.type||"radio"==d.type)ua(d.name,g);else if(-1<d.name.indexOf("[]")){var l=
document.getElementsByName(d.name);if(jQuery.isArray(g))for(var p=0,k=g.length;p<k;p++)p in l&&(l[p].value=g[p]);else null!==l[0]&&(l[0].value=g)}else g.constructor===Object&&(l=d.getAttribute("name").split("[").slice(-1)[0],null!==l&&(l=l.replace("]",""),g=g[l],"undefined"==typeof g&&(g=""))),d.value=g;"SELECT"==d.tagName&&K(d);t(h)}d=a[f];h=n(d,!1);h=W(h);!1!==h&&"lookup"!=h.fieldType&&(h.parentVals=X(h),va(h,d));d=a[f];if(h="undefined"!==typeof __FRMCALC){h=d.type;g=!1;if("text"==h||"hidden"==
h||"number"==h)g=!0;h=g}if(h){h=__FRMCALC;g=d.name;l=d.id.replace("field_","");if(3<=g.split("][").length)for(g=l.split("-"),l="",p=0;p<g.length-1;p++)l=""===l?g[p]:l+"-"+g[p];g=l;l=null;3<=d.name.split("][").length&&(l="hidden"!=d.type?jQuery(d).closest(".frm_form_field"):jQuery(d));d=l;void 0!==h.calc[g]&&Y(h,g,[],d)}d=a[f]}}function V(a,b){var c=n(a,!0);return B("frm_field_"+c+"_container",b)}function R(a,b){if(!B(a.containerId,a.formId)){if(b){jQuery("#"+a.containerId).hide();var c=oa(a.containerId)}else c=
...
__FRMLOOKUP[a]}function X(a){for(var b=[],c=a.parents,d,e=0,f=c.length;e<f;e++){d=W(c[e]);d=ra(d,a);if(""===d||!1===d){b=!1;break}b[e]=d}return b}function T(a){for(var b=!1,c=a.length,d=0;d<c;d++)if("hidden"==a[d].type||a[d].checked){b=a[d].value;break}return b}function Wa(a,b){var c=b.getElementsByTagName("SELECT")[0];if(null!==c){var d=c.value;!1===a.parentVals?(c.options.length=1,""!==d&&(c.value="",K(c),t(jQuery(c),a.fieldKey))):(a.isReadOnly=c.disabled,Ya(c),jQuery.ajax({type:"POST",url:frm_js.ajax_url,
data:{action:"frm_replace_lookup_field_options",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(b){var d=c.value;b=JSON.parse(b);for(var e=c.options.length;0<e;e--)c.remove(e);for(var g=b.length,e=0;e<g;e++)c.options[e+1]=new Option(b[e],b[e],!1,!1);c.value=d;""===c.value&&(b=c.getAttribute("data-frmval"),null!==b&&(c.value=b));!1===a.isReadOnly&&(c.disabled=!1);c.className=c.className.replace(" frm_loading_lookup","");K(c);c.value!=d&&t(jQuery(c),
a.fieldKey)}}))}}function K(a){-1<a.className.indexOf("frm_chzn")&&jQuery().chosen&&jQuery(a).trigger("chosen:updated")}function Ya(a){a.className+=" frm_loading_lookup";a.disabled=!0;K(a)}function Xa(a,b){var c=b.getElementsByClassName("frm_opt_container")[0],d=c.getElementsByTagName("input");Za(b,c);var e="",e="radio"==a.inputType?T(d):J(d),f=jQuery(d[0]).data("frmval");jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_cb_radio_lookup_options",parent_fields:a.parents,parent_vals:a.parentVals,
field_id:a.fieldId,row_index:a.repeatRow,current_value:e,default_value:f,nonce:frm_js.nonce},success:function(e){c.innerHTML=e;e=b.getElementsByClassName("frm-loading-img")[0];null!==e&&void 0!==e&&e.parentNode.removeChild(e);c.style.display="block";1==d.length&&""===d[0].value?xa(a,b):(!1!==B(b.id,a.formId)&&(e=P(a.fieldId),!1===e||1>e.conditions.length?(D(b.id,a.formId),jQuery("#"+b.id).show()):(e.containerId=b.id,e.repeatRow=a.repeatRow,ma(e))),void 0!==f&&(!1!==("radio"==a.inputType?T(d):J(d))||
1>d.length||ua(d[0].name,f)));t(jQuery(d[0]),a.fieldKey)}})}function xa(a,b){B(b.id,a.formId)||(jQuery("#"+b.id).hide(),wa(b.id,a.formId))}function va(a,b){if(!V(b,a.formId))if(!1===a.parentVals){var c=b.getAttribute("data-frmval");null===c&&(c="");ya(a,b,c)}else jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_get_lookup_text_value",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(c){b.value!=c&&ya(a.fieldKey,b,c)}})}function ya(a,
b,c){b.value=c;t(jQuery(b),a)}function Sa(a,b){if(b){var c=jQuery("#"+a.containerId);za(c)}jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",entry_id:a.dataLogic.actualValue,current_field:a.fieldId,hide_id:a.containerId,nonce:frm_js.nonce},success:function(d){if(b){var e=c.find(".frm_opt_container");e.html(d);var f=e.children("input"),h=f.val();Aa(e);""===d||""===h?R(a,!0):Ba(a,c,f,!0)}else e="field_"+a.fieldKey,""!==a.repeatRow&&(e+="-"+a.repeatRow),e=document.getElementById(e),
e.value=d,B(a.containerId,a.formId)&&D(a.containerId,a.formId),t(jQuery(e))}})}function Ta(a,b){var c=jQuery("#"+a.containerId),d=c.find('select[name^="item_meta"], input[name^="item_meta"]'),e=Ca(d),d=d.data("frmval"),f=c.closest("form").find('input[name="id"]').val();za(c);jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_data_options",trigger_field_id:a.dataLogic.fieldId,entry_id:a.dataLogic.actualValue,field_id:a.fieldId,default_value:d,container_id:a.containerId,editing_entry:f,
prev_val:e,nonce:frm_js.nonce},success:function(b){var d=c.find(".frm_opt_container");d.html(b);var f=d.find('select, input[type="checkbox"], input[type="radio"]');Aa(d);""===b||1>f.length?R(a,!0):(b=Ca(f),Ba(a,c,f,e!==b))}})}function za(a){var b=a.html();-1<b.indexOf("frm-loading-img")||(a.html(b+'<span class="frm-loading-img"></span>'),a.find(".frm_opt_container").hide())}function Za(a,b){if(!(-1<a.innerHTML.indexOf("frm-loading-img"))){b.style.display="none";var c=document.createElement("span");
c.setAttribute("class","frm-loading-img");a.insertBefore(c,b.nextSibling)}}function Aa(a){a.parent().children(".frm-loading-img").remove();a.show()}function Ca(a){var b=[],c="";a.each(function(){c=this.value;"radio"===this.type||"checkbox"===this.type?!0===this.checked&&b.push(c):""!==c&&b.push(c)});0===b.length&&(b="");return b}function Ba(a,b,c,d){B(a.containerId,a.formId)&&(D(a.containerId,a.formId),b.show());c.hasClass("frm_chzn")&&ba();!0===d&&t(c)}function N(a,b){if("undefined"!==typeof __FRMCALC){var c=
__FRMCALC,d=c.fields[a];if("undefined"!==typeof d)for(var d=d.total,e=[],f=0,h=d.length;f<h;f++){var g;g=c.calc[d[f]];var l=b.attr("name"),p=!1,k=g.field_id,m=E(g.form_id);1>m.length||("0"===g.inSection&&"0"===g.inEmbedForm?p=L(k,m):(l=H(l),L(k,m)?p=!0:Da(k,l,m)?p=!0:"0"!==g.inSection&&"0"!==g.inEmbedForm?p=Da(g.inSection,l,m):"0"!==g.inSection?p=L(g.inSection,m):"0"!==g.inEmbedForm&&(p=L(g.inEmbedForm,m))));g=p;!1===g&&Y(c,d[f],e,b)}}}function L(a,b){return-1<b.indexOf("frm_field_"+a+"_container")}
function Da(a,b,c){var d=!1;b.repeatingSection&&(a="frm_field_"+a+"-"+b.repeatingSection,a+="-"+b.repeatRow+"_container",d=-1<c.indexOf(a));return d}function Y(a,b,c,d){var e=a.calc[b],f=e.calc,h=jQuery(document.getElementById("field_"+b)),g={triggerField:d,inSection:!1,thisFieldCall:'input[id^="field_'+b+'-"]'};1>h.length&&"undefined"!==typeof d&&(g.inSection=!0,g.thisFieldId=$a(a.fieldsWithCalc,b),h=Ea(g));if(!(1>h.length)){f=ab(e,f,a,c,g);if("text"!=e.calc_type){a=e.calc_dec;-1<f.indexOf(").toFixed(")&&
(c=f.split(").toFixed("),Fa(c[1])&&(a=c[1],f=f.replace(").toFixed("+a,"")));f=parseFloat(eval(f));if("undefined"===typeof f||isNaN(f))f=0;Fa(a)&&(f=f.toFixed(a))}h.val()!=f&&(h.val(f),t(h,b))}}function ab(a,b,c,d,e){for(var f=0,h=a.fields.length;f<h;f++){var g={triggerField:e.triggerField,thisFieldId:a.fields[f],inSection:e.inSection,valKey:e.inSection+""+a.fields[f],thisField:c.fields[a.fields[f]],thisFieldCall:"input"+c.fieldKeys[a.fields[f]]},l=c;"checkbox"==g.thisField.type||"radio"==g.thisField.type||
"scale"==g.thisField.type?g.thisFieldCall=g.thisFieldCall+":checked,"+g.thisFieldCall+"[type=hidden]":"select"==g.thisField.type||"time"==g.thisField.type?g.thisFieldCall="select"+l.fieldKeys[g.thisFieldId]+" option:selected,"+g.thisFieldCall+"[type=hidden]":"textarea"==g.thisField.type&&(g.thisFieldCall=g.thisFieldCall+",textarea"+l.fieldKeys[g.thisFieldId]);if("text"==a.calc_type)g.valKey="text"+g.valKey,d=bb(g,d),"undefined"===typeof d[g.valKey]&&(d[g.valKey]="");else{g.valKey="num"+g.valKey;d=
cb(g,c,d);if("undefined"===typeof d[g.valKey]||isNaN(d[g.valKey]))d[g.valKey]=0;"date"==g.thisField.type&&0===d[g.valKey]&&(b="")}l="["+g.thisFieldId+"]";l=l.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1");b=b.replace(new RegExp(l,"g"),d[g.valKey])}return b}function cb(a,b,c){if("undefined"!==typeof c[a.valKey]&&0!==c[a.valKey])return c;c[a.valKey]=0;var d=Ga(a);if(!1===d)return c;d.each(function(){var d=Ha(a.thisField,this);if("date"==a.thisField.type){var f;f=b.date;var h=0;if(d)if("undefined"===
typeof jQuery.datepicker){h="-";-1<f.indexOf("/")&&(h="/");f=f.split(h);var d=d.split(h),g,l;g=h=l="";for(var k=0;k<f.length;k++)if("y"==f[k])g=((new Date).getFullYear()+15).toString().substr(2,2),g=d[k]>g?"19"+d[k]:"20"+d[k];else if("yy"==f[k])g=d[k];else if("m"==f[k]||"mm"==f[k])h=d[k],2>h.length&&(h="0"+h);else if("d"==f[k]||"dd"==f[k])l=d[k],2>l.length&&(l="0"+l);h=Date.parse(g+"-"+h+"-"+l)}else h=jQuery.datepicker.parseDate(f,d);f=h;null!==f&&(c[a.valKey]=Math.ceil(f/864E5))}else{f=d;""!==f&&
0!==f&&(f=f.trim(),f=parseFloat(f.replace(/,/g,"").match(/-?[\d\.]+$/)));if("undefined"===typeof f||isNaN(f)||""===f)f=0;c[a.valKey]+=f}});return c}function bb(a,b){if("undefined"!==typeof b[a.valKey]&&""!==b[a.valKey])return b;b[a.valKey]="";var c=Ga(a);if(!1===c)return b;var d=0,e="";c.each(function(){var c=Ha(a.thisField,this),c=c.trim();0<d&&(e=", ");""!==c&&(b[a.valKey]+=e+c,d++)});return b}function Ga(a){var b;if(!1===a.inSection)b=jQuery(a.thisFieldCall);else if(b=Ea(a),null===b||"undefined"===
typeof b)b=jQuery(a.thisFieldCall);if(null===b||"undefined"===typeof b||1>b.length)b=!1;return b}function Ea(a){if("undefined"===typeof a.triggerField)return null;var b=a.triggerField.closest(".frm_repeat_sec, .frm_repeat_inline, .frm_repeat_grid");return b.length?(a=a.thisFieldCall.replace("[id=","[id^="),b.find(a)):null}function Ha(a,b){var c;c=!1;if("hidden"==b.type)""!==ca(b)&&(c=!0);else if("select"==a.type){var d=b.className;d&&-1<d.indexOf("frm_other_trigger")&&(c=!0)}else("checkbox"==a.type||
"radio"==a.type)&&-1<b.id.indexOf("-other_")&&0>b.id.indexOf("-otext")&&(c=!0);c?(c=0,"select"==a.type?"hidden"==b.type?(d=!1,2<b.name.split("[").length&&(d=!0),d||(c=ca(b))):c=jQuery(b).closest(".frm_other_container").find(".frm_other_input").val():"checkbox"!=a.type&&"radio"!=a.type||"hidden"==b.type||(c=ca(b))):c="checkbox"!==b.type&&"radio"!==b.type||!b.checked?jQuery(b).val():b.value;"undefined"===typeof c&&(c="");return c}function ca(a){var b="";a=document.getElementById(a.id+"-otext");null!==
a&&""!==a.value&&(b=a.value);return b}function Ia(a){var b=!1;a=jQuery(a).find(".frm_saving_draft");a.length&&(b=a.val());return b}function Ja(a){var b=!1,c=jQuery(a).find(".frm_next_page");if(c.length&&c.val()){var d=jQuery(a).find('input[name="form_id"]').val();a=jQuery(a).find('input[name="frm_page_order_'+d+'"]');a=a.length?a.val():0;if(!a||c.val()<a)b=!0}return b}function ha(a,b){var c=a.getAttribute("data-frmfile");if("hidden"==a.type&&null===c)return b;var d="",e="";if("checkbox"==a.type||
"radio"==a.type)c=jQuery('input[name="'+a.name+'"]').closest(".frm_required_field").find("input:checked"),jQuery(c).each(function(){d=this.value});else if("file"==a.type||c)"undefined"===typeof c&&(c=n(a,!0),c=c.replace("file","")),"undefined"===typeof b[c]&&(d=db(c)),e=c;else{e=a.className;if(-1!==e.indexOf("frm_pos_none"))return b;d=jQuery(a).val();if("string"!==typeof d)for(var c=d,d="",f=0;f<c.length;f++)""!==c[f]&&(d=c[f]);e=-1===e.indexOf("frm_other_input")?n(a,!0):n(a,!1)}""===d&&(""===e&&
(e=n(a,!0)),e in b||(b[e]=F(a,"data-reqmsg")));return b}function db(a){var b="";jQuery('input[name="file'+a+'"], input[name="file'+a+'[]"], input[name^="item_meta['+a+']"]').each(function(){""===b&&(b=this.value)});return b}function ia(a,b,c){var d=a.value,e=n(a,!0);if(e in b)return b;var f=0===e.indexOf("conf_");if(""!==d||f){var h=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/i,g=F(a,"data-invmsg");
""!==d&&!1===h.test(d)?(b[e]=g,f&&(b[e.replace("conf_","")]="")):f&&(a=a.name.replace("conf_",""),c.filter('[name="'+a+'"]').val()!==d&&(b[e]="",b[e.replace("conf_","")]=""))}return b}function ja(a,b){var c=a.value;""!==c&&!1!==isNaN(c/1)&&(c=n(a,!0),c in b||(b[c]=F(a,"data-invmsg")));return b}function ka(a,b){var c=a.value,d=F(a,"pattern");if(""!==d&&""!==c){var e=n(a,!0);e in b||(d=new RegExp("^"+d+"$","i"),!1===d.test(c)&&(b[e]=F(a,"data-invmsg")))}return b}function F(a,b){var c=a.getAttribute(b);
null===c&&(c="");return c}function eb(a,b){"undefined"==typeof b&&jQuery(a).find('input[name="frm_action"]').val();jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:jQuery(a).serialize()+"&action=frm_entries_"+b+"&nonce="+frm_js.nonce,success:function(b){var c={content:"",errors:{},pass:!1};null===b&&(b=c);b=b.replace(/^\s+|\s+$/g,"");b=0===b.indexOf("{")?jQuery.parseJSON(b):c;if("undefined"!=typeof b.redirect)window.location=b.redirect;else if(""!==b.content){jQuery(a).find(".frm_ajax_loading").removeClass("frm_loading_now");
var e=jQuery(a).find('input[name="form_id"]').val();jQuery(a).closest(".frm_forms").replaceWith(b.content);-1!=frm_js.offset&&frmFrontForm.scrollMsg(jQuery(a),!1);"function"==typeof frmThemeOverride_frmAfterSubmit&&(e=jQuery('input[name="frm_page_order_'+e+'"]').val(),c=jQuery(b.content).find('input[name="form_id"]').val(),frmThemeOverride_frmAfterSubmit(c,e,b.content,a));e=jQuery(a).find('input[name="id"]');e.length&&jQuery(document.getElementById("frm_edit_"+e.val())).find("a").addClass("frm_ajax_edited").click();
...
b){google.load("visualization","1.0",{packages:[b],callback:function(){var b=new google.visualization.DataTable,d=!1;-1!==jQuery.inArray("id",a.options.fields)&&(d=!0,b.addColumn("number",frm_js.id));for(var e=a.fields.length,f,h=0,g=e;h<g;h++){var l=a.fields[h];f=Oa(l);b.addColumn(f,l.name)}h=!1;a.options.edit_link&&(h=!0,b.addColumn("string",a.options.edit_link));g=!1;a.options.delete_link&&(g=!0,b.addColumn("string",a.options.delete_link));if(null!==a.entries){var k=a.entries.length;b.addRows(k);
for(var m=0,q=0;q<k;q++){var l=0,n=a.entries[q];d&&(b.setCell(m,l,n.id),l++);for(var r=0,t=e;r<t;r++){var u=a.fields[r];f=Oa(u);u=n.metas[u.id];"number"!=f||null!==u&&""!==u?"boolean"==f&&(u=null===u||"false"==u||!1===u?!1:!0):u=0;b.setCell(m,l,u);l++}h&&("undefined"!==typeof n.editLink?b.setCell(m,l,'<a href="'+n.editLink+'">'+a.options.edit_link+"</a>"):b.setCell(m,l,""),l++);g&&("undefined"!==typeof n.deleteLink?b.setCell(m,l,'<a href="'+n.deleteLink+'" class="frm_delete_link" data-frmconfirm="'+
a.options.confirm+'">'+a.options.delete_link+"</a>"):b.setCell(m,l,""));m++}}else for(b.addRows(1),h=l=0,g=e;h<g;h++)0<l?b.setCell(0,l,""):b.setCell(0,l,a.options.no_entries),l++;(new google.visualization.Table(document.getElementById("frm_google_table_"+a.options.form_id))).draw(b,a.graphOpts)}})}function kb(a){google.load("visualization","1.0",{packages:[a["package"]],callback:function(){var b;new google.visualization.DataTable;b=google.visualization.arrayToDataTable(a.data);var c=document.getElementById("chart_"+
...
"frm_section_"+b+"-"+a,d=jQuery(document.getElementById(c)),e=d.find("input, select, textarea"),f=jQuery(this).closest("form").find('input[name="form_id"]').val();d.fadeOut("slow",function(){d.remove();e.each(function(){var c=n(this,!1);"file"!=this.type&&N(c,jQuery(this));D("frm_field_"+c+"-"+b+"-"+a+"_container",f)});"function"==typeof frmThemeOverride_frmRemoveRow&&frmThemeOverride_frmRemoveRow(c,d)});return!1}function mb(){if(!0===M)return!1;M=!0;var a=jQuery(this).data("parent"),b=0;if(0<jQuery(".frm_repeat_"+
a).length)var c=jQuery(".frm_repeat_"+a+":last").attr("id").replace("frm_section_"+a+"-",""),b=-1<c.indexOf("i")?1:1+parseInt(c);jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"json",data:{action:"frm_add_form_row",field_id:a,i:b,nonce:frm_js.nonce},success:function(c){var d=c.html,f=jQuery(d).hide().fadeIn("slow");jQuery(".frm_repeat_"+a+":last").after(f);var h=["other"],g,l,k={repeatingSection:a.toString(),repeatRow:b.toString()};jQuery(d).find("input, select, textarea").each(function(){if("file"!=
this.type){if(""===this.name)return!0;g=this.name.replace("item_meta[","").split("]")[2].replace("[","");-1==jQuery.inArray(g,h)&&!1!==this.id&&""!==this.id&&(l=jQuery("#"+this.id),h.push(g),I(g,k),aa(g,k,"value changed"),fa(g,l),ga(g,l,"value changed"),N(g,l))}});v(k.repeatRow);Pa();ba();"function"==typeof frmThemeOverride_frmAddRow&&frmThemeOverride_frmAddRow(a,c);M=!1},error:function(){M=!1}});return!1}function nb(){var a=jQuery(this),b=a.data("entryid"),c=a.data("prefix"),d=a.data("pageid"),e=
a.data("formid"),f=a.data("cancel"),h=a.data("fields"),g=a.data("excludefields"),l=jQuery(document.getElementById(c+b)),k=l.html();l.html('<span class="frm-loading-img" id="'+c+b+'"></span><div class="frm_orig_content" style="display:none">'+k+"</div>");jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"html",data:{action:"frm_entries_edit_entry_ajax",post_id:d,entry_id:b,id:e,nonce:frm_js.nonce,fields:h,exclude_fields:g},success:function(b){l.children(".frm-loading-img").replaceWith(b);a.removeClass("frm_inplace_edit").addClass("frm_cancel_edit");
...
c){if("undefined"==typeof b){if(a=jQuery(document.getElementById("frm_form_"+a+"_container")),1>a.length)return}else a="string"==typeof a?jQuery(b).find("#frm_field_"+a+"_container"):a;if((a=a.offset().top)||0===a){a-=frm_js.offset;b=jQuery("html").css("margin-top");var d=jQuery("body").css("margin-top");if(b||d)a=a-parseInt(b)-parseInt(d);if(a&&window.innerHeight&&(b=document.documentElement.scrollTop||document.body.scrollTop,a>b+window.innerHeight||a<b))return"undefined"===typeof c?jQuery(window).scrollTop(a):
...
c.find("option").removeAttr("disabled");if(a&&""!==a)for(var d in a)c.find('option[value="'+d+'"]').attr("disabled","disabled")}})},escapeHtml:function(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")},invisible:function(a){jQuery(a).css("visibility","hidden")},visible:function(a){jQuery(a).css("visibility","visible")}}}var frmFrontForm=frmFrontFormJS();jQuery(document).ready(function(k){frmFrontForm.init()});
function frmRecaptcha(){for(var k=jQuery(".frm-g-recaptcha"),m=0,q=k.length;m<q;m++){var r=grecaptcha.render(k[m].id,{sitekey:k[m].getAttribute("data-sitekey"),size:k[m].getAttribute("data-size"),theme:k[m].getAttribute("data-theme")});k[m].setAttribute("data-rid",r)}}
function frmUpdateField(k,m,q,r,v){jQuery(document.getElementById("frm_update_field_"+k+"_"+m)).html('<span class="frm-loading-img"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_update_field_ajax",entry_id:k,field_id:m,value:q,nonce:frm_js.nonce},success:function(){""===r.replace(/^\s+|\s+$/g,"")?jQuery(document.getElementById("frm_update_field_"+k+"_"+m+"_"+v)).fadeOut("slow"):jQuery(document.getElementById("frm_update_field_"+k+"_"+m+"_"+v)).replaceWith(r)}})}
function frmEditEntry(k,m,q,r,v,z){console.warn("DEPRECATED: function frmEditEntry in v2.0.13 use frmFrontForm.editEntry");var y=jQuery(document.getElementById("frm_edit_"+k)),w=y.html(),A=jQuery(document.getElementById(m+k)),G=A.html();A.html('<span class="frm-loading-img" id="'+m+k+'"></span><div class="frm_orig_content" style="display:none">'+G+"</div>");jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"html",data:{action:"frm_entries_edit_entry_ajax",post_id:q,entry_id:k,id:r,nonce:frm_js.nonce},
success:function(n){A.children(".frm-loading-img").replaceWith(n);y.replaceWith('<span id="frm_edit_'+k+'"><a onclick="frmCancelEdit('+k+",'"+m+"','"+frmFrontForm.escapeHtml(w)+"',"+q+","+r+",'"+z+'\')" class="'+z+'">'+v+"</a></span>")}})}
function frmCancelEdit(k,m,q,r,v,z){console.warn("DEPRECATED: function frmCancelEdit in v2.0.13 use frmFrontForm.cancelEdit");var y=jQuery(document.getElementById("frm_edit_"+k)),w=y.find("a"),A=w.html();w.hasClass("frm_ajax_edited")||(w=jQuery(document.getElementById(m+k)),w.children(".frm_forms").replaceWith(""),w.children(".frm_orig_content").fadeIn("slow").removeClass("frm_orig_content"));y.replaceWith('<a id="frm_edit_'+k+'" class="frm_edit_link '+z+'" href="javascript:frmEditEntry('+k+",'"+
m+"',"+r+","+v+",'"+frmFrontForm.escapeHtml(A)+"','"+z+"')\">"+q+"</a>")}
function frmDeleteEntry(k,m){console.warn("DEPRECATED: function frmDeleteEntry in v2.0.13 use frmFrontForm.deleteEntry");jQuery(document.getElementById("frm_delete_"+k)).replaceWith('<span class="frm-loading-img" id="frm_delete_'+k+'"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_destroy",entry:k,nonce:frm_js.nonce},success:function(q){"success"==q.replace(/^\s+|\s+$/g,"")?jQuery(document.getElementById(m+k)).fadeOut("slow"):jQuery(document.getElementById("frm_delete_"+
k)).replaceWith(q)}})}function frmOnSubmit(k){console.warn("DEPRECATED: function frmOnSubmit in v2.0 use frmFrontForm.submitForm");frmFrontForm.submitForm(k,this)}
function frm_resend_email(k,m){console.warn("DEPRECATED: function frm_resend_email in v2.0");$link=jQuery(document.getElementById("frm_resend_email"));$link.append('<span class="spinner" style="display:inline"></span>');jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_entries_send_email",entry_id:k,form_id:m,nonce:frm_js.nonce},success:function(k){$link.replaceWith(k)}})};