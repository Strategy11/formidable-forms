...
typeof d){d=d.total;for(var e=[],f=0,g=d.length;f<g;f++){var h=c.calc[d[f]];var k=b.attr("name"),l=!1,A=h.field_id,m=E(h.form_id);1>m.length||("0"===h.inSection&&"0"===h.inEmbedForm?l=N(A,m):(k=B(k),N(A,m)?l=!0:Pa(A,k,m)?l=!0:"0"!==h.inSection&&"0"!==h.inEmbedForm?l=Pa(h.inSection,k,m):"0"!==h.inSection?l=N(h.inSection,m):"0"!==h.inEmbedForm&&(l=N(h.inEmbedForm,m))));h=l;!1===h&&Z(c,d[f],e,b)}}}}function N(a,b){return-1<b.indexOf("frm_field_"+a+"_container")}function Pa(a,b,c){var d=!1;b.repeatingSection&&
...
0<d&&("time"==a.thisField.type?1==d?e=":":2==d&&(e=" "):e=", ");""!==c&&(b[a.valKey]+=e+c,d++)});return b}function Sa(a){a=!1===a.inSection?jQuery(a.thisFieldCall):Qa(a);if(null===a||"undefined"===typeof a||1>a.length)a=!1;return a}function Qa(a){if("undefined"===typeof a.triggerField)return null;var b=a.triggerField.closest(".frm_repeat_sec, .frm_repeat_inline, .frm_repeat_grid");var c=B(a.triggerField.attr("name"));var d=a.thisFieldCall.replace("[id=","[id^=").replace(/-"]/g,"-"+c.repeatRow+'"]');
if(b.length||""!==c.repeatRow){if(c=b.length?b.find(d):jQuery(d),null===c||"undefined"===typeof c||1>c.length)c=null,d.indexOf(":checked")?1>b.find(d.replace(":checked","")).length&&(c=jQuery(a.thisFieldCall)):c=jQuery(a.thisFieldCall)}else c=jQuery(a.thisFieldCall);return c}function Ta(a,b){var c=!1;if("hidden"==b.type)""!==ha(b)&&(c=!0);else if("select"==a.type){var d=b.className;d&&-1<d.indexOf("frm_other_trigger")&&(c=!0)}else("checkbox"==a.type||"radio"==a.type)&&-1<b.id.indexOf("-other_")&&
0>b.id.indexOf("-otext")&&(c=!0);c?(c=0,"select"==a.type?"hidden"==b.type?(d=!1,2<b.name.split("[").length&&(d=!0),d||(c=ha(b))):c=jQuery(b).closest(".frm_other_container").find(".frm_other_input").val():"checkbox"!=a.type&&"radio"!=a.type||"hidden"==b.type||(c=ha(b))):c="checkbox"!==b.type&&"radio"!==b.type||!b.checked?jQuery(b).val():b.value;"undefined"===typeof c&&(c="");return c}function ha(a){var b="";a=document.getElementById(a.id+"-otext");null!==a&&""!==a.value&&(b=a.value);return b}function Ua(a){var b=
!1;a=jQuery(a).find(".frm_saving_draft");a.length&&(b=a.val());return b}function ia(a){var b=!1,c=jQuery(a).find(".frm_next_page");if(c.length&&c.val()){var d=jQuery(a).find('input[name="form_id"]').val();a=jQuery(a).find('input[name="frm_page_order_'+d+'"]');a=a.length?a.val():0;if(!a||c.val()<a)b=!0}return b}function P(a,b){var c=a.getAttribute("data-frmfile");if("hidden"==a.type&&null===c)return b;var d="",e="";if("checkbox"==a.type||"radio"==a.type)c=jQuery('input[name="'+a.name+'"]').closest(".frm_required_field").find("input:checked"),
jQuery(c).each(function(){d=this.value});else if("file"==a.type||c)"undefined"===typeof c&&(c=q(a,!0),c=c.replace("file","")),"undefined"===typeof b[c]&&(d=ub(c)),e=c;else{c=a.className;if(-1!==c.indexOf("frm_pos_none"))return b;d=jQuery(a).val();if(null===d)d="";else if("string"!==typeof d){e=d;d="";for(var f=0;f<e.length;f++)""!==e[f]&&(d=e[f])}e=-1===c.indexOf("frm_other_input")?q(a,!0):q(a,!1);-1!==c.indexOf("frm_time_select")&&(e=e.replace("-H","").replace("-m",""))}""===d&&(""===e&&(e=q(a,!0)),
e in b||(b[e]=F(a,"data-reqmsg")));return b}function ub(a){var b="";jQuery('input[name="file'+a+'"], input[name="file'+a+'[]"], input[name^="item_meta['+a+']"]').each(function(){""===b&&(b=this.value)});return b}function pa(a,b,c){var d=a.value,e=q(a,!0);if(e in b)return b;var f=0===e.indexOf("conf_");if(""!==d||f){var g=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/i,h=F(a,"data-invmsg");""!==
d&&!1===g.test(d)?(b[e]=h,f&&(b[e.replace("conf_","")]="")):f&&(a=a.name.replace("conf_",""),c.filter('[name="'+a+'"]').val()!==d&&(b[e]="",b[e.replace("conf_","")]=""))}return b}function qa(a,b){var c=a.value;""!==c&&!1!==isNaN(c/1)&&(c=q(a,!0),c in b||(b[c]=F(a,"data-invmsg")));return b}function ra(a,b){var c=a.value,d=F(a,"pattern");if(""!==d&&""!==c){var e=q(a,!0);e in b||(d=new RegExp("^"+d+"$","i"),!1===d.test(c)&&(b[e]=F(a,"data-invmsg")))}return b}function F(a,b){var c=a.getAttribute(b);null===
c&&(c="");return c}function vb(a,b){"undefined"==typeof b&&jQuery(a).find('input[name="frm_action"]').val();var c=jQuery(a).find(".frm_form_field");c.addClass("frm_doing_ajax");jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:jQuery(a).serialize()+"&action=frm_entries_"+b+"&nonce="+frm_js.nonce,success:function(b){var d={content:"",errors:{},pass:!1};null===b&&(b=d);b=b.replace(/^\s+|\s+$/g,"");b=0===b.indexOf("{")?jQuery.parseJSON(b):d;if("undefined"!=typeof b.redirect)jQuery(document).trigger("frmBeforeFormRedirect",
