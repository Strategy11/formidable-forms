...
b.redirect;else if(""!==b.content){M(a);var f=jQuery(a).find('input[name="form_id"]').val();jQuery(a).find(".frm_form_field").fadeOut("slow",function(){b.content=b.content.replace(/ class="frm_form_field /g,' class="frm_hidden frm_form_field ');b.content=b.content.replace(/ frm_pro_form /g," frm_pro_form frm_no_hide ");jQuery(a).closest(".frm_forms").replaceWith(b.content);jQuery("#frm_form_"+f+"_container .frm_form_field").fadeIn("slow")});-1!=frm_js.offset&&frmFrontForm.scrollMsg(jQuery(a),!1);
hb(b);if("function"==typeof frmThemeOverride_frmAfterSubmit){var h=jQuery('input[name="frm_page_order_'+f+'"]').val(),d=jQuery(b.content).find('input[name="form_id"]').val();frmThemeOverride_frmAfterSubmit(d,h,b.content,a)}h=jQuery(a).find('input[name="id"]');h.length&&jQuery(document.getElementById("frm_edit_"+h.val())).find("a").addClass("frm_ajax_edited").click();jQuery(b.content).find(".frm_message").length&&da("pageLoad");ea()}else if(Object.keys(b.errors).length){M(a,"enable");d=!0;La();var g=
!1,k=null;for(h in b.errors)if(k=jQuery(a).find("#frm_field_"+h+"_container"),k.length){if(!k.is(":visible")){var m=k.closest(".frm_toggle_container");m.length&&(m=m.prev(),m.hasClass("frm_trigger")||(m=m.prev(".frm_trigger")),m.click())}k.is(":visible")&&(O(k,h,b.errors),d=!1,k=jQuery(a).find("#frm_field_"+h+"_container .frm-g-recaptcha, #frm_field_"+h+"_container .g-recaptcha"),k.length&&(g=!0,k=k.data("rid"),jQuery().grecaptcha&&(k?grecaptcha.reset(k):grecaptcha.reset())))}c.removeClass("frm_doing_ajax");
Ma(a);!0!==g&&Na(a,!1);d?a.submit():jQuery(a).prepend(b.error_message)}else ib(a),Na(a,!0),a.submit()},error:function(){jQuery(a).find('input[type="submit"], input[type="button"]').removeAttr("disabled");a.submit()}})}function hb(a){if(history.pushState&&"undefined"!=typeof a.page){var b,c=a.page;b=encodeURI("frm_page");for(var c=encodeURI(c),d=document.location.search.substr(1).split("&"),e=d.length,f;e--;)if(f=d[e].split("="),f[0]==b){f[1]=c;d[e]=f.join("=");break}0>e&&(d[d.length]=[b,c].join("="));
b=d.join("&");window.history.pushState({html:a.html},"","?"+b)}}function O(a,b,c){a.length&&a.is(":visible")&&(a.addClass("frm_blank_field"),"function"==typeof frmThemeOverride_frmPlaceError?frmThemeOverride_frmPlaceError(b,c):a.append('<div class="frm_error">'+c[b]+"</div>"))}function La(){jQuery(".form-field").removeClass("frm_blank_field");jQuery(".form-field .frm_error").replaceWith("");jQuery(".frm_error_style").remove()}function Ma(a){var b=jQuery(a).find(".frm_blank_field:first");b.length&&
frmFrontForm.scrollMsg(b,a,!0)}function fa(a){var b=jQuery(a).find("button.frm_button_submit");b.length&&!b.hasClass("frm_loading_button")&&(b.addClass("frm_loading_button"),b.attr("disabled","disabled"));jQuery(a).find('input[type="submit"], input[type="button"]').attr("disabled","disabled")}function M(a,b){var c=jQuery(a).find("button.frm_loading_button");c.length&&(c.removeClass("frm_loading_button"),"enable"==b&&c.removeAttr("disabled"));"enable"==b&&jQuery(a).find('input[type="submit"], input[type="button"]').removeAttr("disabled")}
