...
<?php
// Only show gateway tabs if there are multiple gateways available.
if ( count( $gateways ) > 1 ) {
...
<div class="frm_grid_container">
	...
	<?php
	// Only show radio buttons when there's a single gateway (tabs are shown for multiple gateways).
	if ( count( $gateways ) === 1 ) :
	?>
	<p>
...
<div class="frm_grid_container frm-mb-xs">
	...
	?>
	<h3 class="frm-billing-section-heading frm-mt-0" data-billing-label="<?php echo esc_attr( $billing_label ); ?>" data-customer-label="<?php echo esc_attr( $customer_label ); ?>">
